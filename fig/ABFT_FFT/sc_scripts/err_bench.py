...
def print_average(tensor, name):
    ...
    print(name, avg)
    print(tensor.sort())
file_name_lists = ['..//sc_data//benchmark_cufft_A100_fp64.csv', 
                  '..//sc_data//benchmark_turbofft_err_no_ft_A100_fp64.csv',
                  '..//sc_data//benchmark_turbofft_err_no_inj_A100_fp64.csv',
                  '..//sc_data//benchmark_turbofft_err_inj_A100_fp64.csv',
                  '..//sc_data//benchmark_cufft_A100_fp32.csv', 
                  '..//sc_data//benchmark_TurboFFT_A100_fp32.csv',
                  '..//sc_data//benchmark_TurboFFT_ft_A100_fp32.csv',
                  '..//sc_data//benchmark_TurboFFT_err_A100_fp32.csv',
                  '..//sc_data//benchmark_xin_A100_fp64.csv',
                  '..//sc_data//benchmark_xin_A100_fp32.csv',]
...
# print('vkfft', (vkfft / cufft[1:, 0, 1]).mean(),  (vkfft / cufft[1:, 0, 1]).max(), (vkfft / cufft[1:, 0, 1]).min())
# print('Turbofft no  FT', (turbofft_no_ft[1:, 0, 1]  / cufft[1:, 0, 1]).mean())
# print('TurboFFT w/ FT', (turbofft_ft[1:, 0, 1] / cufft[1:, 0, 1]).mean())
# print('TurboFFT err', (turbofft_err[1:, 0, 1] / cufft[1:, 0, 1]).mean())
# print('Xin err', ( xin[1:, 0, 1] / cufft[1:, 0, 1]).mean())
...
print('FP32,, A100')
# print('vkfft', (vkfft / cufft[1:, 0, 1]).mean())
# print('Turbofft no  FT', (turbofft_no_ft[1:, 0, 1]  / cufft[1:, 0, 1]).mean())
# print('TurboFFT w/ FT', (turbofft_ft[1:, 0, 1] / cufft[1:, 0, 1]).mean())
# print('TurboFFT err', (turbofft_err[1:, 0, 1] / cufft[1:, 0, 1]).mean())
# print('Xin err', ( xin[1:, 0, 1] / cufft[1:, 0, 1]).mean())
