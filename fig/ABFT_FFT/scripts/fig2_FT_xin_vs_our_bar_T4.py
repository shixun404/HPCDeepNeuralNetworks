...
gflops_fft_xin = th.as_tensor([   196.7,   216.2,   290.6,   349.0,   355.0, 360, 362,  368.8,   364.5,])
gflops_fft_xin_m = gflops_fft_xin - 60
gflops_fft_xin_c = gflops_fft_xin - 30
...
fft = ax.bar(br3, gflops_cufft, color = color[3], width = barWidth,
...
fig.savefig("..\\figures\\fig2_FT_xin_vs_our_bar_T4.pdf",bbox_inches='tight')
