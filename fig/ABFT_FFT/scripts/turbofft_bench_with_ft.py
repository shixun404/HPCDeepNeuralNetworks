...
if __name__ == '__main__':
    ...
    name_lists = [['benchmark_cufft_A100_fp32.csv','benchmark_turbofft_A100_fp32.csv', 
                   'benchmark_twoside_fused_A100_fp32.csv', 'benchmark_twoside_errinject_A100_fp32.csv'], 
                   ['benchmark_cufft_A100_fp64.csv', 'benchmark_turbofft_A100_fp64.csv',
                    'benchmark_twosides_fused_3_A100_fp64.csv', 'benchmark_twoside_errinject_A100_fp64.csv'],
                     ['benchmark_cufft_T4_fp32.csv', 'benchmark_turbofft_T4_fp32.csv',
                      'benchmark_twoside_fused_T4_fp32.csv', 'benchmark_twoside_errinject_T4_fp32.csv'],
                     ['benchmark_cufft_T4_fp64.csv', 'benchmark_turbofft_T4_fp64.csv',
                      'benchmark_twoside_fused_T4_fp64.csv', 'benchmark_twoside_errinject_T4_fp64.csv'],
                     ]
    title_list = [['Compute Performance\n     A100 FP32   ', 'Memory Bandwidth\n   A100 FP32  '], 
                  ['Compute Performance\n     A100 FP64   ', 'Memory Bandwidth\n   A100 FP64  '],
                ['Compute Performance\n     T4 FP32   ', 'Memory Bandwidth\n   T4 FP32  '],
                  ['Compute Performance\n     T4 FP64   ', 'Memory Bandwidth\n   T4 FP64  '],]
    file_name = ['bench_A100_fp32.pdf', 'bench_A100_fp64.pdf', 'bench_T4_fp32.pdf', 'bench_T4_fp64.pdf', ]
    # c_peak = [19.5, ]
    j = 0
    ...
    for name_list in name_lists:
        ...
        for filename in name_list:
            ...
            data_list, data_tensor = load_data_single('../data/'+filename)
        ...
        fig.savefig(f'..\\figures\\FT_{file_name[j]}',bbox_inches='tight')
        j += 1
