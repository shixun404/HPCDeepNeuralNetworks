...
if __name__ == '__main__':
    ...
    title_list = [
        ' Offline \nA100 FP64', ' Optim-1 \nA100 FP64', ' Optim-2 \nA100 FP64', 'turboFFT w/FT\n A100 FP64  ',
        ' Offline \nA100 FP32', ' Optim-1 \nA100 FP32', ' Optim-2 \nA100 FP32', 'turboFFT w/FT\n A100 FP32  ',
        'Offline\nT4 FP32', 'Optim-1\nT4 FP32', 'Optim-2\nT4 FP32', 'turboFFT w/FT\n  T4 FP32  ',
                  ]
    # title_pos_x = [0.2, 0.6]
    ...
    for name_list in name_lists:
        ...
        for filename in name_list[2:6]:
            ...
            # plt.figtext(title_pos_x[j - 1], title_pos_y[j - 1], title_list[j - 1])
            ax1.text(29, 18, 0,title_list[j - 1])
    ...
    plt.subplots_adjust(bottom=0, wspace=-0.27, hspace=-0.05, top=0.8)
    ...
    fig.savefig('..\\figures\\twoside_abft_stepwise_optimization.pdf',bbox_inches='tight')