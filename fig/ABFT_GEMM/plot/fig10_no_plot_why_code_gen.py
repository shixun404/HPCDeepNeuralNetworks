...
ax[0].plot(N, kernel_[:l] / performance_scale,  marker='P',  linewidth=ls,markersize=ms, color = color[2], label="Ours: original",clip_on=False)
ax[0].plot(N, kernel[:l] / performance_scale, '--' ,    linewidth=ls,marker='P',markersize=ms, color = color[2],label="Ours: codegen", clip_on=False)

# ax[0].plot(N, abft[:l] / performance_scale, '--',  marker='s',markersize=ms,  color = color[3],label="fused ABFT SGEMM (Ours): Codegen", clip_on=False)
# ax[0].plot(N, abft_[:l] / performance_scale,   marker='s',markersize=ms,  color = color[3], label="fused ABFT SGEMM (Ours): Original",clip_on=False)
...
ax[1].plot(N, kernel_[:l] / performance_scale,  marker='P',  linewidth=ls,markersize=ms, color = color[2], label="Ours: original",clip_on=False)
ax[1].plot(N, kernel[:l] / performance_scale, '--' ,   linewidth=ls, marker='P',markersize=ms, color = color[2],label="Ours: codegen", clip_on=False)
# ax[1].plot(N, abft[:l] / performance_scale, '--',  marker='s',markersize=ms,  color = color[3],label="fused ABFT SGEMM (Ours): Codegen", clip_on=False)
# ax[1].plot(N, abft_[:l] / performance_scale,   marker='s',markersize=ms,  color = color[3], label="fused ABFT SGEMM (Ours): Original",clip_on=False)
...
fig.savefig(f"why_code_gen_noABFT.pdf", bbox_inches='tight')