...
ax[0].plot(N, abft_kernel_huge_err_injec[:l] / 1000, '--', label="Our fused FT: error injected", marker='^',markersize=ms,  color =  'purple', clip_on=False)
...
ax[1].plot(N, abft_kernel_huge_err_injec[:l] / 1000, '--', label="Our fused FT:error injected", marker='^',markersize=ms,  color = 'purple', clip_on=False)
