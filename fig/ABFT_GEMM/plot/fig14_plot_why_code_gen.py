...
ax[0].plot(N, kernel_[:l] / performance_scale,  marker='P',  linewidth=ls,markersize=ms, color = color[2], label="Our fused FT: off",clip_on=False)
...
ax[1].plot(N, kernel_[:l] / performance_scale,  marker='P',  linewidth=ls,markersize=ms, color = color[2], label="Our fused FT: off",clip_on=False)
...
ax[1].plot(N, abft_[:l] / performance_scale,   marker='s',linewidth=ls,markersize=ms,  color = color[3], label="Our fused FT: on",clip_on=False)
ax[1].plot(N, abft[:l] / performance_scale, '--',  marker='s',linewidth=ls,markersize=ms,  color = color[3],label="Our codegen FT: on", clip_on=False)
