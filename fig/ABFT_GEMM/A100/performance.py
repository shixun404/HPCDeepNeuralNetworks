...
# print_average((cublas[3:] - abft_kernel_huge[3:]) / cublas[3:], "cublas vs abft")
...
print_average((cublas - abft_baseline) / cublas, "abft baseline vs cublas")
assert 0
...
# fig.savefig(f"per.pdf", bbox_inches='tight')