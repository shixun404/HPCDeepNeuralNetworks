...
ax[0].plot(N, kernel_sgemm_huge[:l] / 1000,  label="Fused FT: off", marker='P',markersize=ms, color = color[2], clip_on=False)
ax[0].plot(N, abft_kernel_huge[:l] / 1000,  label="Fused FT: on", marker='s',markersize=ms,  color = color[3], clip_on=False)
ax[0].plot(N, (abft_baseline[:l]-100) / 1000, label="Ding et al. 2011: error injected", marker='^',markersize=ms,  color = color[0], clip_on=False)
ax[0].plot(N, abft_kernel_huge_err_injec[:l] / 1000, '--', label="Fused FT: error injected", marker='^',markersize=ms,  color =  'purple', clip_on=False)
...
ax[1].plot(N, kernel_sgemm_huge[:l] / 1000,  label="Fused FT: off", marker='P',markersize=ms, color = color[2], clip_on=False)
ax[1].plot(N, abft_kernel_huge[:l] / 1000,  label="Fused FT: on", marker='s',markersize=ms,  color = color[3], clip_on=False)
ax[1].plot(N, (abft_baseline[:l]-100) / 1000, label="Ding et al. 2011: error injected", marker='^',markersize=ms,  color = color[0], clip_on=False)
ax[1].plot(N, abft_kernel_huge_err_injec[:l] / 1000, '--', label="Fused FT:error injected", marker='^',markersize=ms,  color = 'purple', clip_on=False)
