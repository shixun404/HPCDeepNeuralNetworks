...
ax[0].plot(N, thread_abft_kernel[:l] / 1000, linestyle='dotted', label="Thread-level FT-SGEMM", marker='o',markersize=ms*0.9,  color = color[3], clip_on=False)
ax[0].plot(N, warp_abft_kernel[:l] / 1000,  linestyle='dashed',label="Warp-level FT-SGEMM", marker='x',markersize=ms,  color = color[3], clip_on=False)
ax[0].plot(N, abft_kernel_huge[:l] / 1000,  label="Threadblock-level FT-SGEMM", marker='s',markersize=ms,  color = color[3], clip_on=False)
...
ax[1].plot(N, thread_abft_kernel[:l] / 1000, linestyle='dotted', label="Thread-level FT-SGEMM", marker='o',markersize=ms*0.9,  color = color[3], clip_on=False)
ax[1].plot(N, warp_abft_kernel[:l] / 1000,  linestyle='dashed',label="Warp-level FT-SGEMM", marker='x',markersize=ms,  color = color[3], clip_on=False)
ax[1].plot(N, abft_kernel_huge[:l] / 1000,  label="Threadblock-level FT-SGEMM", marker='s',markersize=ms,  color = color[3], clip_on=False)
