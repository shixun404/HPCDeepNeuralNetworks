...
ax[0].plot(N, abft_baseline[:l] / 1000, label="Ding et al. 2011: on", marker='^',markersize=ms,  color = color[0], clip_on=False)
...
ax[1].plot(N, abft_baseline[:l] / 1000, label="Ding et al. 2011: on", marker='^',markersize=ms,  color = color[0], clip_on=False)
