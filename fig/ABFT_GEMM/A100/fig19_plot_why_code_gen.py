...
ax[0].plot(N, kernel_[:l] / performance_scale, linewidth=ls, marker='P',markersize=ms, color = color[2], label="Fused FT: off",clip_on=False)
...
ax[1].plot(N, kernel_[:l] / performance_scale, linewidth=ls, marker='P',markersize=ms, color = color[2], label="Fused FT: off",clip_on=False)
...
ax[1].plot(N, abft_[:l] / performance_scale, linewidth=ls,  marker='s',markersize=ms,  color = color[3], label="Fused FT: on",clip_on=False)
ax[1].plot(N, abft[:l] / performance_scale, '--', linewidth=ls, marker='s',markersize=ms,  color = color[3],label="Codegen FT: on", clip_on=False)
