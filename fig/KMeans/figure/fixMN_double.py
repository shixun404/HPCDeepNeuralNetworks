...
with open("fix_MN_double.csv", "r") as file:
...
for i in range(16):
    ...
    speedup_8_best = speedup_8_best + t_codegen_best_N8[i] / t_raft_N8[i]
    speedup_128_best = speedup_128_best + t_codegen_best_N128[i] / t_raft_N128[i]
...
print("Codegen: Speedup 8: ",speedup_8_best / 16)
print("Codegen: Speedup 128: ",speedup_128_best / 16)
print("Codegen: Overall speedup: ", (speedup_8_best + speedup_128_best) / 32)
...
plt.show()
fig.savefig(f"experiment1_fixMN_double.pdf", bbox_inches='tight')
fig.savefig(f"experiment1_fixMN_double.png", bbox_inches='tight')