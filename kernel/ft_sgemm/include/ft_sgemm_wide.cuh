...
__global__  __launch_bounds__(256) void ft_sgemm_wide(int N, int K, float *A, float *B, float *C, float alpha, float beta){
    // ms = 32, ns = 128, ks = 8
    // mw = 16, nw = 64
    // mr = 4,  nr = 8
    ...
    *(((float4*)buffer_B) + 2 * tx + 1) = prefetch_vector_tile_B[1];
    ...
    C_res[ 1] = *((float4 *)(C + 0 + N * 1));
    C_res[ 2] = *((float4 *)(C + 0 + N * 2));
    C_res[ 3] = *((float4 *)(C + 0 + N * 3));
    C_res[ 4] = *((float4 *)(C + 0 + N * 4));
    C_res[ 5] = *((float4 *)(C + 0 + N * 5));
    C_res[ 6] = *((float4 *)(C + 0 + N * 6));
    C_res[ 7] = *((float4 *)(C + 0 + N * 7));
    ...
    *((float4 *)(C + 0 + N * 1)) = C_res[ 1];
    *((float4 *)(C + 0 + N * 2)) = C_res[ 2];
    *((float4 *)(C + 0 + N * 3)) = C_res[ 3];
    *((float4 *)(C + 0 + N * 4)) = C_res[ 4];
    *((float4 *)(C + 0 + N * 5)) = C_res[ 5];
    *((float4 *)(C + 0 + N * 6)) = C_res[ 6];
    *((float4 *)(C + 0 + N * 7)) = C_res[ 7];
}