...
__global__  __launch_bounds__(256) void ft_sgemm_3(int N, float *A, float *B, float *C, float alpha, float beta){
    ...
    float4 t[16], bb0,aa0,bb1, aa1, C1[16], C_c[2], C_r[2], C_c_ref[2], C_r_ref[2];
    float A_c, B_r = 0.; 
    ...
    *(float4*)((float*)shared_C_r_ref + shared_row_idx + 4) = C_r_ref[1];  
    ...
    while(i != 0){
        if(wx < i){
            tcab((*(float4*)((float*)shared_C_c + (wx + i) * 8 + wy * 128)), (*(float4*)((float*)shared_C_c + wx * 8 + wy * 128)), 1.0, 1.0);
            tcab((*(float4*)((float*)shared_C_c + (wx + i) * 8 + 4 + wy * 128)), (*(float4*)((float*)shared_C_c + wx * 8 + 4 + wy * 128)), 1.0, 1.0);
            tcab((*(float4*)((float*)shared_C_r + (wx + i) * 8 + wy * 128)), (*(float4*)((float*)shared_C_r + wx * 8 + wy * 128)), 1.0, 1.0);
            tcab((*(float4*)((float*)shared_C_r + (wx + i) * 8 + 4 + wy * 128)), (*(float4*)((float*)shared_C_r + wx * 8 + 4 + wy * 128)), 1.0, 1.0);
            tcab((*(float4*)((float*)shared_C_c_ref + (wx + i) * 8 + wy * 128)), (*(float4*)((float*)shared_C_c_ref + wx * 8 + wy * 128)), 1.0, 1.0);
            tcab((*(float4*)((float*)shared_C_c_ref + (wx + i) * 8 + 4 + wy * 128)), (*(float4*)((float*)shared_C_c_ref + wx * 8 + 4 + wy * 128)), 1.0, 1.0);
            tcab((*(float4*)((float*)shared_C_r_ref + (wx + i) * 8 + wy * 128)), (*(float4*)((float*)shared_C_r_ref + wx * 8 + wy * 128)), 1.0, 1.0);
            tcab((*(float4*)((float*)shared_C_r_ref + (wx + i) * 8 + 4 + wy * 128)), (*(float4*)((float*)shared_C_r_ref + wx * 8 + 4 + wy * 128)), 1.0, 1.0);
