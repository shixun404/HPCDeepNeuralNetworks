...
__global__  __launch_bounds__(256) void sgemm_test(int M, int N, int K, float *A, float *B, float *C, float alpha, float beta){
    // ms = 128, ns = 32, ks = 8
    // mw = 64, nw = 16
    // mr = 8, nr = 4
    // blockId, warpId, and threadIdx
    
    int ms = 64, ns = 64, ks = 8, mw = 16, nw = 32, mr = 4, nr = 4;
