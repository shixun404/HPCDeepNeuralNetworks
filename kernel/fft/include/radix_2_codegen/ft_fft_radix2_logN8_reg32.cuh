extern __shared__ float shared[];
    ...
    __global__ void __launch_bounds__(32) fft_radix2_logN8(float2* inputs, float2* outputs, float2* r_1) {
    ...
    float2 temp_0;
        ...
        *(float4*)(((float*)sdata) + tid * 16 + 3 * 4) = tmp_r;
        ...
        temp_0 = inputs[(ty + 0 * 8) + (tx + bx * 4) * 256];
        temp_1 = inputs[(ty + 1 * 8) + (tx + bx * 4) * 256];
        temp_2 = inputs[(ty + 2 * 8) + (tx + bx * 4) * 256];
        temp_3 = inputs[(ty + 3 * 8) + (tx + bx * 4) * 256];
        temp_4 = inputs[(ty + 4 * 8) + (tx + bx * 4) * 256];
        temp_5 = inputs[(ty + 5 * 8) + (tx + bx * 4) * 256];
        temp_6 = inputs[(ty + 6 * 8) + (tx + bx * 4) * 256];
        temp_7 = inputs[(ty + 7 * 8) + (tx + bx * 4) * 256];
        temp_8 = inputs[(ty + 8 * 8) + (tx + bx * 4) * 256];
        temp_9 = inputs[(ty + 9 * 8) + (tx + bx * 4) * 256];
        temp_10 = inputs[(ty + 10 * 8) + (tx + bx * 4) * 256];
        temp_11 = inputs[(ty + 11 * 8) + (tx + bx * 4) * 256];
        temp_12 = inputs[(ty + 12 * 8) + (tx + bx * 4) * 256];
        temp_13 = inputs[(ty + 13 * 8) + (tx + bx * 4) * 256];
        temp_14 = inputs[(ty + 14 * 8) + (tx + bx * 4) * 256];
        temp_15 = inputs[(ty + 15 * 8) + (tx + bx * 4) * 256];
        temp_16 = inputs[(ty + 16 * 8) + (tx + bx * 4) * 256];
        temp_17 = inputs[(ty + 17 * 8) + (tx + bx * 4) * 256];
        temp_18 = inputs[(ty + 18 * 8) + (tx + bx * 4) * 256];
        temp_19 = inputs[(ty + 19 * 8) + (tx + bx * 4) * 256];
        temp_20 = inputs[(ty + 20 * 8) + (tx + bx * 4) * 256];
        temp_21 = inputs[(ty + 21 * 8) + (tx + bx * 4) * 256];
        temp_22 = inputs[(ty + 22 * 8) + (tx + bx * 4) * 256];
        temp_23 = inputs[(ty + 23 * 8) + (tx + bx * 4) * 256];
        temp_24 = inputs[(ty + 24 * 8) + (tx + bx * 4) * 256];
        temp_25 = inputs[(ty + 25 * 8) + (tx + bx * 4) * 256];
        temp_26 = inputs[(ty + 26 * 8) + (tx + bx * 4) * 256];
        temp_27 = inputs[(ty + 27 * 8) + (tx + bx * 4) * 256];
        temp_28 = inputs[(ty + 28 * 8) + (tx + bx * 4) * 256];
        temp_29 = inputs[(ty + 29 * 8) + (tx + bx * 4) * 256];
        temp_30 = inputs[(ty + 30 * 8) + (tx + bx * 4) * 256];
        temp_31 = inputs[(ty + 31 * 8) + (tx + bx * 4) * 256];
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 16) / (float)(256), tmp_angle);
    MY_MUL(temp_1, tmp_angle, tmp);
    temp_1 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 17) / (float)(256), tmp_angle);
    MY_MUL(temp_17, tmp_angle, tmp);
    temp_17 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 18) / (float)(256), tmp_angle);
    MY_MUL(temp_9, tmp_angle, tmp);
    temp_9 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 19) / (float)(256), tmp_angle);
    MY_MUL(temp_25, tmp_angle, tmp);
    temp_25 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 20) / (float)(256), tmp_angle);
    MY_MUL(temp_5, tmp_angle, tmp);
    temp_5 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 21) / (float)(256), tmp_angle);
    MY_MUL(temp_21, tmp_angle, tmp);
    temp_21 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 22) / (float)(256), tmp_angle);
    MY_MUL(temp_13, tmp_angle, tmp);
    temp_13 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 23) / (float)(256), tmp_angle);
    MY_MUL(temp_29, tmp_angle, tmp);
    temp_29 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 24) / (float)(256), tmp_angle);
    MY_MUL(temp_3, tmp_angle, tmp);
    temp_3 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 25) / (float)(256), tmp_angle);
    MY_MUL(temp_19, tmp_angle, tmp);
    temp_19 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 26) / (float)(256), tmp_angle);
    MY_MUL(temp_11, tmp_angle, tmp);
    temp_11 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 27) / (float)(256), tmp_angle);
    MY_MUL(temp_27, tmp_angle, tmp);
    temp_27 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 28) / (float)(256), tmp_angle);
    MY_MUL(temp_7, tmp_angle, tmp);
    temp_7 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 29) / (float)(256), tmp_angle);
    MY_MUL(temp_23, tmp_angle, tmp);
    temp_23 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 30) / (float)(256), tmp_angle);
    MY_MUL(temp_15, tmp_angle, tmp);
    temp_15 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 31) / (float)(256), tmp_angle);
    MY_MUL(temp_31, tmp_angle, tmp);
    temp_31 = tmp;
        ...
        sdata[((tx + 4 * __id[16]) / 16) * 17 + 
        ((tx + 4 * __id[16]) % 16)] = temp_16;
        
        sdata[((tx + 4 * __id[8]) / 16) * 17 + 
        ((tx + 4 * __id[8]) % 16)] = temp_8;
        
        sdata[((tx + 4 * __id[24]) / 16) * 17 + 
        ((tx + 4 * __id[24]) % 16)] = temp_24;
        
        sdata[((tx + 4 * __id[4]) / 16) * 17 + 
        ((tx + 4 * __id[4]) % 16)] = temp_4;
        
        sdata[((tx + 4 * __id[20]) / 16) * 17 + 
        ((tx + 4 * __id[20]) % 16)] = temp_20;
        
        sdata[((tx + 4 * __id[12]) / 16) * 17 + 
        ((tx + 4 * __id[12]) % 16)] = temp_12;
        
        sdata[((tx + 4 * __id[28]) / 16) * 17 + 
        ((tx + 4 * __id[28]) % 16)] = temp_28;
        
        sdata[((tx + 4 * __id[2]) / 16) * 17 + 
        ((tx + 4 * __id[2]) % 16)] = temp_2;
        
        sdata[((tx + 4 * __id[18]) / 16) * 17 + 
        ((tx + 4 * __id[18]) % 16)] = temp_18;
        
        sdata[((tx + 4 * __id[10]) / 16) * 17 + 
        ((tx + 4 * __id[10]) % 16)] = temp_10;
        
        sdata[((tx + 4 * __id[26]) / 16) * 17 + 
        ((tx + 4 * __id[26]) % 16)] = temp_26;
        
        sdata[((tx + 4 * __id[6]) / 16) * 17 + 
        ((tx + 4 * __id[6]) % 16)] = temp_6;
        
        sdata[((tx + 4 * __id[22]) / 16) * 17 + 
        ((tx + 4 * __id[22]) % 16)] = temp_22;
        
        sdata[((tx + 4 * __id[14]) / 16) * 17 + 
        ((tx + 4 * __id[14]) % 16)] = temp_14;
        
        sdata[((tx + 4 * __id[30]) / 16) * 17 + 
        ((tx + 4 * __id[30]) % 16)] = temp_30;
        
        sdata[((tx + 4 * __id[1]) / 16) * 17 + 
        ((tx + 4 * __id[1]) % 16)] = temp_1;
        
        sdata[((tx + 4 * __id[17]) / 16) * 17 + 
        ((tx + 4 * __id[17]) % 16)] = temp_17;
        
        sdata[((tx + 4 * __id[9]) / 16) * 17 + 
        ((tx + 4 * __id[9]) % 16)] = temp_9;
        
        sdata[((tx + 4 * __id[25]) / 16) * 17 + 
        ((tx + 4 * __id[25]) % 16)] = temp_25;
        
        sdata[((tx + 4 * __id[5]) / 16) * 17 + 
        ((tx + 4 * __id[5]) % 16)] = temp_5;
        
        sdata[((tx + 4 * __id[21]) / 16) * 17 + 
        ((tx + 4 * __id[21]) % 16)] = temp_21;
        
        sdata[((tx + 4 * __id[13]) / 16) * 17 + 
        ((tx + 4 * __id[13]) % 16)] = temp_13;
        
        sdata[((tx + 4 * __id[29]) / 16) * 17 + 
        ((tx + 4 * __id[29]) % 16)] = temp_29;
        
        sdata[((tx + 4 * __id[3]) / 16) * 17 + 
        ((tx + 4 * __id[3]) % 16)] = temp_3;
        
        sdata[((tx + 4 * __id[19]) / 16) * 17 + 
        ((tx + 4 * __id[19]) % 16)] = temp_19;
        
        sdata[((tx + 4 * __id[11]) / 16) * 17 + 
        ((tx + 4 * __id[11]) % 16)] = temp_11;
        
        sdata[((tx + 4 * __id[27]) / 16) * 17 + 
        ((tx + 4 * __id[27]) % 16)] = temp_27;
        
        sdata[((tx + 4 * __id[7]) / 16) * 17 + 
        ((tx + 4 * __id[7]) % 16)] = temp_7;
        
        sdata[((tx + 4 * __id[23]) / 16) * 17 + 
        ((tx + 4 * __id[23]) % 16)] = temp_23;
        
        sdata[((tx + 4 * __id[15]) / 16) * 17 + 
        ((tx + 4 * __id[15]) % 16)] = temp_15;
        
        sdata[((tx + 4 * __id[31]) / 16) * 17 + 
        ((tx + 4 * __id[31]) % 16)] = temp_31;
        ...
        temp_1 = sdata[((tx + 4 * (8 + ty)) / 16) * 17 +
                            ((tx + 4 * (8 + ty)) % 16)];
        __id[1] = ty + 8;
        
        temp_2 = sdata[((tx + 4 * (16 + ty)) / 16) * 17 +
                            ((tx + 4 * (16 + ty)) % 16)];
        __id[2] = ty + 16;
        
        temp_3 = sdata[((tx + 4 * (24 + ty)) / 16) * 17 +
                            ((tx + 4 * (24 + ty)) % 16)];
        __id[3] = ty + 24;
        
        temp_4 = sdata[((tx + 4 * (32 + ty)) / 16) * 17 +
                            ((tx + 4 * (32 + ty)) % 16)];
        __id[4] = ty + 32;
        
        temp_5 = sdata[((tx + 4 * (40 + ty)) / 16) * 17 +
                            ((tx + 4 * (40 + ty)) % 16)];
        __id[5] = ty + 40;
        
        temp_6 = sdata[((tx + 4 * (48 + ty)) / 16) * 17 +
                            ((tx + 4 * (48 + ty)) % 16)];
        __id[6] = ty + 48;
        
        temp_7 = sdata[((tx + 4 * (56 + ty)) / 16) * 17 +
                            ((tx + 4 * (56 + ty)) % 16)];
        __id[7] = ty + 56;
        
        temp_8 = sdata[((tx + 4 * (64 + ty)) / 16) * 17 +
                            ((tx + 4 * (64 + ty)) % 16)];
        __id[8] = ty + 64;
        
        temp_9 = sdata[((tx + 4 * (72 + ty)) / 16) * 17 +
                            ((tx + 4 * (72 + ty)) % 16)];
        __id[9] = ty + 72;
        
        temp_10 = sdata[((tx + 4 * (80 + ty)) / 16) * 17 +
                            ((tx + 4 * (80 + ty)) % 16)];
        __id[10] = ty + 80;
        
        temp_11 = sdata[((tx + 4 * (88 + ty)) / 16) * 17 +
                            ((tx + 4 * (88 + ty)) % 16)];
        __id[11] = ty + 88;
        
        temp_12 = sdata[((tx + 4 * (96 + ty)) / 16) * 17 +
                            ((tx + 4 * (96 + ty)) % 16)];
        __id[12] = ty + 96;
        
        temp_13 = sdata[((tx + 4 * (104 + ty)) / 16) * 17 +
                            ((tx + 4 * (104 + ty)) % 16)];
        __id[13] = ty + 104;
        
        temp_14 = sdata[((tx + 4 * (112 + ty)) / 16) * 17 +
                            ((tx + 4 * (112 + ty)) % 16)];
        __id[14] = ty + 112;
        
        temp_15 = sdata[((tx + 4 * (120 + ty)) / 16) * 17 +
                            ((tx + 4 * (120 + ty)) % 16)];
        __id[15] = ty + 120;
        
        temp_16 = sdata[((tx + 4 * (128 + ty)) / 16) * 17 +
                            ((tx + 4 * (128 + ty)) % 16)];
        __id[16] = ty + 128;
        
        temp_17 = sdata[((tx + 4 * (136 + ty)) / 16) * 17 +
                            ((tx + 4 * (136 + ty)) % 16)];
        __id[17] = ty + 136;
        
        temp_18 = sdata[((tx + 4 * (144 + ty)) / 16) * 17 +
                            ((tx + 4 * (144 + ty)) % 16)];
        __id[18] = ty + 144;
        
        temp_19 = sdata[((tx + 4 * (152 + ty)) / 16) * 17 +
                            ((tx + 4 * (152 + ty)) % 16)];
        __id[19] = ty + 152;
        
        temp_20 = sdata[((tx + 4 * (160 + ty)) / 16) * 17 +
                            ((tx + 4 * (160 + ty)) % 16)];
        __id[20] = ty + 160;
        
        temp_21 = sdata[((tx + 4 * (168 + ty)) / 16) * 17 +
                            ((tx + 4 * (168 + ty)) % 16)];
        __id[21] = ty + 168;
        
        temp_22 = sdata[((tx + 4 * (176 + ty)) / 16) * 17 +
                            ((tx + 4 * (176 + ty)) % 16)];
        __id[22] = ty + 176;
        
        temp_23 = sdata[((tx + 4 * (184 + ty)) / 16) * 17 +
                            ((tx + 4 * (184 + ty)) % 16)];
        __id[23] = ty + 184;
        
        temp_24 = sdata[((tx + 4 * (192 + ty)) / 16) * 17 +
                            ((tx + 4 * (192 + ty)) % 16)];
        __id[24] = ty + 192;
        
        temp_25 = sdata[((tx + 4 * (200 + ty)) / 16) * 17 +
                            ((tx + 4 * (200 + ty)) % 16)];
        __id[25] = ty + 200;
        
        temp_26 = sdata[((tx + 4 * (208 + ty)) / 16) * 17 +
                            ((tx + 4 * (208 + ty)) % 16)];
        __id[26] = ty + 208;
        
        temp_27 = sdata[((tx + 4 * (216 + ty)) / 16) * 17 +
                            ((tx + 4 * (216 + ty)) % 16)];
        __id[27] = ty + 216;
        
        temp_28 = sdata[((tx + 4 * (224 + ty)) / 16) * 17 +
                            ((tx + 4 * (224 + ty)) % 16)];
        __id[28] = ty + 224;
        
        temp_29 = sdata[((tx + 4 * (232 + ty)) / 16) * 17 +
                            ((tx + 4 * (232 + ty)) % 16)];
        __id[29] = ty + 232;
        
        temp_30 = sdata[((tx + 4 * (240 + ty)) / 16) * 17 +
                            ((tx + 4 * (240 + ty)) % 16)];
        __id[30] = ty + 240;
        
        temp_31 = sdata[((tx + 4 * (248 + ty)) / 16) * 17 +
                            ((tx + 4 * (248 + ty)) % 16)];
        __id[31] = ty + 248;
        ...
        outputs[(tx + bx * 4) * 256 +  __id[16]] = temp_16;
        
        outputs[(tx + bx * 4) * 256 +  __id[17]] = temp_17;
        
        outputs[(tx + bx * 4) * 256 +  __id[18]] = temp_18;
        
        outputs[(tx + bx * 4) * 256 +  __id[19]] = temp_19;
        
        outputs[(tx + bx * 4) * 256 +  __id[8]] = temp_8;
        
        outputs[(tx + bx * 4) * 256 +  __id[9]] = temp_9;
        
        outputs[(tx + bx * 4) * 256 +  __id[10]] = temp_10;
        
        outputs[(tx + bx * 4) * 256 +  __id[11]] = temp_11;
        
        outputs[(tx + bx * 4) * 256 +  __id[24]] = temp_24;
        
        outputs[(tx + bx * 4) * 256 +  __id[25]] = temp_25;
        
        outputs[(tx + bx * 4) * 256 +  __id[26]] = temp_26;
        
        outputs[(tx + bx * 4) * 256 +  __id[27]] = temp_27;
        ...
        outputs[(tx + bx * 4) * 256 +  __id[20]] = temp_20;
        
        outputs[(tx + bx * 4) * 256 +  __id[21]] = temp_21;
        
        outputs[(tx + bx * 4) * 256 +  __id[22]] = temp_22;
        
        outputs[(tx + bx * 4) * 256 +  __id[23]] = temp_23;
        
        outputs[(tx + bx * 4) * 256 +  __id[12]] = temp_12;
        
        outputs[(tx + bx * 4) * 256 +  __id[13]] = temp_13;
        
        outputs[(tx + bx * 4) * 256 +  __id[14]] = temp_14;
        
        outputs[(tx + bx * 4) * 256 +  __id[15]] = temp_15;
        
        outputs[(tx + bx * 4) * 256 +  __id[28]] = temp_28;
        
        outputs[(tx + bx * 4) * 256 +  __id[29]] = temp_29;
        
        outputs[(tx + bx * 4) * 256 +  __id[30]] = temp_30;
        
        outputs[(tx + bx * 4) * 256 +  __id[31]] = temp_31;
