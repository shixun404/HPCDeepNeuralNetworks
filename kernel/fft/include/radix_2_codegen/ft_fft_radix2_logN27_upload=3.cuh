...
__global__ void __launch_bounds__(512) fft_radix2_logN27_3(float2* inputs, float2* outputs, float2* r_1) {
    ...
    temp_0 = inputs[(tx + 32 * ty + 0 * 512) % 512 + (((bx % 32) * 16) + ((tx + 32 * ty + 0 * 512) / 512)) * 262144 + (bx / 32) * 512];
        sdata[(tx + 32 * ty + 0 * 512) % 512 + ((tx + 32 * ty + 0 * 512) / 512) * 512] = temp_0;
    temp_1 = inputs[(tx + 32 * ty + 1 * 512) % 512 + (((bx % 32) * 16) + ((tx + 32 * ty + 1 * 512) / 512)) * 262144 + (bx / 32) * 512];
        sdata[(tx + 32 * ty + 1 * 512) % 512 + ((tx + 32 * ty + 1 * 512) / 512) * 512] = temp_1;
    temp_2 = inputs[(tx + 32 * ty + 2 * 512) % 512 + (((bx % 32) * 16) + ((tx + 32 * ty + 2 * 512) / 512)) * 262144 + (bx / 32) * 512];
        sdata[(tx + 32 * ty + 2 * 512) % 512 + ((tx + 32 * ty + 2 * 512) / 512) * 512] = temp_2;
    temp_3 = inputs[(tx + 32 * ty + 3 * 512) % 512 + (((bx % 32) * 16) + ((tx + 32 * ty + 3 * 512) / 512)) * 262144 + (bx / 32) * 512];
        sdata[(tx + 32 * ty + 3 * 512) % 512 + ((tx + 32 * ty + 3 * 512) / 512) * 512] = temp_3;
    temp_4 = inputs[(tx + 32 * ty + 4 * 512) % 512 + (((bx % 32) * 16) + ((tx + 32 * ty + 4 * 512) / 512)) * 262144 + (bx / 32) * 512];
        sdata[(tx + 32 * ty + 4 * 512) % 512 + ((tx + 32 * ty + 4 * 512) / 512) * 512] = temp_4;
    temp_5 = inputs[(tx + 32 * ty + 5 * 512) % 512 + (((bx % 32) * 16) + ((tx + 32 * ty + 5 * 512) / 512)) * 262144 + (bx / 32) * 512];
        sdata[(tx + 32 * ty + 5 * 512) % 512 + ((tx + 32 * ty + 5 * 512) / 512) * 512] = temp_5;
    temp_6 = inputs[(tx + 32 * ty + 6 * 512) % 512 + (((bx % 32) * 16) + ((tx + 32 * ty + 6 * 512) / 512)) * 262144 + (bx / 32) * 512];
        sdata[(tx + 32 * ty + 6 * 512) % 512 + ((tx + 32 * ty + 6 * 512) / 512) * 512] = temp_6;
    temp_7 = inputs[(tx + 32 * ty + 7 * 512) % 512 + (((bx % 32) * 16) + ((tx + 32 * ty + 7 * 512) / 512)) * 262144 + (bx / 32) * 512];
        sdata[(tx + 32 * ty + 7 * 512) % 512 + ((tx + 32 * ty + 7 * 512) / 512) * 512] = temp_7;
    temp_8 = inputs[(tx + 32 * ty + 8 * 512) % 512 + (((bx % 32) * 16) + ((tx + 32 * ty + 8 * 512) / 512)) * 262144 + (bx / 32) * 512];
        sdata[(tx + 32 * ty + 8 * 512) % 512 + ((tx + 32 * ty + 8 * 512) / 512) * 512] = temp_8;
    temp_9 = inputs[(tx + 32 * ty + 9 * 512) % 512 + (((bx % 32) * 16) + ((tx + 32 * ty + 9 * 512) / 512)) * 262144 + (bx / 32) * 512];
        sdata[(tx + 32 * ty + 9 * 512) % 512 + ((tx + 32 * ty + 9 * 512) / 512) * 512] = temp_9;
    temp_10 = inputs[(tx + 32 * ty + 10 * 512) % 512 + (((bx % 32) * 16) + ((tx + 32 * ty + 10 * 512) / 512)) * 262144 + (bx / 32) * 512];
        sdata[(tx + 32 * ty + 10 * 512) % 512 + ((tx + 32 * ty + 10 * 512) / 512) * 512] = temp_10;
    temp_11 = inputs[(tx + 32 * ty + 11 * 512) % 512 + (((bx % 32) * 16) + ((tx + 32 * ty + 11 * 512) / 512)) * 262144 + (bx / 32) * 512];
        sdata[(tx + 32 * ty + 11 * 512) % 512 + ((tx + 32 * ty + 11 * 512) / 512) * 512] = temp_11;
    temp_12 = inputs[(tx + 32 * ty + 12 * 512) % 512 + (((bx % 32) * 16) + ((tx + 32 * ty + 12 * 512) / 512)) * 262144 + (bx / 32) * 512];
        sdata[(tx + 32 * ty + 12 * 512) % 512 + ((tx + 32 * ty + 12 * 512) / 512) * 512] = temp_12;
    temp_13 = inputs[(tx + 32 * ty + 13 * 512) % 512 + (((bx % 32) * 16) + ((tx + 32 * ty + 13 * 512) / 512)) * 262144 + (bx / 32) * 512];
        sdata[(tx + 32 * ty + 13 * 512) % 512 + ((tx + 32 * ty + 13 * 512) / 512) * 512] = temp_13;
    temp_14 = inputs[(tx + 32 * ty + 14 * 512) % 512 + (((bx % 32) * 16) + ((tx + 32 * ty + 14 * 512) / 512)) * 262144 + (bx / 32) * 512];
        sdata[(tx + 32 * ty + 14 * 512) % 512 + ((tx + 32 * ty + 14 * 512) / 512) * 512] = temp_14;
    temp_15 = inputs[(tx + 32 * ty + 15 * 512) % 512 + (((bx % 32) * 16) + ((tx + 32 * ty + 15 * 512) / 512)) * 262144 + (bx / 32) * 512];
        sdata[(tx + 32 * ty + 15 * 512) % 512 + ((tx + 32 * ty + 15 * 512) / 512) * 512] = temp_15;
    
    __syncthreads();
    temp_0 = sdata[(tx + 0) + ty * 512];
    temp_1 = sdata[(tx + 32) + ty * 512];
    temp_2 = sdata[(tx + 64) + ty * 512];
    temp_3 = sdata[(tx + 96) + ty * 512];
    temp_4 = sdata[(tx + 128) + ty * 512];
    temp_5 = sdata[(tx + 160) + ty * 512];
    temp_6 = sdata[(tx + 192) + ty * 512];
    temp_7 = sdata[(tx + 224) + ty * 512];
    temp_8 = sdata[(tx + 256) + ty * 512];
    temp_9 = sdata[(tx + 288) + ty * 512];
    temp_10 = sdata[(tx + 320) + ty * 512];
    temp_11 = sdata[(tx + 352) + ty * 512];
    temp_12 = sdata[(tx + 384) + ty * 512];
    temp_13 = sdata[(tx + 416) + ty * 512];
    temp_14 = sdata[(tx + 448) + ty * 512];
    temp_15 = sdata[(tx + 480) + ty * 512];
    __id[0] = 0 + tx;
    __id[1] = 32 + tx;
    __id[2] = 64 + tx;
    __id[3] = 96 + tx;
    ...
    *(float2*)(((float*)sdata) + tid * 2) = tmp_r;
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 1) * 8) / (float)(512), tmp_angle);
    MY_MUL(temp_1, tmp_angle, tmp);
    temp_1 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 1) * 9) / (float)(512), tmp_angle);
    MY_MUL(temp_9, tmp_angle, tmp);
    temp_9 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 1) * 10) / (float)(512), tmp_angle);
    MY_MUL(temp_5, tmp_angle, tmp);
    temp_5 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 1) * 11) / (float)(512), tmp_angle);
    MY_MUL(temp_13, tmp_angle, tmp);
    temp_13 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 1) * 12) / (float)(512), tmp_angle);
    MY_MUL(temp_3, tmp_angle, tmp);
    temp_3 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 1) * 13) / (float)(512), tmp_angle);
    MY_MUL(temp_11, tmp_angle, tmp);
    temp_11 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 1) * 14) / (float)(512), tmp_angle);
    MY_MUL(temp_7, tmp_angle, tmp);
    temp_7 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 1) * 15) / (float)(512), tmp_angle);
    MY_MUL(temp_15, tmp_angle, tmp);
    temp_15 = tmp;
    
    sdata[__id[0] + ty * 512 ] = temp_0;
    
    sdata[__id[8] + ty * 512 ] = temp_8;
    
    sdata[__id[4] + ty * 512 ] = temp_4;
    
    sdata[__id[12] + ty * 512 ] = temp_12;
    
    sdata[__id[2] + ty * 512 ] = temp_2;
    
    sdata[__id[10] + ty * 512 ] = temp_10;
    
    sdata[__id[6] + ty * 512 ] = temp_6;
    
    sdata[__id[14] + ty * 512 ] = temp_14;
    
    sdata[__id[1] + ty * 512 ] = temp_1;
    
    sdata[__id[9] + ty * 512 ] = temp_9;
    
    sdata[__id[5] + ty * 512 ] = temp_5;
    
    sdata[__id[13] + ty * 512 ] = temp_13;
    
    sdata[__id[3] + ty * 512 ] = temp_3;
    
    sdata[__id[11] + ty * 512 ] = temp_11;
    
    sdata[__id[7] + ty * 512 ] = temp_7;
    
    sdata[__id[15] + ty * 512 ] = temp_15;
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 16) * 4) / (float)(32.0), tmp_angle);
    MY_MUL(temp_2, tmp_angle, tmp);
    temp_2 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 16) * 5) / (float)(32.0), tmp_angle);
    MY_MUL(temp_10, tmp_angle, tmp);
    temp_10 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 16) * 6) / (float)(32.0), tmp_angle);
    MY_MUL(temp_6, tmp_angle, tmp);
    temp_6 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 16) * 7) / (float)(32.0), tmp_angle);
    MY_MUL(temp_14, tmp_angle, tmp);
    temp_14 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 16) * 8) / (float)(32.0), tmp_angle);
    MY_MUL(temp_1, tmp_angle, tmp);
    temp_1 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 16) * 9) / (float)(32.0), tmp_angle);
    MY_MUL(temp_9, tmp_angle, tmp);
    temp_9 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 16) * 10) / (float)(32.0), tmp_angle);
    MY_MUL(temp_5, tmp_angle, tmp);
    temp_5 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 16) * 11) / (float)(32.0), tmp_angle);
    MY_MUL(temp_13, tmp_angle, tmp);
    temp_13 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 16) * 12) / (float)(32.0), tmp_angle);
    MY_MUL(temp_3, tmp_angle, tmp);
    temp_3 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 16) * 13) / (float)(32.0), tmp_angle);
    MY_MUL(temp_11, tmp_angle, tmp);
    temp_11 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 16) * 14) / (float)(32.0), tmp_angle);
    MY_MUL(temp_7, tmp_angle, tmp);
    temp_7 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 16) * 15) / (float)(32.0), tmp_angle);
    MY_MUL(temp_15, tmp_angle, tmp);
    temp_15 = tmp;
    ...
    temp_0 = sdata[((tx + ty * 32 + 0) / 16) + ((tx + ty * 32 + 0) % 16) * 512];
    outputs[(((tx + ty * 32 + 0) % 16) + (bx % 32) * 16) + (bx / 32) * 512 + ((tx + ty * 32 + 0) / 16) * 262144] = temp_0; 
    
    //        |    x3             |      |    x2  * N3        |                   |    x1  * N3        |
    //inputs[tx + 32 + ty * 262144 + (bx % 32) * 4194304 + (bx / 32 * 512)]
    // printf("############ finish bx = %d, tx = %d, ty = %d, ###########\n", bx, tx, ty);
    ...
    temp_0 = sdata[((tx + ty * 32 + 512) / 16) + ((tx + ty * 32 + 512) % 16) * 512];
    outputs[(((tx + ty * 32 + 512) % 16) + (bx % 32) * 16) + (bx / 32) * 512 + ((tx + ty * 32 + 512) / 16) * 262144] = temp_0; 
    ...
    temp_0 = sdata[((tx + ty * 32 + 1024) / 16) + ((tx + ty * 32 + 1024) % 16) * 512];
    outputs[(((tx + ty * 32 + 1024) % 16) + (bx % 32) * 16) + (bx / 32) * 512 + ((tx + ty * 32 + 1024) / 16) * 262144] = temp_0; 
    
    //        |    x3             |      |    x2  * N3        |                   |    x1  * N3        |
    //inputs[tx + 96 + ty * 262144 + (bx % 32) * 4194304 + (bx / 32 * 512)]
    // printf("############ finish bx = %d, tx = %d, ty = %d, ###########\n", bx, tx, ty);
    ...
    temp_0 = sdata[((tx + ty * 32 + 1536) / 16) + ((tx + ty * 32 + 1536) % 16) * 512];
    outputs[(((tx + ty * 32 + 1536) % 16) + (bx % 32) * 16) + (bx / 32) * 512 + ((tx + ty * 32 + 1536) / 16) * 262144] = temp_0; 
    ...
    temp_0 = sdata[((tx + ty * 32 + 2048) / 16) + ((tx + ty * 32 + 2048) % 16) * 512];
    outputs[(((tx + ty * 32 + 2048) % 16) + (bx % 32) * 16) + (bx / 32) * 512 + ((tx + ty * 32 + 2048) / 16) * 262144] = temp_0; 
    
    //        |    x3             |      |    x2  * N3        |                   |    x1  * N3        |
    //inputs[tx + 160 + ty * 262144 + (bx % 32) * 4194304 + (bx / 32 * 512)]
    // printf("############ finish bx = %d, tx = %d, ty = %d, ###########\n", bx, tx, ty);
    ...
    temp_0 = sdata[((tx + ty * 32 + 2560) / 16) + ((tx + ty * 32 + 2560) % 16) * 512];
    outputs[(((tx + ty * 32 + 2560) % 16) + (bx % 32) * 16) + (bx / 32) * 512 + ((tx + ty * 32 + 2560) / 16) * 262144] = temp_0; 
    ...
    temp_0 = sdata[((tx + ty * 32 + 3072) / 16) + ((tx + ty * 32 + 3072) % 16) * 512];
    outputs[(((tx + ty * 32 + 3072) % 16) + (bx % 32) * 16) + (bx / 32) * 512 + ((tx + ty * 32 + 3072) / 16) * 262144] = temp_0; 
    
    //        |    x3             |      |    x2  * N3        |                   |    x1  * N3        |
    //inputs[tx + 224 + ty * 262144 + (bx % 32) * 4194304 + (bx / 32 * 512)]
    // printf("############ finish bx = %d, tx = %d, ty = %d, ###########\n", bx, tx, ty);
    ...
    temp_0 = sdata[((tx + ty * 32 + 3584) / 16) + ((tx + ty * 32 + 3584) % 16) * 512];
    outputs[(((tx + ty * 32 + 3584) % 16) + (bx % 32) * 16) + (bx / 32) * 512 + ((tx + ty * 32 + 3584) / 16) * 262144] = temp_0; 
    
    //        |    x3             |      |    x2  * N3        |                   |    x1  * N3        |
    //inputs[tx + 256 + ty * 262144 + (bx % 32) * 4194304 + (bx / 32 * 512)]
    // printf("############ finish bx = %d, tx = %d, ty = %d, ###########\n", bx, tx, ty);
    
    // outputs[(bx / 32) + ((bx % 32) * 16 + ty) * 512 + (__id[8]) * 262144] = temp_8;
    // outputs[(ty + (bx % 32) * 16) + (bx / 32) * 512 + (__id[8]) * 262144] = temp_8; 
    
    
    temp_0 = sdata[((tx + ty * 32 + 4096) / 16) + ((tx + ty * 32 + 4096) % 16) * 512];
    outputs[(((tx + ty * 32 + 4096) % 16) + (bx % 32) * 16) + (bx / 32) * 512 + ((tx + ty * 32 + 4096) / 16) * 262144] = temp_0; 
    
    //        |    x3             |      |    x2  * N3        |                   |    x1  * N3        |
    //inputs[tx + 288 + ty * 262144 + (bx % 32) * 4194304 + (bx / 32 * 512)]
    // printf("############ finish bx = %d, tx = %d, ty = %d, ###########\n", bx, tx, ty);
    
    // outputs[(bx / 32) + ((bx % 32) * 16 + ty) * 512 + (__id[9]) * 262144] = temp_9;
    // outputs[(ty + (bx % 32) * 16) + (bx / 32) * 512 + (__id[9]) * 262144] = temp_9; 
    
    
    temp_0 = sdata[((tx + ty * 32 + 4608) / 16) + ((tx + ty * 32 + 4608) % 16) * 512];
    outputs[(((tx + ty * 32 + 4608) % 16) + (bx % 32) * 16) + (bx / 32) * 512 + ((tx + ty * 32 + 4608) / 16) * 262144] = temp_0; 
    
    //        |    x3             |      |    x2  * N3        |                   |    x1  * N3        |
    //inputs[tx + 320 + ty * 262144 + (bx % 32) * 4194304 + (bx / 32 * 512)]
    // printf("############ finish bx = %d, tx = %d, ty = %d, ###########\n", bx, tx, ty);
    
    // outputs[(bx / 32) + ((bx % 32) * 16 + ty) * 512 + (__id[10]) * 262144] = temp_10;
    // outputs[(ty + (bx % 32) * 16) + (bx / 32) * 512 + (__id[10]) * 262144] = temp_10; 
    
    
    temp_0 = sdata[((tx + ty * 32 + 5120) / 16) + ((tx + ty * 32 + 5120) % 16) * 512];
    outputs[(((tx + ty * 32 + 5120) % 16) + (bx % 32) * 16) + (bx / 32) * 512 + ((tx + ty * 32 + 5120) / 16) * 262144] = temp_0; 
    
    //        |    x3             |      |    x2  * N3        |                   |    x1  * N3        |
    //inputs[tx + 352 + ty * 262144 + (bx % 32) * 4194304 + (bx / 32 * 512)]
    // printf("############ finish bx = %d, tx = %d, ty = %d, ###########\n", bx, tx, ty);
    
    // outputs[(bx / 32) + ((bx % 32) * 16 + ty) * 512 + (__id[11]) * 262144] = temp_11;
    // outputs[(ty + (bx % 32) * 16) + (bx / 32) * 512 + (__id[11]) * 262144] = temp_11; 
    
    
    temp_0 = sdata[((tx + ty * 32 + 5632) / 16) + ((tx + ty * 32 + 5632) % 16) * 512];
    outputs[(((tx + ty * 32 + 5632) % 16) + (bx % 32) * 16) + (bx / 32) * 512 + ((tx + ty * 32 + 5632) / 16) * 262144] = temp_0; 
    
    //        |    x3             |      |    x2  * N3        |                   |    x1  * N3        |
    //inputs[tx + 384 + ty * 262144 + (bx % 32) * 4194304 + (bx / 32 * 512)]
    // printf("############ finish bx = %d, tx = %d, ty = %d, ###########\n", bx, tx, ty);
    
    // outputs[(bx / 32) + ((bx % 32) * 16 + ty) * 512 + (__id[12]) * 262144] = temp_12;
    // outputs[(ty + (bx % 32) * 16) + (bx / 32) * 512 + (__id[12]) * 262144] = temp_12; 
    
    
    temp_0 = sdata[((tx + ty * 32 + 6144) / 16) + ((tx + ty * 32 + 6144) % 16) * 512];
    outputs[(((tx + ty * 32 + 6144) % 16) + (bx % 32) * 16) + (bx / 32) * 512 + ((tx + ty * 32 + 6144) / 16) * 262144] = temp_0; 
    
    //        |    x3             |      |    x2  * N3        |                   |    x1  * N3        |
    //inputs[tx + 416 + ty * 262144 + (bx % 32) * 4194304 + (bx / 32 * 512)]
    // printf("############ finish bx = %d, tx = %d, ty = %d, ###########\n", bx, tx, ty);
    
    // outputs[(bx / 32) + ((bx % 32) * 16 + ty) * 512 + (__id[13]) * 262144] = temp_13;
    // outputs[(ty + (bx % 32) * 16) + (bx / 32) * 512 + (__id[13]) * 262144] = temp_13; 
    
    
    temp_0 = sdata[((tx + ty * 32 + 6656) / 16) + ((tx + ty * 32 + 6656) % 16) * 512];
    outputs[(((tx + ty * 32 + 6656) % 16) + (bx % 32) * 16) + (bx / 32) * 512 + ((tx + ty * 32 + 6656) / 16) * 262144] = temp_0; 
    
    //        |    x3             |      |    x2  * N3        |                   |    x1  * N3        |
    //inputs[tx + 448 + ty * 262144 + (bx % 32) * 4194304 + (bx / 32 * 512)]
    // printf("############ finish bx = %d, tx = %d, ty = %d, ###########\n", bx, tx, ty);
    
    // outputs[(bx / 32) + ((bx % 32) * 16 + ty) * 512 + (__id[14]) * 262144] = temp_14;
    // outputs[(ty + (bx % 32) * 16) + (bx / 32) * 512 + (__id[14]) * 262144] = temp_14; 
    
    
    temp_0 = sdata[((tx + ty * 32 + 7168) / 16) + ((tx + ty * 32 + 7168) % 16) * 512];
    outputs[(((tx + ty * 32 + 7168) % 16) + (bx % 32) * 16) + (bx / 32) * 512 + ((tx + ty * 32 + 7168) / 16) * 262144] = temp_0; 
    
    //        |    x3             |      |    x2  * N3        |                   |    x1  * N3        |
    //inputs[tx + 480 + ty * 262144 + (bx % 32) * 4194304 + (bx / 32 * 512)]
    // printf("############ finish bx = %d, tx = %d, ty = %d, ###########\n", bx, tx, ty);
    
    // outputs[(bx / 32) + ((bx % 32) * 16 + ty) * 512 + (__id[15]) * 262144] = temp_15;
    // outputs[(ty + (bx % 32) * 16) + (bx / 32) * 512 + (__id[15]) * 262144] = temp_15; 
    
    
    temp_0 = sdata[((tx + ty * 32 + 7680) / 16) + ((tx + ty * 32 + 7680) % 16) * 512];
    outputs[(((tx + ty * 32 + 7680) % 16) + (bx % 32) * 16) + (bx / 32) * 512 + ((tx + ty * 32 + 7680) / 16) * 262144] = temp_0; 
