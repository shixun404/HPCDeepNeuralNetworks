extern __shared__ float shared[];
    __global__ void __launch_bounds__(256) fft_radix2_logN10(float2* inputs, float2* outputs, float2* r_1) {
    ...
    float2 temp_0;
        ...
        *(float4*)(((float*)sdata) + tid * 8 + 1 * 4) = tmp_r;
        ...
        temp_0 = inputs[(ty + 0 * 64) + (tx + bx * 4) * 1024];
        temp_1 = inputs[(ty + 1 * 64) + (tx + bx * 4) * 1024];
        temp_2 = inputs[(ty + 2 * 64) + (tx + bx * 4) * 1024];
        temp_3 = inputs[(ty + 3 * 64) + (tx + bx * 4) * 1024];
        temp_4 = inputs[(ty + 4 * 64) + (tx + bx * 4) * 1024];
        temp_5 = inputs[(ty + 5 * 64) + (tx + bx * 4) * 1024];
        temp_6 = inputs[(ty + 6 * 64) + (tx + bx * 4) * 1024];
        temp_7 = inputs[(ty + 7 * 64) + (tx + bx * 4) * 1024];
        temp_8 = inputs[(ty + 8 * 64) + (tx + bx * 4) * 1024];
        temp_9 = inputs[(ty + 9 * 64) + (tx + bx * 4) * 1024];
        temp_10 = inputs[(ty + 10 * 64) + (tx + bx * 4) * 1024];
        temp_11 = inputs[(ty + 11 * 64) + (tx + bx * 4) * 1024];
        temp_12 = inputs[(ty + 12 * 64) + (tx + bx * 4) * 1024];
        temp_13 = inputs[(ty + 13 * 64) + (tx + bx * 4) * 1024];
        temp_14 = inputs[(ty + 14 * 64) + (tx + bx * 4) * 1024];
        temp_15 = inputs[(ty + 15 * 64) + (tx + bx * 4) * 1024];
    ...
    temp_15 = tmp;
        ...
        temp_1 = sdata[((tx + 4 * (64 + ty)) / 16) * 17 +
                            ((tx + 4 * (64 + ty)) % 16)];
        __id[1] = ty + 64;
        
        temp_2 = sdata[((tx + 4 * (128 + ty)) / 16) * 17 +
                            ((tx + 4 * (128 + ty)) % 16)];
        __id[2] = ty + 128;
        
        temp_3 = sdata[((tx + 4 * (192 + ty)) / 16) * 17 +
                            ((tx + 4 * (192 + ty)) % 16)];
        __id[3] = ty + 192;
        
        temp_4 = sdata[((tx + 4 * (256 + ty)) / 16) * 17 +
                            ((tx + 4 * (256 + ty)) % 16)];
        __id[4] = ty + 256;
        
        temp_5 = sdata[((tx + 4 * (320 + ty)) / 16) * 17 +
                            ((tx + 4 * (320 + ty)) % 16)];
        __id[5] = ty + 320;
        
        temp_6 = sdata[((tx + 4 * (384 + ty)) / 16) * 17 +
                            ((tx + 4 * (384 + ty)) % 16)];
        __id[6] = ty + 384;
        
        temp_7 = sdata[((tx + 4 * (448 + ty)) / 16) * 17 +
                            ((tx + 4 * (448 + ty)) % 16)];
        __id[7] = ty + 448;
        
        temp_8 = sdata[((tx + 4 * (512 + ty)) / 16) * 17 +
                            ((tx + 4 * (512 + ty)) % 16)];
        __id[8] = ty + 512;
        
        temp_9 = sdata[((tx + 4 * (576 + ty)) / 16) * 17 +
                            ((tx + 4 * (576 + ty)) % 16)];
        __id[9] = ty + 576;
        
        temp_10 = sdata[((tx + 4 * (640 + ty)) / 16) * 17 +
                            ((tx + 4 * (640 + ty)) % 16)];
        __id[10] = ty + 640;
        
        temp_11 = sdata[((tx + 4 * (704 + ty)) / 16) * 17 +
                            ((tx + 4 * (704 + ty)) % 16)];
        __id[11] = ty + 704;
        
        temp_12 = sdata[((tx + 4 * (768 + ty)) / 16) * 17 +
                            ((tx + 4 * (768 + ty)) % 16)];
        __id[12] = ty + 768;
        
        temp_13 = sdata[((tx + 4 * (832 + ty)) / 16) * 17 +
                            ((tx + 4 * (832 + ty)) % 16)];
        __id[13] = ty + 832;
        
        temp_14 = sdata[((tx + 4 * (896 + ty)) / 16) * 17 +
                            ((tx + 4 * (896 + ty)) % 16)];
        __id[14] = ty + 896;
        
        temp_15 = sdata[((tx + 4 * (960 + ty)) / 16) * 17 +
                            ((tx + 4 * (960 + ty)) % 16)];
        __id[15] = ty + 960;
