extern __shared__ float shared[];
    __global__ void __launch_bounds__(128) fft_radix2_logN18_2(float2* inputs, float2* outputs) {
        ...
        temp_0 = inputs[(tx + 0 * 32) + (ty + bx * 4) * 512];
        temp_1 = inputs[(tx + 1 * 32) + (ty + bx * 4) * 512];
        temp_2 = inputs[(tx + 2 * 32) + (ty + bx * 4) * 512];
        temp_3 = inputs[(tx + 3 * 32) + (ty + bx * 4) * 512];
        temp_4 = inputs[(tx + 4 * 32) + (ty + bx * 4) * 512];
        temp_5 = inputs[(tx + 5 * 32) + (ty + bx * 4) * 512];
        temp_6 = inputs[(tx + 6 * 32) + (ty + bx * 4) * 512];
        temp_7 = inputs[(tx + 7 * 32) + (ty + bx * 4) * 512];
        temp_8 = inputs[(tx + 8 * 32) + (ty + bx * 4) * 512];
        temp_9 = inputs[(tx + 9 * 32) + (ty + bx * 4) * 512];
        temp_10 = inputs[(tx + 10 * 32) + (ty + bx * 4) * 512];
        temp_11 = inputs[(tx + 11 * 32) + (ty + bx * 4) * 512];
        temp_12 = inputs[(tx + 12 * 32) + (ty + bx * 4) * 512];
        temp_13 = inputs[(tx + 13 * 32) + (ty + bx * 4) * 512];
        temp_14 = inputs[(tx + 14 * 32) + (ty + bx * 4) * 512];
        temp_15 = inputs[(tx + 15 * 32) + (ty + bx * 4) * 512];
    ...
    temp_15 = tmp;
        ...
        // __syncthreads();
                    ...
                    outputs[__id[8] + (ty + bx * blockDim.y) * 512] = temp_8;
         
                    // temp_0 = sdata[((tx + ty * 32 + 1152) % 4) + 4 * ((tx + ty * 32 + 1152) / 4)];
                    outputs[__id[9] + (ty + bx * blockDim.y) * 512] = temp_9;
         
                    // temp_0 = sdata[((tx + ty * 32 + 1280) % 4) + 4 * ((tx + ty * 32 + 1280) / 4)];
                    outputs[__id[10] + (ty + bx * blockDim.y) * 512] = temp_10;
         
                    // temp_0 = sdata[((tx + ty * 32 + 1408) % 4) + 4 * ((tx + ty * 32 + 1408) / 4)];
                    outputs[__id[11] + (ty + bx * blockDim.y) * 512] = temp_11;
         
                    // temp_0 = sdata[((tx + ty * 32 + 1536) % 4) + 4 * ((tx + ty * 32 + 1536) / 4)];
                    outputs[__id[12] + (ty + bx * blockDim.y) * 512] = temp_12;
         
                    // temp_0 = sdata[((tx + ty * 32 + 1664) % 4) + 4 * ((tx + ty * 32 + 1664) / 4)];
                    outputs[__id[13] + (ty + bx * blockDim.y) * 512] = temp_13;
         
                    // temp_0 = sdata[((tx + ty * 32 + 1792) % 4) + 4 * ((tx + ty * 32 + 1792) / 4)];
                    outputs[__id[14] + (ty + bx * blockDim.y) * 512] = temp_14;
         
                    // temp_0 = sdata[((tx + ty * 32 + 1920) % 4) + 4 * ((tx + ty * 32 + 1920) / 4)];
                    outputs[__id[15] + (ty + bx * blockDim.y) * 512] = temp_15;
