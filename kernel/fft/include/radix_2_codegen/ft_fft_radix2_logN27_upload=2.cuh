...
__global__ void __launch_bounds__(512) fft_radix2_logN27_2(float2* inputs, float2* outputs, float2* r_1) {
    ...
    *(float2*)(((float*)sdata) + tid * 2) = tmp_r;
    ...
    temp_0 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 0) + (bx / 32) * 262144];
    temp_1 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 16384) + (bx / 32) * 262144];
    temp_2 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 32768) + (bx / 32) * 262144];
    temp_3 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 49152) + (bx / 32) * 262144];
    temp_4 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 65536) + (bx / 32) * 262144];
    temp_5 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 81920) + (bx / 32) * 262144];
    temp_6 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 98304) + (bx / 32) * 262144];
    temp_7 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 114688) + (bx / 32) * 262144];
    temp_8 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 131072) + (bx / 32) * 262144];
    temp_9 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 147456) + (bx / 32) * 262144];
    temp_10 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 163840) + (bx / 32) * 262144];
    temp_11 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 180224) + (bx / 32) * 262144];
    temp_12 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 196608) + (bx / 32) * 262144];
    temp_13 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 212992) + (bx / 32) * 262144];
    temp_14 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 229376) + (bx / 32) * 262144];
    temp_15 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 245760) + (bx / 32) * 262144];
    __id[0] = 0 + ty;
    __id[1] = 32 + ty;
    __id[2] = 64 + ty;
    __id[3] = 96 + ty;
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 512) * (__id[0])) / (float)(262144), tmp_angle);
    MY_MUL(temp_0, tmp_angle, tmp);
    temp_0 = tmp;
    outputs[(tx + bx * 16) % 512 + 512 * __id[0] + ((tx + bx * 16) / 512) * 512 * 512] = temp_0;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 512) * (__id[1])) / (float)(262144), tmp_angle);
    MY_MUL(temp_1, tmp_angle, tmp);
    temp_1 = tmp;
    outputs[(tx + bx * 16) % 512 + 512 * __id[1] + ((tx + bx * 16) / 512) * 512 * 512] = temp_1;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 512) * (__id[2])) / (float)(262144), tmp_angle);
    MY_MUL(temp_2, tmp_angle, tmp);
    temp_2 = tmp;
    outputs[(tx + bx * 16) % 512 + 512 * __id[2] + ((tx + bx * 16) / 512) * 512 * 512] = temp_2;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 512) * (__id[3])) / (float)(262144), tmp_angle);
    MY_MUL(temp_3, tmp_angle, tmp);
    temp_3 = tmp;
    outputs[(tx + bx * 16) % 512 + 512 * __id[3] + ((tx + bx * 16) / 512) * 512 * 512] = temp_3;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 512) * (__id[4])) / (float)(262144), tmp_angle);
    MY_MUL(temp_4, tmp_angle, tmp);
    temp_4 = tmp;
    outputs[(tx + bx * 16) % 512 + 512 * __id[4] + ((tx + bx * 16) / 512) * 512 * 512] = temp_4;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 512) * (__id[5])) / (float)(262144), tmp_angle);
    MY_MUL(temp_5, tmp_angle, tmp);
    temp_5 = tmp;
    outputs[(tx + bx * 16) % 512 + 512 * __id[5] + ((tx + bx * 16) / 512) * 512 * 512] = temp_5;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 512) * (__id[6])) / (float)(262144), tmp_angle);
    MY_MUL(temp_6, tmp_angle, tmp);
    temp_6 = tmp;
    outputs[(tx + bx * 16) % 512 + 512 * __id[6] + ((tx + bx * 16) / 512) * 512 * 512] = temp_6;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 512) * (__id[7])) / (float)(262144), tmp_angle);
    MY_MUL(temp_7, tmp_angle, tmp);
    temp_7 = tmp;
    outputs[(tx + bx * 16) % 512 + 512 * __id[7] + ((tx + bx * 16) / 512) * 512 * 512] = temp_7;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 512) * (__id[8])) / (float)(262144), tmp_angle);
    MY_MUL(temp_8, tmp_angle, tmp);
    temp_8 = tmp;
    outputs[(tx + bx * 16) % 512 + 512 * __id[8] + ((tx + bx * 16) / 512) * 512 * 512] = temp_8;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 512) * (__id[9])) / (float)(262144), tmp_angle);
    MY_MUL(temp_9, tmp_angle, tmp);
    temp_9 = tmp;
    outputs[(tx + bx * 16) % 512 + 512 * __id[9] + ((tx + bx * 16) / 512) * 512 * 512] = temp_9;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 512) * (__id[10])) / (float)(262144), tmp_angle);
    MY_MUL(temp_10, tmp_angle, tmp);
    temp_10 = tmp;
    outputs[(tx + bx * 16) % 512 + 512 * __id[10] + ((tx + bx * 16) / 512) * 512 * 512] = temp_10;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 512) * (__id[11])) / (float)(262144), tmp_angle);
    MY_MUL(temp_11, tmp_angle, tmp);
    temp_11 = tmp;
    outputs[(tx + bx * 16) % 512 + 512 * __id[11] + ((tx + bx * 16) / 512) * 512 * 512] = temp_11;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 512) * (__id[12])) / (float)(262144), tmp_angle);
    MY_MUL(temp_12, tmp_angle, tmp);
    temp_12 = tmp;
    outputs[(tx + bx * 16) % 512 + 512 * __id[12] + ((tx + bx * 16) / 512) * 512 * 512] = temp_12;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 512) * (__id[13])) / (float)(262144), tmp_angle);
    MY_MUL(temp_13, tmp_angle, tmp);
    temp_13 = tmp;
    outputs[(tx + bx * 16) % 512 + 512 * __id[13] + ((tx + bx * 16) / 512) * 512 * 512] = temp_13;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 512) * (__id[14])) / (float)(262144), tmp_angle);
    MY_MUL(temp_14, tmp_angle, tmp);
    temp_14 = tmp;
    outputs[(tx + bx * 16) % 512 + 512 * __id[14] + ((tx + bx * 16) / 512) * 512 * 512] = temp_14;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 512) * (__id[15])) / (float)(262144), tmp_angle);
    MY_MUL(temp_15, tmp_angle, tmp);
    temp_15 = tmp;
    outputs[(tx + bx * 16) % 512 + 512 * __id[15] + ((tx + bx * 16) / 512) * 512 * 512] = temp_15;
