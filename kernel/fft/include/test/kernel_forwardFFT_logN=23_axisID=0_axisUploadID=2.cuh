...
extern "C" __global__ void __launch_bounds__(256) VkFFT_main_logN23_2 (float2* inputs, float2* outputs) {
...
float2* sdata = (float2*)shared;
	...
	mult.x = 0;
	mult.y = 0;
		disableThreads = ((((threadIdx.x + blockIdx.x * blockDim.x)) / 256) * (32768) < 8388608) ? 1 : 0;
		if(disableThreads>0) {
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (256) + 256 * (threadIdx.y + 0) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 256) * (32768);
			inoutID = (inoutID);
			temp_0=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (256) + 256 * (threadIdx.y + 16) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 256) * (32768);
			inoutID = (inoutID);
			temp_1=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (256) + 256 * (threadIdx.y + 32) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 256) * (32768);
			inoutID = (inoutID);
			temp_2=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (256) + 256 * (threadIdx.y + 48) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 256) * (32768);
			inoutID = (inoutID);
			temp_3=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (256) + 256 * (threadIdx.y + 64) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 256) * (32768);
			inoutID = (inoutID);
			temp_4=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (256) + 256 * (threadIdx.y + 80) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 256) * (32768);
			inoutID = (inoutID);
			temp_5=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (256) + 256 * (threadIdx.y + 96) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 256) * (32768);
			inoutID = (inoutID);
			temp_6=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (256) + 256 * (threadIdx.y + 112) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 256) * (32768);
			inoutID = (inoutID);
		if(threadIdx.y < 16){
	...
	sdata[sdataID] = temp_7;
		...
		temp_4 = sdata[sharedStride*(threadIdx.y+16)+threadIdx.x];
	...
	temp_3.y = temp_3.y + loc_0.y;
		...
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (256)) * (threadIdx.y + 0)) / 3.27680000000000000e+04f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_0.x * mult.x - temp_0.y * mult.y;
		temp_0.y = temp_0.y * mult.x + temp_0.x * mult.y;
		temp_0.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (256)) * (threadIdx.y + 16)) / 3.27680000000000000e+04f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_1.x * mult.x - temp_1.y * mult.y;
		temp_1.y = temp_1.y * mult.x + temp_1.x * mult.y;
		temp_1.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (256)) * (threadIdx.y + 32)) / 3.27680000000000000e+04f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_2.x * mult.x - temp_2.y * mult.y;
		temp_2.y = temp_2.y * mult.x + temp_2.x * mult.y;
		temp_2.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (256)) * (threadIdx.y + 48)) / 3.27680000000000000e+04f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_3.x * mult.x - temp_3.y * mult.y;
		temp_3.y = temp_3.y * mult.x + temp_3.x * mult.y;
		temp_3.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (256)) * (threadIdx.y + 64)) / 3.27680000000000000e+04f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_4.x * mult.x - temp_4.y * mult.y;
		temp_4.y = temp_4.y * mult.x + temp_4.x * mult.y;
		temp_4.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (256)) * (threadIdx.y + 80)) / 3.27680000000000000e+04f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_5.x * mult.x - temp_5.y * mult.y;
		temp_5.y = temp_5.y * mult.x + temp_5.x * mult.y;
		temp_5.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (256)) * (threadIdx.y + 96)) / 3.27680000000000000e+04f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_6.x * mult.x - temp_6.y * mult.y;
		temp_6.y = temp_6.y * mult.x + temp_6.x * mult.y;
		temp_6.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (256)) * (threadIdx.y + 112)) / 3.27680000000000000e+04f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_7.x * mult.x - temp_7.y * mult.y;
		temp_7.y = temp_7.y * mult.x + temp_7.x * mult.y;
		temp_7.x = w.x;
}		if ((((threadIdx.x + blockIdx.x * blockDim.x)) / 256) * (32768) < 8388608) {
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (256) + 256 * (threadIdx.y + 0) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 256) * (32768);
			inoutID = (inoutID) * 1;
