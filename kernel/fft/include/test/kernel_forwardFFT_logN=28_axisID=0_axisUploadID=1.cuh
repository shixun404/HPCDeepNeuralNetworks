...
extern "C" __global__ void __launch_bounds__(1024) VkFFT_main_logN28_1 (float2* inputs, float2* outputs) {
...
float2* sdata = (float2*)shared;
	...
	mult.x = 0;
	mult.y = 0;
		disableThreads = ((((threadIdx.x + blockIdx.x * blockDim.x)) / 524288) * (268435456) < 268435456) ? 1 : 0;
		if(disableThreads>0) {
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (524288) + 524288 * (threadIdx.y + 0) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 524288) * (268435456);
			inoutID = (inoutID);
			temp_0=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (524288) + 524288 * (threadIdx.y + 64) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 524288) * (268435456);
			inoutID = (inoutID);
			temp_1=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (524288) + 524288 * (threadIdx.y + 128) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 524288) * (268435456);
			inoutID = (inoutID);
			temp_2=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (524288) + 524288 * (threadIdx.y + 192) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 524288) * (268435456);
			inoutID = (inoutID);
			temp_3=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (524288) + 524288 * (threadIdx.y + 256) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 524288) * (268435456);
			inoutID = (inoutID);
			temp_4=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (524288) + 524288 * (threadIdx.y + 320) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 524288) * (268435456);
			inoutID = (inoutID);
			temp_5=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (524288) + 524288 * (threadIdx.y + 384) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 524288) * (268435456);
			inoutID = (inoutID);
			temp_6=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (524288) + 524288 * (threadIdx.y + 448) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 524288) * (268435456);
			inoutID = (inoutID);
		if(threadIdx.y < 64){
	...
	temp_6.y = temp_6.y + loc_0.y;
		...
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (524288)) * (threadIdx.y + 0)) / 2.68435456000000000e+08f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_0.x * mult.x - temp_0.y * mult.y;
		temp_0.y = temp_0.y * mult.x + temp_0.x * mult.y;
		temp_0.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (524288)) * (threadIdx.y + 64)) / 2.68435456000000000e+08f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_4.x * mult.x - temp_4.y * mult.y;
		temp_4.y = temp_4.y * mult.x + temp_4.x * mult.y;
		temp_4.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (524288)) * (threadIdx.y + 128)) / 2.68435456000000000e+08f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_2.x * mult.x - temp_2.y * mult.y;
		temp_2.y = temp_2.y * mult.x + temp_2.x * mult.y;
		temp_2.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (524288)) * (threadIdx.y + 192)) / 2.68435456000000000e+08f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_6.x * mult.x - temp_6.y * mult.y;
		temp_6.y = temp_6.y * mult.x + temp_6.x * mult.y;
		temp_6.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (524288)) * (threadIdx.y + 256)) / 2.68435456000000000e+08f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_1.x * mult.x - temp_1.y * mult.y;
		temp_1.y = temp_1.y * mult.x + temp_1.x * mult.y;
		temp_1.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (524288)) * (threadIdx.y + 320)) / 2.68435456000000000e+08f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_5.x * mult.x - temp_5.y * mult.y;
		temp_5.y = temp_5.y * mult.x + temp_5.x * mult.y;
		temp_5.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (524288)) * (threadIdx.y + 384)) / 2.68435456000000000e+08f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_3.x * mult.x - temp_3.y * mult.y;
		temp_3.y = temp_3.y * mult.x + temp_3.x * mult.y;
		temp_3.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (524288)) * (threadIdx.y + 448)) / 2.68435456000000000e+08f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_7.x * mult.x - temp_7.y * mult.y;
		temp_7.y = temp_7.y * mult.x + temp_7.x * mult.y;
		temp_7.x = w.x;
}		if ((((threadIdx.x + blockIdx.x * blockDim.x)) / 524288) * (268435456) < 268435456) {
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (524288) + 524288 * (threadIdx.y + 0) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 524288) * (268435456);
			inoutID = (inoutID) * 1;
