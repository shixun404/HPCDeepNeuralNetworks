...
extern "C" __global__ void __launch_bounds__(256) VkFFT_main_logN23_1 (float2* inputs, float2* outputs) {
...
float2* sdata = (float2*)shared;
	...
	mult.x = 0;
	mult.y = 0;
		disableThreads = ((((threadIdx.x + blockIdx.x * blockDim.x)) / 32768) * (8388608) < 8388608) ? 1 : 0;
		if(disableThreads>0) {
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (32768) + 32768 * (threadIdx.y + 0) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 32768) * (8388608);
			inoutID = (inoutID);
			temp_0=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (32768) + 32768 * (threadIdx.y + 16) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 32768) * (8388608);
			inoutID = (inoutID);
			temp_1=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (32768) + 32768 * (threadIdx.y + 32) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 32768) * (8388608);
			inoutID = (inoutID);
			temp_2=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (32768) + 32768 * (threadIdx.y + 48) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 32768) * (8388608);
			inoutID = (inoutID);
			temp_3=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (32768) + 32768 * (threadIdx.y + 64) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 32768) * (8388608);
			inoutID = (inoutID);
			temp_4=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (32768) + 32768 * (threadIdx.y + 80) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 32768) * (8388608);
			inoutID = (inoutID);
			temp_5=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (32768) + 32768 * (threadIdx.y + 96) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 32768) * (8388608);
			inoutID = (inoutID);
			temp_6=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (32768) + 32768 * (threadIdx.y + 112) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 32768) * (8388608);
			inoutID = (inoutID);
			temp_7=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (32768) + 32768 * (threadIdx.y + 128) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 32768) * (8388608);
			inoutID = (inoutID);
			temp_8=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (32768) + 32768 * (threadIdx.y + 144) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 32768) * (8388608);
			inoutID = (inoutID);
			temp_9=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (32768) + 32768 * (threadIdx.y + 160) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 32768) * (8388608);
			inoutID = (inoutID);
			temp_10=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (32768) + 32768 * (threadIdx.y + 176) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 32768) * (8388608);
			inoutID = (inoutID);
			temp_11=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (32768) + 32768 * (threadIdx.y + 192) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 32768) * (8388608);
			inoutID = (inoutID);
			temp_12=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (32768) + 32768 * (threadIdx.y + 208) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 32768) * (8388608);
			inoutID = (inoutID);
			temp_13=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (32768) + 32768 * (threadIdx.y + 224) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 32768) * (8388608);
			inoutID = (inoutID);
			temp_14=inputs[inoutID];
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (32768) + 32768 * (threadIdx.y + 240) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 32768) * (8388608);
			inoutID = (inoutID);
		if(threadIdx.y < 16){
	...
	temp_7.y = temp_7.y + loc_0.y;
		...
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (32768)) * (threadIdx.y + 0)) / 8.38860800000000000e+06f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_0.x * mult.x - temp_0.y * mult.y;
		temp_0.y = temp_0.y * mult.x + temp_0.x * mult.y;
		temp_0.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (32768)) * (threadIdx.y + 16)) / 8.38860800000000000e+06f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_1.x * mult.x - temp_1.y * mult.y;
		temp_1.y = temp_1.y * mult.x + temp_1.x * mult.y;
		temp_1.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (32768)) * (threadIdx.y + 32)) / 8.38860800000000000e+06f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_2.x * mult.x - temp_2.y * mult.y;
		temp_2.y = temp_2.y * mult.x + temp_2.x * mult.y;
		temp_2.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (32768)) * (threadIdx.y + 48)) / 8.38860800000000000e+06f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_3.x * mult.x - temp_3.y * mult.y;
		temp_3.y = temp_3.y * mult.x + temp_3.x * mult.y;
		temp_3.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (32768)) * (threadIdx.y + 64)) / 8.38860800000000000e+06f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_4.x * mult.x - temp_4.y * mult.y;
		temp_4.y = temp_4.y * mult.x + temp_4.x * mult.y;
		temp_4.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (32768)) * (threadIdx.y + 80)) / 8.38860800000000000e+06f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_5.x * mult.x - temp_5.y * mult.y;
		temp_5.y = temp_5.y * mult.x + temp_5.x * mult.y;
		temp_5.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (32768)) * (threadIdx.y + 96)) / 8.38860800000000000e+06f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_6.x * mult.x - temp_6.y * mult.y;
		temp_6.y = temp_6.y * mult.x + temp_6.x * mult.y;
		temp_6.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (32768)) * (threadIdx.y + 112)) / 8.38860800000000000e+06f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_7.x * mult.x - temp_7.y * mult.y;
		temp_7.y = temp_7.y * mult.x + temp_7.x * mult.y;
		temp_7.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (32768)) * (threadIdx.y + 128)) / 8.38860800000000000e+06f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_8.x * mult.x - temp_8.y * mult.y;
		temp_8.y = temp_8.y * mult.x + temp_8.x * mult.y;
		temp_8.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (32768)) * (threadIdx.y + 144)) / 8.38860800000000000e+06f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_9.x * mult.x - temp_9.y * mult.y;
		temp_9.y = temp_9.y * mult.x + temp_9.x * mult.y;
		temp_9.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (32768)) * (threadIdx.y + 160)) / 8.38860800000000000e+06f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_10.x * mult.x - temp_10.y * mult.y;
		temp_10.y = temp_10.y * mult.x + temp_10.x * mult.y;
		temp_10.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (32768)) * (threadIdx.y + 176)) / 8.38860800000000000e+06f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_11.x * mult.x - temp_11.y * mult.y;
		temp_11.y = temp_11.y * mult.x + temp_11.x * mult.y;
		temp_11.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (32768)) * (threadIdx.y + 192)) / 8.38860800000000000e+06f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_12.x * mult.x - temp_12.y * mult.y;
		temp_12.y = temp_12.y * mult.x + temp_12.x * mult.y;
		temp_12.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (32768)) * (threadIdx.y + 208)) / 8.38860800000000000e+06f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_13.x * mult.x - temp_13.y * mult.y;
		temp_13.y = temp_13.y * mult.x + temp_13.x * mult.y;
		temp_13.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (32768)) * (threadIdx.y + 224)) / 8.38860800000000000e+06f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_14.x * mult.x - temp_14.y * mult.y;
		temp_14.y = temp_14.y * mult.x + temp_14.x * mult.y;
		temp_14.x = w.x;
		angle = 2 * 3.14159265358979312e+00f * (((((threadIdx.x + blockIdx.x * blockDim.x)) % (32768)) * (threadIdx.y + 240)) / 8.38860800000000000e+06f);
		mult.x = __cosf(angle);
		mult.y = -__sinf(angle);
		w.x = temp_15.x * mult.x - temp_15.y * mult.y;
		temp_15.y = temp_15.y * mult.x + temp_15.x * mult.y;
		temp_15.x = w.x;
}		if ((((threadIdx.x + blockIdx.x * blockDim.x)) / 32768) * (8388608) < 8388608) {
		inoutID = ((threadIdx.x + blockIdx.x * blockDim.x)) % (32768) + 32768 * (threadIdx.y + 0) + (((threadIdx.x + blockIdx.x * blockDim.x)) / 32768) * (8388608);
			inoutID = (inoutID) * 1;
