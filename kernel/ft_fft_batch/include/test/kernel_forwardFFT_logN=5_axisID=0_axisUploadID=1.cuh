...
extern "C" __global__ void __launch_bounds__(4) VkFFT_main_logN5 (float2* inputs, float2* outputs) {
...
float2* sdata = (float2*)shared;
	...
	sdataID = inoutID + 0;
	sharedStride = 34;	sdataID = (sdataID / 16) * 17 + sdataID % 16;	sdata[sdataID] = temp_0;
	sdataID = inoutID + 1;
