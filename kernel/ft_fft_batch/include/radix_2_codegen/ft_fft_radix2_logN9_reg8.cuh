extern __shared__ float shared[];
    ...
    float2 temp_0;
        ...
        *(float4*)(((float*)sdata) + tid * 8 + 1 * 4) = tmp_r;
        ...
        temp_0 = inputs[(ty + 0 * 64) + (tx + bx * 2) * 512];
        temp_1 = inputs[(ty + 1 * 64) + (tx + bx * 2) * 512];
        temp_2 = inputs[(ty + 2 * 64) + (tx + bx * 2) * 512];
        temp_3 = inputs[(ty + 3 * 64) + (tx + bx * 2) * 512];
        temp_4 = inputs[(ty + 4 * 64) + (tx + bx * 2) * 512];
        temp_5 = inputs[(ty + 5 * 64) + (tx + bx * 2) * 512];
        temp_6 = inputs[(ty + 6 * 64) + (tx + bx * 2) * 512];
        temp_7 = inputs[(ty + 7 * 64) + (tx + bx * 2) * 512];
    ...
    temp_7 = tmp;
        ...
        temp_1 = sdata[((tx + 2 * (64 + ty)) / 16) * 17 +
                            ((tx + 2 * (64 + ty)) % 16)];
        __id[1] = ty + 64;
        
        temp_2 = sdata[((tx + 2 * (128 + ty)) / 16) * 17 +
                            ((tx + 2 * (128 + ty)) % 16)];
        __id[2] = ty + 128;
        
        temp_3 = sdata[((tx + 2 * (192 + ty)) / 16) * 17 +
                            ((tx + 2 * (192 + ty)) % 16)];
        __id[3] = ty + 192;
        
        temp_4 = sdata[((tx + 2 * (256 + ty)) / 16) * 17 +
                            ((tx + 2 * (256 + ty)) % 16)];
        __id[4] = ty + 256;
        
        temp_5 = sdata[((tx + 2 * (320 + ty)) / 16) * 17 +
                            ((tx + 2 * (320 + ty)) % 16)];
        __id[5] = ty + 320;
        
        temp_6 = sdata[((tx + 2 * (384 + ty)) / 16) * 17 +
                            ((tx + 2 * (384 + ty)) % 16)];
        __id[6] = ty + 384;
        
        temp_7 = sdata[((tx + 2 * (448 + ty)) / 16) * 17 +
                            ((tx + 2 * (448 + ty)) % 16)];
        __id[7] = ty + 448;
