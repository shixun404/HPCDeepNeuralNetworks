...
__global__ void __launch_bounds__(512) fft_radix2_logN21_2(float2* inputs, float2* outputs, float2* r_1) {

    int batch_id = (blockIdx.x * blockDim.x) / 1024;
float2 r[3];
r[0].x = 1.0f;
r[0].y = 0.0f;
r[1].x = -0.5f;
...
float2 mem_checksum, mem_checksum_t1;
    ...
    *(float4*)(((float*)sdata) + tid * 8 + 1 * 4) = tmp_r;
    ...
    temp_0 = inputs[(ty + 0 * 128) + ((tx + bx * 4) % 1024) * 2048 + batch_id * 2097152];
    temp_1 = inputs[(ty + 1 * 128) + ((tx + bx * 4) % 1024) * 2048 + batch_id * 2097152];
    temp_2 = inputs[(ty + 2 * 128) + ((tx + bx * 4) % 1024) * 2048 + batch_id * 2097152];
    temp_3 = inputs[(ty + 3 * 128) + ((tx + bx * 4) % 1024) * 2048 + batch_id * 2097152];
    temp_4 = inputs[(ty + 4 * 128) + ((tx + bx * 4) % 1024) * 2048 + batch_id * 2097152];
    temp_5 = inputs[(ty + 5 * 128) + ((tx + bx * 4) % 1024) * 2048 + batch_id * 2097152];
    temp_6 = inputs[(ty + 6 * 128) + ((tx + bx * 4) % 1024) * 2048 + batch_id * 2097152];
    temp_7 = inputs[(ty + 7 * 128) + ((tx + bx * 4) % 1024) * 2048 + batch_id * 2097152];
    temp_8 = inputs[(ty + 8 * 128) + ((tx + bx * 4) % 1024) * 2048 + batch_id * 2097152];
    temp_9 = inputs[(ty + 9 * 128) + ((tx + bx * 4) % 1024) * 2048 + batch_id * 2097152];
    temp_10 = inputs[(ty + 10 * 128) + ((tx + bx * 4) % 1024) * 2048 + batch_id * 2097152];
    temp_11 = inputs[(ty + 11 * 128) + ((tx + bx * 4) % 1024) * 2048 + batch_id * 2097152];
    temp_12 = inputs[(ty + 12 * 128) + ((tx + bx * 4) % 1024) * 2048 + batch_id * 2097152];
    temp_13 = inputs[(ty + 13 * 128) + ((tx + bx * 4) % 1024) * 2048 + batch_id * 2097152];
    temp_14 = inputs[(ty + 14 * 128) + ((tx + bx * 4) % 1024) * 2048 + batch_id * 2097152];
    temp_15 = inputs[(ty + 15 * 128) + ((tx + bx * 4) % 1024) * 2048 + batch_id * 2097152];
...
MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 0) / (float)(2048), tmp_angle);
MY_MUL(temp_0, tmp_angle, tmp);
temp_0 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 1) / (float)(2048), tmp_angle);
MY_MUL(temp_8, tmp_angle, tmp);
temp_8 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 2) / (float)(2048), tmp_angle);
MY_MUL(temp_4, tmp_angle, tmp);
temp_4 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 3) / (float)(2048), tmp_angle);
MY_MUL(temp_12, tmp_angle, tmp);
temp_12 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 4) / (float)(2048), tmp_angle);
MY_MUL(temp_2, tmp_angle, tmp);
temp_2 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 5) / (float)(2048), tmp_angle);
MY_MUL(temp_10, tmp_angle, tmp);
temp_10 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 6) / (float)(2048), tmp_angle);
MY_MUL(temp_6, tmp_angle, tmp);
temp_6 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 7) / (float)(2048), tmp_angle);
MY_MUL(temp_14, tmp_angle, tmp);
temp_14 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 8) / (float)(2048), tmp_angle);
MY_MUL(temp_1, tmp_angle, tmp);
temp_1 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 9) / (float)(2048), tmp_angle);
MY_MUL(temp_9, tmp_angle, tmp);
temp_9 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 10) / (float)(2048), tmp_angle);
MY_MUL(temp_5, tmp_angle, tmp);
temp_5 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 11) / (float)(2048), tmp_angle);
MY_MUL(temp_13, tmp_angle, tmp);
temp_13 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 12) / (float)(2048), tmp_angle);
MY_MUL(temp_3, tmp_angle, tmp);
temp_3 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 13) / (float)(2048), tmp_angle);
MY_MUL(temp_11, tmp_angle, tmp);
temp_11 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 14) / (float)(2048), tmp_angle);
MY_MUL(temp_7, tmp_angle, tmp);
temp_7 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 15) / (float)(2048), tmp_angle);
MY_MUL(temp_15, tmp_angle, tmp);
temp_15 = tmp;
...
MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 0) / (float)(128.0), tmp_angle);
MY_MUL(temp_0, tmp_angle, tmp);
temp_0 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 1) / (float)(128.0), tmp_angle);
MY_MUL(temp_8, tmp_angle, tmp);
temp_8 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 2) / (float)(128.0), tmp_angle);
MY_MUL(temp_4, tmp_angle, tmp);
temp_4 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 3) / (float)(128.0), tmp_angle);
MY_MUL(temp_12, tmp_angle, tmp);
temp_12 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 4) / (float)(128.0), tmp_angle);
MY_MUL(temp_2, tmp_angle, tmp);
temp_2 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 5) / (float)(128.0), tmp_angle);
MY_MUL(temp_10, tmp_angle, tmp);
temp_10 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 6) / (float)(128.0), tmp_angle);
MY_MUL(temp_6, tmp_angle, tmp);
temp_6 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 7) / (float)(128.0), tmp_angle);
MY_MUL(temp_14, tmp_angle, tmp);
temp_14 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 8) / (float)(128.0), tmp_angle);
MY_MUL(temp_1, tmp_angle, tmp);
temp_1 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 9) / (float)(128.0), tmp_angle);
MY_MUL(temp_9, tmp_angle, tmp);
temp_9 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 10) / (float)(128.0), tmp_angle);
MY_MUL(temp_5, tmp_angle, tmp);
temp_5 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 11) / (float)(128.0), tmp_angle);
MY_MUL(temp_13, tmp_angle, tmp);
temp_13 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 12) / (float)(128.0), tmp_angle);
MY_MUL(temp_3, tmp_angle, tmp);
temp_3 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 13) / (float)(128.0), tmp_angle);
MY_MUL(temp_11, tmp_angle, tmp);
temp_11 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 14) / (float)(128.0), tmp_angle);
MY_MUL(temp_7, tmp_angle, tmp);
temp_7 = tmp;

MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 15) / (float)(128.0), tmp_angle);
MY_MUL(temp_15, tmp_angle, tmp);
temp_15 = tmp;
    ...
    outputs[((tx + bx * 4) % 1024) + batch_id  * 2097152 + 1024 * __id[0]] = temp_0;
    
    outputs[((tx + bx * 4) % 1024) + batch_id  * 2097152 + 1024 * __id[1]] = temp_1;
    
    outputs[((tx + bx * 4) % 1024) + batch_id  * 2097152 + 1024 * __id[8]] = temp_8;
    
    outputs[((tx + bx * 4) % 1024) + batch_id  * 2097152 + 1024 * __id[9]] = temp_9;
    
    outputs[((tx + bx * 4) % 1024) + batch_id  * 2097152 + 1024 * __id[4]] = temp_4;
    
    outputs[((tx + bx * 4) % 1024) + batch_id  * 2097152 + 1024 * __id[5]] = temp_5;
    
    outputs[((tx + bx * 4) % 1024) + batch_id  * 2097152 + 1024 * __id[12]] = temp_12;
    
    outputs[((tx + bx * 4) % 1024) + batch_id  * 2097152 + 1024 * __id[13]] = temp_13;
    
    outputs[((tx + bx * 4) % 1024) + batch_id  * 2097152 + 1024 * __id[2]] = temp_2;
    
    outputs[((tx + bx * 4) % 1024) + batch_id  * 2097152 + 1024 * __id[3]] = temp_3;
    
    outputs[((tx + bx * 4) % 1024) + batch_id  * 2097152 + 1024 * __id[10]] = temp_10;
    
    outputs[((tx + bx * 4) % 1024) + batch_id  * 2097152 + 1024 * __id[11]] = temp_11;
    
    outputs[((tx + bx * 4) % 1024) + batch_id  * 2097152 + 1024 * __id[6]] = temp_6;
    
    outputs[((tx + bx * 4) % 1024) + batch_id  * 2097152 + 1024 * __id[7]] = temp_7;
    
    outputs[((tx + bx * 4) % 1024) + batch_id  * 2097152 + 1024 * __id[14]] = temp_14;
    
    outputs[((tx + bx * 4) % 1024) + batch_id  * 2097152 + 1024 * __id[15]] = temp_15;
