extern __shared__ float shared[];
    __global__ void __launch_bounds__(32) fft_radix2_logN9(float2* inputs, float2* outputs, float2* r_1) {
    ...
    float2 temp_0;
        ...
        *(float4*)(((float*)sdata) + tid * 32 + 7 * 4) = tmp_r;
        ...
        temp_0 = inputs[(ty + 0 * 16) + (tx + bx * 2) * 512];
        temp_1 = inputs[(ty + 1 * 16) + (tx + bx * 2) * 512];
        temp_2 = inputs[(ty + 2 * 16) + (tx + bx * 2) * 512];
        temp_3 = inputs[(ty + 3 * 16) + (tx + bx * 2) * 512];
        temp_4 = inputs[(ty + 4 * 16) + (tx + bx * 2) * 512];
        temp_5 = inputs[(ty + 5 * 16) + (tx + bx * 2) * 512];
        temp_6 = inputs[(ty + 6 * 16) + (tx + bx * 2) * 512];
        temp_7 = inputs[(ty + 7 * 16) + (tx + bx * 2) * 512];
        temp_8 = inputs[(ty + 8 * 16) + (tx + bx * 2) * 512];
        temp_9 = inputs[(ty + 9 * 16) + (tx + bx * 2) * 512];
        temp_10 = inputs[(ty + 10 * 16) + (tx + bx * 2) * 512];
        temp_11 = inputs[(ty + 11 * 16) + (tx + bx * 2) * 512];
        temp_12 = inputs[(ty + 12 * 16) + (tx + bx * 2) * 512];
        temp_13 = inputs[(ty + 13 * 16) + (tx + bx * 2) * 512];
        temp_14 = inputs[(ty + 14 * 16) + (tx + bx * 2) * 512];
        temp_15 = inputs[(ty + 15 * 16) + (tx + bx * 2) * 512];
        temp_16 = inputs[(ty + 16 * 16) + (tx + bx * 2) * 512];
        temp_17 = inputs[(ty + 17 * 16) + (tx + bx * 2) * 512];
        temp_18 = inputs[(ty + 18 * 16) + (tx + bx * 2) * 512];
        temp_19 = inputs[(ty + 19 * 16) + (tx + bx * 2) * 512];
        temp_20 = inputs[(ty + 20 * 16) + (tx + bx * 2) * 512];
        temp_21 = inputs[(ty + 21 * 16) + (tx + bx * 2) * 512];
        temp_22 = inputs[(ty + 22 * 16) + (tx + bx * 2) * 512];
        temp_23 = inputs[(ty + 23 * 16) + (tx + bx * 2) * 512];
        temp_24 = inputs[(ty + 24 * 16) + (tx + bx * 2) * 512];
        temp_25 = inputs[(ty + 25 * 16) + (tx + bx * 2) * 512];
        temp_26 = inputs[(ty + 26 * 16) + (tx + bx * 2) * 512];
        temp_27 = inputs[(ty + 27 * 16) + (tx + bx * 2) * 512];
        temp_28 = inputs[(ty + 28 * 16) + (tx + bx * 2) * 512];
        temp_29 = inputs[(ty + 29 * 16) + (tx + bx * 2) * 512];
        temp_30 = inputs[(ty + 30 * 16) + (tx + bx * 2) * 512];
        temp_31 = inputs[(ty + 31 * 16) + (tx + bx * 2) * 512];
    ...
    temp_31 = tmp;
        ...
        sdata[((tx + 2 * __id[16]) / 16) * 17 + 
        ((tx + 2 * __id[16]) % 16)] = temp_16;
        
        sdata[((tx + 2 * __id[8]) / 16) * 17 + 
        ((tx + 2 * __id[8]) % 16)] = temp_8;
        
        sdata[((tx + 2 * __id[24]) / 16) * 17 + 
        ((tx + 2 * __id[24]) % 16)] = temp_24;
        
        sdata[((tx + 2 * __id[4]) / 16) * 17 + 
        ((tx + 2 * __id[4]) % 16)] = temp_4;
        
        sdata[((tx + 2 * __id[20]) / 16) * 17 + 
        ((tx + 2 * __id[20]) % 16)] = temp_20;
        
        sdata[((tx + 2 * __id[12]) / 16) * 17 + 
        ((tx + 2 * __id[12]) % 16)] = temp_12;
        
        sdata[((tx + 2 * __id[28]) / 16) * 17 + 
        ((tx + 2 * __id[28]) % 16)] = temp_28;
        
        sdata[((tx + 2 * __id[2]) / 16) * 17 + 
        ((tx + 2 * __id[2]) % 16)] = temp_2;
        
        sdata[((tx + 2 * __id[18]) / 16) * 17 + 
        ((tx + 2 * __id[18]) % 16)] = temp_18;
        
        sdata[((tx + 2 * __id[10]) / 16) * 17 + 
        ((tx + 2 * __id[10]) % 16)] = temp_10;
        
        sdata[((tx + 2 * __id[26]) / 16) * 17 + 
        ((tx + 2 * __id[26]) % 16)] = temp_26;
        
        sdata[((tx + 2 * __id[6]) / 16) * 17 + 
        ((tx + 2 * __id[6]) % 16)] = temp_6;
        
        sdata[((tx + 2 * __id[22]) / 16) * 17 + 
        ((tx + 2 * __id[22]) % 16)] = temp_22;
        
        sdata[((tx + 2 * __id[14]) / 16) * 17 + 
        ((tx + 2 * __id[14]) % 16)] = temp_14;
        
        sdata[((tx + 2 * __id[30]) / 16) * 17 + 
        ((tx + 2 * __id[30]) % 16)] = temp_30;
        
        sdata[((tx + 2 * __id[1]) / 16) * 17 + 
        ((tx + 2 * __id[1]) % 16)] = temp_1;
        
        sdata[((tx + 2 * __id[17]) / 16) * 17 + 
        ((tx + 2 * __id[17]) % 16)] = temp_17;
        
        sdata[((tx + 2 * __id[9]) / 16) * 17 + 
        ((tx + 2 * __id[9]) % 16)] = temp_9;
        
        sdata[((tx + 2 * __id[25]) / 16) * 17 + 
        ((tx + 2 * __id[25]) % 16)] = temp_25;
        
        sdata[((tx + 2 * __id[5]) / 16) * 17 + 
        ((tx + 2 * __id[5]) % 16)] = temp_5;
        
        sdata[((tx + 2 * __id[21]) / 16) * 17 + 
        ((tx + 2 * __id[21]) % 16)] = temp_21;
        
        sdata[((tx + 2 * __id[13]) / 16) * 17 + 
        ((tx + 2 * __id[13]) % 16)] = temp_13;
        
        sdata[((tx + 2 * __id[29]) / 16) * 17 + 
        ((tx + 2 * __id[29]) % 16)] = temp_29;
        
        sdata[((tx + 2 * __id[3]) / 16) * 17 + 
        ((tx + 2 * __id[3]) % 16)] = temp_3;
        
        sdata[((tx + 2 * __id[19]) / 16) * 17 + 
        ((tx + 2 * __id[19]) % 16)] = temp_19;
        
        sdata[((tx + 2 * __id[11]) / 16) * 17 + 
        ((tx + 2 * __id[11]) % 16)] = temp_11;
        
        sdata[((tx + 2 * __id[27]) / 16) * 17 + 
        ((tx + 2 * __id[27]) % 16)] = temp_27;
        
        sdata[((tx + 2 * __id[7]) / 16) * 17 + 
        ((tx + 2 * __id[7]) % 16)] = temp_7;
        
        sdata[((tx + 2 * __id[23]) / 16) * 17 + 
        ((tx + 2 * __id[23]) % 16)] = temp_23;
        
        sdata[((tx + 2 * __id[15]) / 16) * 17 + 
        ((tx + 2 * __id[15]) % 16)] = temp_15;
        
        sdata[((tx + 2 * __id[31]) / 16) * 17 + 
        ((tx + 2 * __id[31]) % 16)] = temp_31;
        ...
        temp_16 = sdata[((tx + 2 * (256 + ty)) / 16) * 17 +
                            ((tx + 2 * (256 + ty)) % 16)];
        __id[16] = ty + 256;
        
        temp_17 = sdata[((tx + 2 * (272 + ty)) / 16) * 17 +
                            ((tx + 2 * (272 + ty)) % 16)];
        __id[17] = ty + 272;
        
        temp_18 = sdata[((tx + 2 * (288 + ty)) / 16) * 17 +
                            ((tx + 2 * (288 + ty)) % 16)];
        __id[18] = ty + 288;
        
        temp_19 = sdata[((tx + 2 * (304 + ty)) / 16) * 17 +
                            ((tx + 2 * (304 + ty)) % 16)];
        __id[19] = ty + 304;
        
        temp_20 = sdata[((tx + 2 * (320 + ty)) / 16) * 17 +
                            ((tx + 2 * (320 + ty)) % 16)];
        __id[20] = ty + 320;
        
        temp_21 = sdata[((tx + 2 * (336 + ty)) / 16) * 17 +
                            ((tx + 2 * (336 + ty)) % 16)];
        __id[21] = ty + 336;
        
        temp_22 = sdata[((tx + 2 * (352 + ty)) / 16) * 17 +
                            ((tx + 2 * (352 + ty)) % 16)];
        __id[22] = ty + 352;
        
        temp_23 = sdata[((tx + 2 * (368 + ty)) / 16) * 17 +
                            ((tx + 2 * (368 + ty)) % 16)];
        __id[23] = ty + 368;
        
        temp_24 = sdata[((tx + 2 * (384 + ty)) / 16) * 17 +
                            ((tx + 2 * (384 + ty)) % 16)];
        __id[24] = ty + 384;
        
        temp_25 = sdata[((tx + 2 * (400 + ty)) / 16) * 17 +
                            ((tx + 2 * (400 + ty)) % 16)];
        __id[25] = ty + 400;
        
        temp_26 = sdata[((tx + 2 * (416 + ty)) / 16) * 17 +
                            ((tx + 2 * (416 + ty)) % 16)];
        __id[26] = ty + 416;
        
        temp_27 = sdata[((tx + 2 * (432 + ty)) / 16) * 17 +
                            ((tx + 2 * (432 + ty)) % 16)];
        __id[27] = ty + 432;
        
        temp_28 = sdata[((tx + 2 * (448 + ty)) / 16) * 17 +
                            ((tx + 2 * (448 + ty)) % 16)];
        __id[28] = ty + 448;
        
        temp_29 = sdata[((tx + 2 * (464 + ty)) / 16) * 17 +
                            ((tx + 2 * (464 + ty)) % 16)];
        __id[29] = ty + 464;
        
        temp_30 = sdata[((tx + 2 * (480 + ty)) / 16) * 17 +
                            ((tx + 2 * (480 + ty)) % 16)];
        __id[30] = ty + 480;
        
        temp_31 = sdata[((tx + 2 * (496 + ty)) / 16) * 17 +
                            ((tx + 2 * (496 + ty)) % 16)];
        __id[31] = ty + 496;
        ...
        outputs[(tx + bx * 2) * 512 +  __id[0]] = temp_0;
        
        outputs[(tx + bx * 2) * 512 +  __id[1]] = temp_1;
        
        outputs[(tx + bx * 2) * 512 +  __id[16]] = temp_16;
        
        outputs[(tx + bx * 2) * 512 +  __id[17]] = temp_17;
        
        outputs[(tx + bx * 2) * 512 +  __id[8]] = temp_8;
        
        outputs[(tx + bx * 2) * 512 +  __id[9]] = temp_9;
        
        outputs[(tx + bx * 2) * 512 +  __id[24]] = temp_24;
        
        outputs[(tx + bx * 2) * 512 +  __id[25]] = temp_25;
        
        outputs[(tx + bx * 2) * 512 +  __id[4]] = temp_4;
        
        outputs[(tx + bx * 2) * 512 +  __id[5]] = temp_5;
        
        outputs[(tx + bx * 2) * 512 +  __id[20]] = temp_20;
        
        outputs[(tx + bx * 2) * 512 +  __id[21]] = temp_21;
        
        outputs[(tx + bx * 2) * 512 +  __id[12]] = temp_12;
        
        outputs[(tx + bx * 2) * 512 +  __id[13]] = temp_13;
        
        outputs[(tx + bx * 2) * 512 +  __id[28]] = temp_28;
        
        outputs[(tx + bx * 2) * 512 +  __id[29]] = temp_29;
        
        outputs[(tx + bx * 2) * 512 +  __id[2]] = temp_2;
        
        outputs[(tx + bx * 2) * 512 +  __id[3]] = temp_3;
        
        outputs[(tx + bx * 2) * 512 +  __id[18]] = temp_18;
        
        outputs[(tx + bx * 2) * 512 +  __id[19]] = temp_19;
        
        outputs[(tx + bx * 2) * 512 +  __id[10]] = temp_10;
        
        outputs[(tx + bx * 2) * 512 +  __id[11]] = temp_11;
        
        outputs[(tx + bx * 2) * 512 +  __id[26]] = temp_26;
        
        outputs[(tx + bx * 2) * 512 +  __id[27]] = temp_27;
        
        outputs[(tx + bx * 2) * 512 +  __id[6]] = temp_6;
        
        outputs[(tx + bx * 2) * 512 +  __id[7]] = temp_7;
        
        outputs[(tx + bx * 2) * 512 +  __id[22]] = temp_22;
        
        outputs[(tx + bx * 2) * 512 +  __id[23]] = temp_23;
        
        outputs[(tx + bx * 2) * 512 +  __id[14]] = temp_14;
        
        outputs[(tx + bx * 2) * 512 +  __id[15]] = temp_15;
        
        outputs[(tx + bx * 2) * 512 +  __id[30]] = temp_30;
        
        outputs[(tx + bx * 2) * 512 +  __id[31]] = temp_31;
