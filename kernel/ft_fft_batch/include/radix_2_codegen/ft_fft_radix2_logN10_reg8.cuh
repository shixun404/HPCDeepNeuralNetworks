...
__constant__ float r_1[2048];
extern __shared__ float shared[];
        
    __global__ void __launch_bounds__(128) fft_radix2_logN10(float2* inputs, float2* outputs) {
    ...
    float2 temp_0;
        ...
        *(float4*)(((float*)sdata) + tid * 16 + 3 * 4) = tmp_r;
        ...
        temp_0 = inputs[(ty + 0 * 128) + (tx + bx * 1) * 1024];
        temp_1 = inputs[(ty + 1 * 128) + (tx + bx * 1) * 1024];
        temp_2 = inputs[(ty + 2 * 128) + (tx + bx * 1) * 1024];
        temp_3 = inputs[(ty + 3 * 128) + (tx + bx * 1) * 1024];
        temp_4 = inputs[(ty + 4 * 128) + (tx + bx * 1) * 1024];
        temp_5 = inputs[(ty + 5 * 128) + (tx + bx * 1) * 1024];
        temp_6 = inputs[(ty + 6 * 128) + (tx + bx * 1) * 1024];
        temp_7 = inputs[(ty + 7 * 128) + (tx + bx * 1) * 1024];
    ...
    temp_7 = tmp;
        ...
        temp_4 = sdata[((tx + 1 * (512 + ty)) / 16) * 17 +
                            ((tx + 1 * (512 + ty)) % 16)];
        __id[4] = ty + 512;
        
        temp_5 = sdata[((tx + 1 * (640 + ty)) / 16) * 17 +
                            ((tx + 1 * (640 + ty)) % 16)];
        __id[5] = ty + 640;
        
        temp_6 = sdata[((tx + 1 * (768 + ty)) / 16) * 17 +
                            ((tx + 1 * (768 + ty)) % 16)];
        __id[6] = ty + 768;
        
        temp_7 = sdata[((tx + 1 * (896 + ty)) / 16) * 17 +
                            ((tx + 1 * (896 + ty)) % 16)];
        __id[7] = ty + 896;
    ...
    temp_7 = tmp;
        ...
        outputs[(tx + bx * 1) * 1024 +  __id[0]] = temp_0;
        
        outputs[(tx + bx * 1) * 1024 +  __id[1]] = temp_1;
        
        outputs[(tx + bx * 1) * 1024 +  __id[2]] = temp_2;
        
        outputs[(tx + bx * 1) * 1024 +  __id[3]] = temp_3;
        
        outputs[(tx + bx * 1) * 1024 +  __id[4]] = temp_4;
        
        outputs[(tx + bx * 1) * 1024 +  __id[5]] = temp_5;
        
        outputs[(tx + bx * 1) * 1024 +  __id[6]] = temp_6;
        
        outputs[(tx + bx * 1) * 1024 +  __id[7]] = temp_7;
