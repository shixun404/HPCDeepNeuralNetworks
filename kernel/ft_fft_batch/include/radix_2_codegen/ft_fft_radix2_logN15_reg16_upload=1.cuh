...
__global__ void __launch_bounds__(128) fft_radix2_logN15_1(float2* inputs, float2* outputs, float2* r_1) {
    ...
    *(float2*)(((float*)sdata) + tid * 2) = tmp_r;
    ...
    temp_0 = inputs[(ty + 0 * 8) * 256 + (tx + bx * blockDim.x) % 256 + batch_id * 32768];
    temp_1 = inputs[(ty + 1 * 8) * 256 + (tx + bx * blockDim.x) % 256 + batch_id * 32768];
    temp_2 = inputs[(ty + 2 * 8) * 256 + (tx + bx * blockDim.x) % 256 + batch_id * 32768];
    temp_3 = inputs[(ty + 3 * 8) * 256 + (tx + bx * blockDim.x) % 256 + batch_id * 32768];
    temp_4 = inputs[(ty + 4 * 8) * 256 + (tx + bx * blockDim.x) % 256 + batch_id * 32768];
    temp_5 = inputs[(ty + 5 * 8) * 256 + (tx + bx * blockDim.x) % 256 + batch_id * 32768];
    temp_6 = inputs[(ty + 6 * 8) * 256 + (tx + bx * blockDim.x) % 256 + batch_id * 32768];
    temp_7 = inputs[(ty + 7 * 8) * 256 + (tx + bx * blockDim.x) % 256 + batch_id * 32768];
    temp_8 = inputs[(ty + 8 * 8) * 256 + (tx + bx * blockDim.x) % 256 + batch_id * 32768];
    temp_9 = inputs[(ty + 9 * 8) * 256 + (tx + bx * blockDim.x) % 256 + batch_id * 32768];
    temp_10 = inputs[(ty + 10 * 8) * 256 + (tx + bx * blockDim.x) % 256 + batch_id * 32768];
    temp_11 = inputs[(ty + 11 * 8) * 256 + (tx + bx * blockDim.x) % 256 + batch_id * 32768];
    temp_12 = inputs[(ty + 12 * 8) * 256 + (tx + bx * blockDim.x) % 256 + batch_id * 32768];
    temp_13 = inputs[(ty + 13 * 8) * 256 + (tx + bx * blockDim.x) % 256 + batch_id * 32768];
    temp_14 = inputs[(ty + 14 * 8) * 256 + (tx + bx * blockDim.x) % 256 + batch_id * 32768];
    temp_15 = inputs[(ty + 15 * 8) * 256 + (tx + bx * blockDim.x) % 256 + batch_id * 32768];
