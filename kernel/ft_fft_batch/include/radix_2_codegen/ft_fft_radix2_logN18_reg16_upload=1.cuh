...
__global__ void __launch_bounds__(512) fft_radix2_logN18_1(float2* inputs, float2* outputs) {
    ...
    temp_0 = inputs[(ty + 0 * 32) * gridDim.x * blockDim.x + tx + bx * 16];
    temp_1 = inputs[(ty + 1 * 32) * gridDim.x * blockDim.x + tx + bx * 16];
    temp_2 = inputs[(ty + 2 * 32) * gridDim.x * blockDim.x + tx + bx * 16];
    temp_3 = inputs[(ty + 3 * 32) * gridDim.x * blockDim.x + tx + bx * 16];
    temp_4 = inputs[(ty + 4 * 32) * gridDim.x * blockDim.x + tx + bx * 16];
    temp_5 = inputs[(ty + 5 * 32) * gridDim.x * blockDim.x + tx + bx * 16];
    temp_6 = inputs[(ty + 6 * 32) * gridDim.x * blockDim.x + tx + bx * 16];
    temp_7 = inputs[(ty + 7 * 32) * gridDim.x * blockDim.x + tx + bx * 16];
    temp_8 = inputs[(ty + 8 * 32) * gridDim.x * blockDim.x + tx + bx * 16];
    temp_9 = inputs[(ty + 9 * 32) * gridDim.x * blockDim.x + tx + bx * 16];
    temp_10 = inputs[(ty + 10 * 32) * gridDim.x * blockDim.x + tx + bx * 16];
    temp_11 = inputs[(ty + 11 * 32) * gridDim.x * blockDim.x + tx + bx * 16];
    temp_12 = inputs[(ty + 12 * 32) * gridDim.x * blockDim.x + tx + bx * 16];
    temp_13 = inputs[(ty + 13 * 32) * gridDim.x * blockDim.x + tx + bx * 16];
    temp_14 = inputs[(ty + 14 * 32) * gridDim.x * blockDim.x + tx + bx * 16];
    temp_15 = inputs[(ty + 15 * 32) * gridDim.x * blockDim.x + tx + bx * 16];
