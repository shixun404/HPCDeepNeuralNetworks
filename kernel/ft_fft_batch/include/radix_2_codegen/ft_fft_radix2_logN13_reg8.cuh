extern __shared__ float shared[];
    ...
    __global__ void __launch_bounds__(1024) fft_radix2_logN13(float2* inputs, float2* outputs, float2* r_2) {
    ...
    float2 temp_0;
        ...
        *(float4*)(((float*)sdata) + tid * 16 + 3 * 4) = tmp_r;
        ...
        temp_0 = inputs[(ty + 0 * 1024) + (tx + bx * 1) * 8192];
        temp_1 = inputs[(ty + 1 * 1024) + (tx + bx * 1) * 8192];
        temp_2 = inputs[(ty + 2 * 1024) + (tx + bx * 1) * 8192];
        temp_3 = inputs[(ty + 3 * 1024) + (tx + bx * 1) * 8192];
        temp_4 = inputs[(ty + 4 * 1024) + (tx + bx * 1) * 8192];
        temp_5 = inputs[(ty + 5 * 1024) + (tx + bx * 1) * 8192];
        temp_6 = inputs[(ty + 6 * 1024) + (tx + bx * 1) * 8192];
        temp_7 = inputs[(ty + 7 * 1024) + (tx + bx * 1) * 8192];
    ...
    temp_7 = tmp;
        ...
        temp_1 = sdata[tx + 1 * (1024 + ty)];
        __id[1] = ty + 1024;
        
        temp_2 = sdata[tx + 1 * (2048 + ty)];
        __id[2] = ty + 2048;
        
        temp_3 = sdata[tx + 1 * (3072 + ty)];
        __id[3] = ty + 3072;
        
        temp_4 = sdata[tx + 1 * (4096 + ty)];
        __id[4] = ty + 4096;
        
        temp_5 = sdata[tx + 1 * (5120 + ty)];
        __id[5] = ty + 5120;
        
        temp_6 = sdata[tx + 1 * (6144 + ty)];
        __id[6] = ty + 6144;
        
        temp_7 = sdata[tx + 1 * (7168 + ty)];
        __id[7] = ty + 7168;
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 8) * 0) / (float)(1024.0), tmp_angle);
    MY_MUL(temp_0, tmp_angle, tmp);
    temp_0 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 8) * 1) / (float)(1024.0), tmp_angle);
    MY_MUL(temp_4, tmp_angle, tmp);
    temp_4 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 8) * 2) / (float)(1024.0), tmp_angle);
    MY_MUL(temp_2, tmp_angle, tmp);
    temp_2 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 8) * 3) / (float)(1024.0), tmp_angle);
    MY_MUL(temp_6, tmp_angle, tmp);
    temp_6 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 8) * 4) / (float)(1024.0), tmp_angle);
    MY_MUL(temp_1, tmp_angle, tmp);
    temp_1 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 8) * 5) / (float)(1024.0), tmp_angle);
    MY_MUL(temp_5, tmp_angle, tmp);
    temp_5 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 8) * 6) / (float)(1024.0), tmp_angle);
    MY_MUL(temp_3, tmp_angle, tmp);
    temp_3 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 8) * 7) / (float)(1024.0), tmp_angle);
    MY_MUL(temp_7, tmp_angle, tmp);
    temp_7 = tmp;
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 64) * 0) / (float)(128.0), tmp_angle);
    MY_MUL(temp_0, tmp_angle, tmp);
    temp_0 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 64) * 1) / (float)(128.0), tmp_angle);
    MY_MUL(temp_4, tmp_angle, tmp);
    temp_4 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 64) * 2) / (float)(128.0), tmp_angle);
    MY_MUL(temp_2, tmp_angle, tmp);
    temp_2 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 64) * 3) / (float)(128.0), tmp_angle);
    MY_MUL(temp_6, tmp_angle, tmp);
    temp_6 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 64) * 4) / (float)(128.0), tmp_angle);
    MY_MUL(temp_1, tmp_angle, tmp);
    temp_1 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 64) * 5) / (float)(128.0), tmp_angle);
    MY_MUL(temp_5, tmp_angle, tmp);
    temp_5 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 64) * 6) / (float)(128.0), tmp_angle);
    MY_MUL(temp_3, tmp_angle, tmp);
    temp_3 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 64) * 7) / (float)(128.0), tmp_angle);
    MY_MUL(temp_7, tmp_angle, tmp);
    temp_7 = tmp;
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 512) * 0) / (float)(16.0), tmp_angle);
    MY_MUL(temp_0, tmp_angle, tmp);
    temp_0 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 512) * 1) / (float)(16.0), tmp_angle);
    MY_MUL(temp_4, tmp_angle, tmp);
    temp_4 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 512) * 2) / (float)(16.0), tmp_angle);
    MY_MUL(temp_2, tmp_angle, tmp);
    temp_2 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 512) * 3) / (float)(16.0), tmp_angle);
    MY_MUL(temp_6, tmp_angle, tmp);
    temp_6 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 512) * 4) / (float)(16.0), tmp_angle);
    MY_MUL(temp_1, tmp_angle, tmp);
    temp_1 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 512) * 5) / (float)(16.0), tmp_angle);
    MY_MUL(temp_5, tmp_angle, tmp);
    temp_5 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 512) * 6) / (float)(16.0), tmp_angle);
    MY_MUL(temp_3, tmp_angle, tmp);
    temp_3 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 512) * 7) / (float)(16.0), tmp_angle);
    MY_MUL(temp_7, tmp_angle, tmp);
    temp_7 = tmp;
