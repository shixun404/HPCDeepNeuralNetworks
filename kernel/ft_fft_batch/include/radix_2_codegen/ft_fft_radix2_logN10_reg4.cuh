extern __shared__ float shared[];
    ...
    float2 temp_0;
        ...
        *(float4*)(((float*)sdata) + tid * 8 + 1 * 4) = tmp_r;
        ...
        temp_0 = inputs[(ty + 0 * 256) + (tx + bx * 1) * 1024];
        temp_1 = inputs[(ty + 1 * 256) + (tx + bx * 1) * 1024];
        temp_2 = inputs[(ty + 2 * 256) + (tx + bx * 1) * 1024];
        temp_3 = inputs[(ty + 3 * 256) + (tx + bx * 1) * 1024];
    ...
    temp_3 = tmp;
        ...
        temp_1 = sdata[((tx + 1 * (256 + ty)) / 16) * 17 +
                            ((tx + 1 * (256 + ty)) % 16)];
        __id[1] = ty + 256;
        
        temp_2 = sdata[((tx + 1 * (512 + ty)) / 16) * 17 +
                            ((tx + 1 * (512 + ty)) % 16)];
        __id[2] = ty + 512;
        
        temp_3 = sdata[((tx + 1 * (768 + ty)) / 16) * 17 +
                            ((tx + 1 * (768 + ty)) % 16)];
        __id[3] = ty + 768;
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 4) * 0) / (float)(256.0), tmp_angle);
    MY_MUL(temp_0, tmp_angle, tmp);
    temp_0 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 4) * 1) / (float)(256.0), tmp_angle);
    MY_MUL(temp_2, tmp_angle, tmp);
    temp_2 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 4) * 2) / (float)(256.0), tmp_angle);
    MY_MUL(temp_1, tmp_angle, tmp);
    temp_1 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 4) * 3) / (float)(256.0), tmp_angle);
    MY_MUL(temp_3, tmp_angle, tmp);
    temp_3 = tmp;
