extern __shared__ float shared[];
    ...
    float2 mem_checksum, mem_checksum_t1;
        ...
        *(float4*)(((float*)sdata) + tid * 4) = tmp_r;
        ...
        temp_0 = inputs[(ty + 0 * 16) + (tx + bx * 8) * 256];
        temp_1 = inputs[(ty + 1 * 16) + (tx + bx * 8) * 256];
        temp_2 = inputs[(ty + 2 * 16) + (tx + bx * 8) * 256];
        temp_3 = inputs[(ty + 3 * 16) + (tx + bx * 8) * 256];
        temp_4 = inputs[(ty + 4 * 16) + (tx + bx * 8) * 256];
        temp_5 = inputs[(ty + 5 * 16) + (tx + bx * 8) * 256];
        temp_6 = inputs[(ty + 6 * 16) + (tx + bx * 8) * 256];
        temp_7 = inputs[(ty + 7 * 16) + (tx + bx * 8) * 256];
        temp_8 = inputs[(ty + 8 * 16) + (tx + bx * 8) * 256];
        temp_9 = inputs[(ty + 9 * 16) + (tx + bx * 8) * 256];
        temp_10 = inputs[(ty + 10 * 16) + (tx + bx * 8) * 256];
        temp_11 = inputs[(ty + 11 * 16) + (tx + bx * 8) * 256];
        temp_12 = inputs[(ty + 12 * 16) + (tx + bx * 8) * 256];
        temp_13 = inputs[(ty + 13 * 16) + (tx + bx * 8) * 256];
        temp_14 = inputs[(ty + 14 * 16) + (tx + bx * 8) * 256];
        temp_15 = inputs[(ty + 15 * 16) + (tx + bx * 8) * 256];
    ...
    temp_15 = tmp;
        ...
        outputs[(tx + bx * 8) + 128 * __id[0]] = temp_0;
        
        outputs[(tx + bx * 8) + 128 * __id[8]] = temp_8;
        
        outputs[(tx + bx * 8) + 128 * __id[4]] = temp_4;
        
        outputs[(tx + bx * 8) + 128 * __id[12]] = temp_12;
        
        outputs[(tx + bx * 8) + 128 * __id[2]] = temp_2;
        
        outputs[(tx + bx * 8) + 128 * __id[10]] = temp_10;
        
        outputs[(tx + bx * 8) + 128 * __id[6]] = temp_6;
        
        outputs[(tx + bx * 8) + 128 * __id[14]] = temp_14;
        
        outputs[(tx + bx * 8) + 128 * __id[1]] = temp_1;
        
        outputs[(tx + bx * 8) + 128 * __id[9]] = temp_9;
        
        outputs[(tx + bx * 8) + 128 * __id[5]] = temp_5;
        
        outputs[(tx + bx * 8) + 128 * __id[13]] = temp_13;
        
        outputs[(tx + bx * 8) + 128 * __id[3]] = temp_3;
        
        outputs[(tx + bx * 8) + 128 * __id[11]] = temp_11;
        
        outputs[(tx + bx * 8) + 128 * __id[7]] = temp_7;
        
        outputs[(tx + bx * 8) + 128 * __id[15]] = temp_15;
