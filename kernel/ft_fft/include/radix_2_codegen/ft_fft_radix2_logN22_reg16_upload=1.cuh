...
__global__ void __launch_bounds__(512) fft_radix2_logN22_1(float2* inputs, float2* outputs, float2* r_1) {
...
__syncthreads();
    ...
    temp_0 = sdata[tx + 4 * (((ty * 4) / 32) * 16 * (8) + 0 * (8) + (ty % 8))];
    global_mem_checksum += temp_0.x + temp_0.y;
    outputs[(tx + bx * 4) + 2048 * (((ty * 4) / 32) * 16 * (8) + 0 * (8) + (ty % 8))] = temp_0;
    
    temp_1 = sdata[tx + 4 * (((ty * 4) / 32) * 16 * (8) + 1 * (8) + (ty % 8))];
    global_mem_checksum += temp_1.x + temp_1.y;
    outputs[(tx + bx * 4) + 2048 * (((ty * 4) / 32) * 16 * (8) + 1 * (8) + (ty % 8))] = temp_1;
    
    temp_2 = sdata[tx + 4 * (((ty * 4) / 32) * 16 * (8) + 2 * (8) + (ty % 8))];
    global_mem_checksum += temp_2.x + temp_2.y;
    outputs[(tx + bx * 4) + 2048 * (((ty * 4) / 32) * 16 * (8) + 2 * (8) + (ty % 8))] = temp_2;
    
    temp_3 = sdata[tx + 4 * (((ty * 4) / 32) * 16 * (8) + 3 * (8) + (ty % 8))];
    global_mem_checksum += temp_3.x + temp_3.y;
    outputs[(tx + bx * 4) + 2048 * (((ty * 4) / 32) * 16 * (8) + 3 * (8) + (ty % 8))] = temp_3;
    ...
    outputs[4194304 + bx * 64 + 4 * (tid / 32) +  1].x = global_mem_checksum;
    global_mem_checksum = 0;
    
    temp_4 = sdata[tx + 4 * (((ty * 4) / 32) * 16 * (8) + 4 * (8) + (ty % 8))];
    global_mem_checksum += temp_4.x + temp_4.y;
    outputs[(tx + bx * 4) + 2048 * (((ty * 4) / 32) * 16 * (8) + 4 * (8) + (ty % 8))] = temp_4;
    
    temp_5 = sdata[tx + 4 * (((ty * 4) / 32) * 16 * (8) + 5 * (8) + (ty % 8))];
    global_mem_checksum += temp_5.x + temp_5.y;
    outputs[(tx + bx * 4) + 2048 * (((ty * 4) / 32) * 16 * (8) + 5 * (8) + (ty % 8))] = temp_5;
    
    temp_6 = sdata[tx + 4 * (((ty * 4) / 32) * 16 * (8) + 6 * (8) + (ty % 8))];
    global_mem_checksum += temp_6.x + temp_6.y;
    outputs[(tx + bx * 4) + 2048 * (((ty * 4) / 32) * 16 * (8) + 6 * (8) + (ty % 8))] = temp_6;
    
    temp_7 = sdata[tx + 4 * (((ty * 4) / 32) * 16 * (8) + 7 * (8) + (ty % 8))];
    global_mem_checksum += temp_7.x + temp_7.y;
    outputs[(tx + bx * 4) + 2048 * (((ty * 4) / 32) * 16 * (8) + 7 * (8) + (ty % 8))] = temp_7;
    ...
    outputs[4194304 + bx * 64 + 4 * (tid / 32) +  2].x = global_mem_checksum;
    global_mem_checksum = 0;
    
    temp_8 = sdata[tx + 4 * (((ty * 4) / 32) * 16 * (8) + 8 * (8) + (ty % 8))];
    global_mem_checksum += temp_8.x + temp_8.y;
    outputs[(tx + bx * 4) + 2048 * (((ty * 4) / 32) * 16 * (8) + 8 * (8) + (ty % 8))] = temp_8;
    
    temp_9 = sdata[tx + 4 * (((ty * 4) / 32) * 16 * (8) + 9 * (8) + (ty % 8))];
    global_mem_checksum += temp_9.x + temp_9.y;
    outputs[(tx + bx * 4) + 2048 * (((ty * 4) / 32) * 16 * (8) + 9 * (8) + (ty % 8))] = temp_9;
    
    temp_10 = sdata[tx + 4 * (((ty * 4) / 32) * 16 * (8) + 10 * (8) + (ty % 8))];
    global_mem_checksum += temp_10.x + temp_10.y;
    outputs[(tx + bx * 4) + 2048 * (((ty * 4) / 32) * 16 * (8) + 10 * (8) + (ty % 8))] = temp_10;
    
    temp_11 = sdata[tx + 4 * (((ty * 4) / 32) * 16 * (8) + 11 * (8) + (ty % 8))];
    global_mem_checksum += temp_11.x + temp_11.y;
    outputs[(tx + bx * 4) + 2048 * (((ty * 4) / 32) * 16 * (8) + 11 * (8) + (ty % 8))] = temp_11;
    ...
    outputs[4194304 + bx * 64 + 4 * (tid / 32) +  3].x = global_mem_checksum;
    global_mem_checksum = 0;
    
    temp_12 = sdata[tx + 4 * (((ty * 4) / 32) * 16 * (8) + 12 * (8) + (ty % 8))];
    global_mem_checksum += temp_12.x + temp_12.y;
    outputs[(tx + bx * 4) + 2048 * (((ty * 4) / 32) * 16 * (8) + 12 * (8) + (ty % 8))] = temp_12;
    
    temp_13 = sdata[tx + 4 * (((ty * 4) / 32) * 16 * (8) + 13 * (8) + (ty % 8))];
    global_mem_checksum += temp_13.x + temp_13.y;
    outputs[(tx + bx * 4) + 2048 * (((ty * 4) / 32) * 16 * (8) + 13 * (8) + (ty % 8))] = temp_13;
    
    temp_14 = sdata[tx + 4 * (((ty * 4) / 32) * 16 * (8) + 14 * (8) + (ty % 8))];
    global_mem_checksum += temp_14.x + temp_14.y;
    outputs[(tx + bx * 4) + 2048 * (((ty * 4) / 32) * 16 * (8) + 14 * (8) + (ty % 8))] = temp_14;
    
    temp_15 = sdata[tx + 4 * (((ty * 4) / 32) * 16 * (8) + 15 * (8) + (ty % 8))];
    global_mem_checksum += temp_15.x + temp_15.y;
    outputs[(tx + bx * 4) + 2048 * (((ty * 4) / 32) * 16 * (8) + 15 * (8) + (ty % 8))] = temp_15;
    ...
    outputs[4194304 + bx * 64 + 4 * (tid / 32) +  4].x = global_mem_checksum;
    global_mem_checksum = 0;
