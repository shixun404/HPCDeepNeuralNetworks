...
__global__ void __launch_bounds__(512) fft_radix2_logN22_1(float2* inputs, float2* outputs) {
    ...
    temp_0 = inputs[(ty + 0 * 128) * gridDim.x * blockDim.x + tx + bx * 4];
    temp_1 = inputs[(ty + 1 * 128) * gridDim.x * blockDim.x + tx + bx * 4];
    temp_2 = inputs[(ty + 2 * 128) * gridDim.x * blockDim.x + tx + bx * 4];
    temp_3 = inputs[(ty + 3 * 128) * gridDim.x * blockDim.x + tx + bx * 4];
    temp_4 = inputs[(ty + 4 * 128) * gridDim.x * blockDim.x + tx + bx * 4];
    temp_5 = inputs[(ty + 5 * 128) * gridDim.x * blockDim.x + tx + bx * 4];
    temp_6 = inputs[(ty + 6 * 128) * gridDim.x * blockDim.x + tx + bx * 4];
    temp_7 = inputs[(ty + 7 * 128) * gridDim.x * blockDim.x + tx + bx * 4];
    temp_8 = inputs[(ty + 8 * 128) * gridDim.x * blockDim.x + tx + bx * 4];
    temp_9 = inputs[(ty + 9 * 128) * gridDim.x * blockDim.x + tx + bx * 4];
    temp_10 = inputs[(ty + 10 * 128) * gridDim.x * blockDim.x + tx + bx * 4];
    temp_11 = inputs[(ty + 11 * 128) * gridDim.x * blockDim.x + tx + bx * 4];
    temp_12 = inputs[(ty + 12 * 128) * gridDim.x * blockDim.x + tx + bx * 4];
    temp_13 = inputs[(ty + 13 * 128) * gridDim.x * blockDim.x + tx + bx * 4];
    temp_14 = inputs[(ty + 14 * 128) * gridDim.x * blockDim.x + tx + bx * 4];
    temp_15 = inputs[(ty + 15 * 128) * gridDim.x * blockDim.x + tx + bx * 4];
