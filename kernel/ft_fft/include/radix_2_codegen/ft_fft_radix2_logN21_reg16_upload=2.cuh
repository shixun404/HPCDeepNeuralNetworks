extern __shared__ float shared[];
    __global__ void __launch_bounds__(512) fft_radix2_logN21_2(float2* inputs, float2* outputs) {
        ...
        outputs[(ty + bx * 4) + 1024 * __id[0]] = temp_0;
        // outputs[__id[0]] = temp_0;
        
        
        
        outputs[(ty + bx * 4) + 1024 * __id[1]] = temp_1;
        // outputs[__id[1]] = temp_1;
        
        
        
        outputs[(ty + bx * 4) + 1024 * __id[8]] = temp_8;
        // outputs[__id[8]] = temp_8;
        
        
        
        outputs[(ty + bx * 4) + 1024 * __id[9]] = temp_9;
        // outputs[__id[9]] = temp_9;
        
        
        
        outputs[(ty + bx * 4) + 1024 * __id[4]] = temp_4;
        // outputs[__id[4]] = temp_4;
        
        
        
        outputs[(ty + bx * 4) + 1024 * __id[5]] = temp_5;
        // outputs[__id[5]] = temp_5;
        
        
        
        outputs[(ty + bx * 4) + 1024 * __id[12]] = temp_12;
        // outputs[__id[12]] = temp_12;
        
        
        
        outputs[(ty + bx * 4) + 1024 * __id[13]] = temp_13;
        // outputs[__id[13]] = temp_13;
        
        
        
        outputs[(ty + bx * 4) + 1024 * __id[2]] = temp_2;
        // outputs[__id[2]] = temp_2;
        
        
        
        outputs[(ty + bx * 4) + 1024 * __id[3]] = temp_3;
        // outputs[__id[3]] = temp_3;
        
        
        
        outputs[(ty + bx * 4) + 1024 * __id[10]] = temp_10;
        // outputs[__id[10]] = temp_10;
        
        
        
        outputs[(ty + bx * 4) + 1024 * __id[11]] = temp_11;
        // outputs[__id[11]] = temp_11;
        
        
        
        outputs[(ty + bx * 4) + 1024 * __id[6]] = temp_6;
        // outputs[__id[6]] = temp_6;
        
        
        
        outputs[(ty + bx * 4) + 1024 * __id[7]] = temp_7;
        // outputs[__id[7]] = temp_7;
        
        
        
        outputs[(ty + bx * 4) + 1024 * __id[14]] = temp_14;
        // outputs[__id[14]] = temp_14;
        
        
        
        outputs[(ty + bx * 4) + 1024 * __id[15]] = temp_15;
