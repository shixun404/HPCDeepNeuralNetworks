extern __shared__ float shared[];
    ...
    float2 mem_checksum, mem_checksum_t1;
        ...
        *(float4*)(((float*)sdata) + tid * 8 + 1 * 4) = tmp_r;
        ...
        temp_0 = inputs[(ty + 0 * 128) + (tx + bx * 4) * 2048];
        temp_1 = inputs[(ty + 1 * 128) + (tx + bx * 4) * 2048];
        temp_2 = inputs[(ty + 2 * 128) + (tx + bx * 4) * 2048];
        temp_3 = inputs[(ty + 3 * 128) + (tx + bx * 4) * 2048];
        temp_4 = inputs[(ty + 4 * 128) + (tx + bx * 4) * 2048];
        temp_5 = inputs[(ty + 5 * 128) + (tx + bx * 4) * 2048];
        temp_6 = inputs[(ty + 6 * 128) + (tx + bx * 4) * 2048];
        temp_7 = inputs[(ty + 7 * 128) + (tx + bx * 4) * 2048];
        temp_8 = inputs[(ty + 8 * 128) + (tx + bx * 4) * 2048];
        temp_9 = inputs[(ty + 9 * 128) + (tx + bx * 4) * 2048];
        temp_10 = inputs[(ty + 10 * 128) + (tx + bx * 4) * 2048];
        temp_11 = inputs[(ty + 11 * 128) + (tx + bx * 4) * 2048];
        temp_12 = inputs[(ty + 12 * 128) + (tx + bx * 4) * 2048];
        temp_13 = inputs[(ty + 13 * 128) + (tx + bx * 4) * 2048];
        temp_14 = inputs[(ty + 14 * 128) + (tx + bx * 4) * 2048];
        temp_15 = inputs[(ty + 15 * 128) + (tx + bx * 4) * 2048];
