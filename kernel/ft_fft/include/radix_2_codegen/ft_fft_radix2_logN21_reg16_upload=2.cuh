extern __shared__ float shared[];
    ...
    temp_15 = tmp;
        ...
        __syncthreads();
                    ...
                    outputs[(((tx + ty * 128 + 0) % 4) + bx * 4) + 1024 * ((tx + ty * 128 + 0) / 4)] = temp_0;
         
                    temp_0 = sdata[((tx + ty * 128 + 512) % 4) + 4 * ((tx + ty * 128 + 512) / 4)];
                    outputs[(((tx + ty * 128 + 512) % 4) + bx * 4) + 1024 * ((tx + ty * 128 + 512) / 4)] = temp_0;
         
                    temp_0 = sdata[((tx + ty * 128 + 1024) % 4) + 4 * ((tx + ty * 128 + 1024) / 4)];
                    outputs[(((tx + ty * 128 + 1024) % 4) + bx * 4) + 1024 * ((tx + ty * 128 + 1024) / 4)] = temp_0;
         
                    temp_0 = sdata[((tx + ty * 128 + 1536) % 4) + 4 * ((tx + ty * 128 + 1536) / 4)];
                    outputs[(((tx + ty * 128 + 1536) % 4) + bx * 4) + 1024 * ((tx + ty * 128 + 1536) / 4)] = temp_0;
         
                    temp_0 = sdata[((tx + ty * 128 + 2048) % 4) + 4 * ((tx + ty * 128 + 2048) / 4)];
                    outputs[(((tx + ty * 128 + 2048) % 4) + bx * 4) + 1024 * ((tx + ty * 128 + 2048) / 4)] = temp_0;
         
                    temp_0 = sdata[((tx + ty * 128 + 2560) % 4) + 4 * ((tx + ty * 128 + 2560) / 4)];
                    outputs[(((tx + ty * 128 + 2560) % 4) + bx * 4) + 1024 * ((tx + ty * 128 + 2560) / 4)] = temp_0;
         
                    temp_0 = sdata[((tx + ty * 128 + 3072) % 4) + 4 * ((tx + ty * 128 + 3072) / 4)];
                    outputs[(((tx + ty * 128 + 3072) % 4) + bx * 4) + 1024 * ((tx + ty * 128 + 3072) / 4)] = temp_0;
         
                    temp_0 = sdata[((tx + ty * 128 + 3584) % 4) + 4 * ((tx + ty * 128 + 3584) / 4)];
                    outputs[(((tx + ty * 128 + 3584) % 4) + bx * 4) + 1024 * ((tx + ty * 128 + 3584) / 4)] = temp_0;
         
                    temp_0 = sdata[((tx + ty * 128 + 4096) % 4) + 4 * ((tx + ty * 128 + 4096) / 4)];
                    outputs[(((tx + ty * 128 + 4096) % 4) + bx * 4) + 1024 * ((tx + ty * 128 + 4096) / 4)] = temp_0;
         
                    temp_0 = sdata[((tx + ty * 128 + 4608) % 4) + 4 * ((tx + ty * 128 + 4608) / 4)];
                    outputs[(((tx + ty * 128 + 4608) % 4) + bx * 4) + 1024 * ((tx + ty * 128 + 4608) / 4)] = temp_0;
         
                    temp_0 = sdata[((tx + ty * 128 + 5120) % 4) + 4 * ((tx + ty * 128 + 5120) / 4)];
                    outputs[(((tx + ty * 128 + 5120) % 4) + bx * 4) + 1024 * ((tx + ty * 128 + 5120) / 4)] = temp_0;
         
                    temp_0 = sdata[((tx + ty * 128 + 5632) % 4) + 4 * ((tx + ty * 128 + 5632) / 4)];
                    outputs[(((tx + ty * 128 + 5632) % 4) + bx * 4) + 1024 * ((tx + ty * 128 + 5632) / 4)] = temp_0;
         
                    temp_0 = sdata[((tx + ty * 128 + 6144) % 4) + 4 * ((tx + ty * 128 + 6144) / 4)];
                    outputs[(((tx + ty * 128 + 6144) % 4) + bx * 4) + 1024 * ((tx + ty * 128 + 6144) / 4)] = temp_0;
         
                    temp_0 = sdata[((tx + ty * 128 + 6656) % 4) + 4 * ((tx + ty * 128 + 6656) / 4)];
                    outputs[(((tx + ty * 128 + 6656) % 4) + bx * 4) + 1024 * ((tx + ty * 128 + 6656) / 4)] = temp_0;
         
                    temp_0 = sdata[((tx + ty * 128 + 7168) % 4) + 4 * ((tx + ty * 128 + 7168) / 4)];
                    outputs[(((tx + ty * 128 + 7168) % 4) + bx * 4) + 1024 * ((tx + ty * 128 + 7168) / 4)] = temp_0;
         
                    temp_0 = sdata[((tx + ty * 128 + 7680) % 4) + 4 * ((tx + ty * 128 + 7680) / 4)];
                    outputs[(((tx + ty * 128 + 7680) % 4) + bx * 4) + 1024 * ((tx + ty * 128 + 7680) / 4)] = temp_0;
