...
__global__ void __launch_bounds__(128) fft_radix2_logN11(float2* inputs, float2* outputs) {
    ...
    n_global *= 2;
        ...
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 128) * 0) / (float)(2048), tmp_angle);
        MY_MUL(temp_0, tmp_angle, tmp);
        temp_0 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 128) * 1) / (float)(2048), tmp_angle);
        MY_MUL(temp_8, tmp_angle, tmp);
        temp_8 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 128) * 2) / (float)(2048), tmp_angle);
        MY_MUL(temp_4, tmp_angle, tmp);
        temp_4 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 128) * 3) / (float)(2048), tmp_angle);
        MY_MUL(temp_12, tmp_angle, tmp);
        temp_12 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 128) * 4) / (float)(2048), tmp_angle);
        MY_MUL(temp_2, tmp_angle, tmp);
        temp_2 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 128) * 5) / (float)(2048), tmp_angle);
        MY_MUL(temp_10, tmp_angle, tmp);
        temp_10 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 128) * 6) / (float)(2048), tmp_angle);
        MY_MUL(temp_6, tmp_angle, tmp);
        temp_6 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 128) * 7) / (float)(2048), tmp_angle);
        MY_MUL(temp_14, tmp_angle, tmp);
        temp_14 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 128) * 8) / (float)(2048), tmp_angle);
        MY_MUL(temp_1, tmp_angle, tmp);
        temp_1 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 128) * 9) / (float)(2048), tmp_angle);
        MY_MUL(temp_9, tmp_angle, tmp);
        temp_9 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 128) * 10) / (float)(2048), tmp_angle);
        MY_MUL(temp_5, tmp_angle, tmp);
        temp_5 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 128) * 11) / (float)(2048), tmp_angle);
        MY_MUL(temp_13, tmp_angle, tmp);
        temp_13 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 128) * 12) / (float)(2048), tmp_angle);
        MY_MUL(temp_3, tmp_angle, tmp);
        temp_3 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 128) * 13) / (float)(2048), tmp_angle);
        MY_MUL(temp_11, tmp_angle, tmp);
        temp_11 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 128) * 14) / (float)(2048), tmp_angle);
        MY_MUL(temp_7, tmp_angle, tmp);
        temp_7 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 128) * 15) / (float)(2048), tmp_angle);
        MY_MUL(temp_15, tmp_angle, tmp);
        temp_15 = tmp;
    ...
    __syncthreads();
        ...
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 8) * 0) / (float)(128.0), tmp_angle);
        MY_MUL(temp_0, tmp_angle, tmp);
        temp_0 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 8) * 1) / (float)(128.0), tmp_angle);
        MY_MUL(temp_8, tmp_angle, tmp);
        temp_8 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 8) * 2) / (float)(128.0), tmp_angle);
        MY_MUL(temp_4, tmp_angle, tmp);
        temp_4 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 8) * 3) / (float)(128.0), tmp_angle);
        MY_MUL(temp_12, tmp_angle, tmp);
        temp_12 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 8) * 4) / (float)(128.0), tmp_angle);
        MY_MUL(temp_2, tmp_angle, tmp);
        temp_2 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 8) * 5) / (float)(128.0), tmp_angle);
        MY_MUL(temp_10, tmp_angle, tmp);
        temp_10 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 8) * 6) / (float)(128.0), tmp_angle);
        MY_MUL(temp_6, tmp_angle, tmp);
        temp_6 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 8) * 7) / (float)(128.0), tmp_angle);
        MY_MUL(temp_14, tmp_angle, tmp);
        temp_14 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 8) * 8) / (float)(128.0), tmp_angle);
        MY_MUL(temp_1, tmp_angle, tmp);
        temp_1 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 8) * 9) / (float)(128.0), tmp_angle);
        MY_MUL(temp_9, tmp_angle, tmp);
        temp_9 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 8) * 10) / (float)(128.0), tmp_angle);
        MY_MUL(temp_5, tmp_angle, tmp);
        temp_5 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 8) * 11) / (float)(128.0), tmp_angle);
        MY_MUL(temp_13, tmp_angle, tmp);
        temp_13 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 8) * 12) / (float)(128.0), tmp_angle);
        MY_MUL(temp_3, tmp_angle, tmp);
        temp_3 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 8) * 13) / (float)(128.0), tmp_angle);
        MY_MUL(temp_11, tmp_angle, tmp);
        temp_11 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 8) * 14) / (float)(128.0), tmp_angle);
        MY_MUL(temp_7, tmp_angle, tmp);
        temp_7 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 8) * 15) / (float)(128.0), tmp_angle);
        MY_MUL(temp_15, tmp_angle, tmp);
        temp_15 = tmp;
