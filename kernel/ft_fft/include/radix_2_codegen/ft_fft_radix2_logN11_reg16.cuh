...
__global__ void __launch_bounds__(128) fft_radix2_logN11(float2* inputs, float2* outputs) {
    ...
    temp_12 = tmp;
    #if defined(LOG_ON)
    if(tx==0)printf("tx %d, rot_a.real %f,  rot_a.imag %f, local_id 9,  global_id %d, j %d, k %d, j * k %d, n_global %d, \n",
    ...
    temp_13 = tmp;
    #if defined(LOG_ON)
    if(tx==0)printf("tx %d, rot_a.real %f,  rot_a.imag %f, local_id 11,  global_id %d, j %d, k %d, j * k %d, n_global %d, \n",
    ...
    temp_14 = tmp;
    #if defined(LOG_ON)
    if(tx==0)printf("tx %d, rot_a.real %f,  rot_a.imag %f, local_id 13,  global_id %d, j %d, k %d, j * k %d, n_global %d, \n",
    ...
    temp_15 = tmp;
    #if defined(LOG_ON)
    if(tx==0)printf("tx %d, rot_a.real %f,  rot_a.imag %f, local_id 15,  global_id %d, j %d, k %d, j * k %d, n_global %d, \n",
    ...
    temp_6 = tmp;
    #if defined(LOG_ON)
    if(tx==0)printf("tx %d, rot_a.real %f,  rot_a.imag %f, local_id 10,  global_id %d, j %d, k %d, j * k %d, n_global %d, \n",
    ...
    temp_7 = tmp;
    #if defined(LOG_ON)
    if(tx==0)printf("tx %d, rot_a.real %f,  rot_a.imag %f, local_id 14,  global_id %d, j %d, k %d, j * k %d, n_global %d, \n",
    ...
    temp_3 = tmp;
    #if defined(LOG_ON)
    if(tx==0)printf("tx %d, rot_a.real %f,  rot_a.imag %f, local_id 12,  global_id %d, j %d, k %d, j * k %d, n_global %d, \n",
