...
__global__ void __launch_bounds__(256) fft_radix2_logN13(float2* inputs, float2* outputs, float2* r_1) {
    ...
    tmp_r = *(float4*)(((float*)r_1) + tid * 64 + 0 * 4);
    *(float4*)(((float*)sdata) + tid * 64 + 0 * 4) = tmp_r;
    // if(bx == 0)printf("%d, hello\n", tid);
    
    tmp_r = *(float4*)(((float*)r_1) + tid * 64 + 1 * 4);
    *(float4*)(((float*)sdata) + tid * 64 + 1 * 4) = tmp_r;
    // if(bx == 0)printf("%d, hello\n", tid);
    
    tmp_r = *(float4*)(((float*)r_1) + tid * 64 + 2 * 4);
    *(float4*)(((float*)sdata) + tid * 64 + 2 * 4) = tmp_r;
    // if(bx == 0)printf("%d, hello\n", tid);
    
    tmp_r = *(float4*)(((float*)r_1) + tid * 64 + 3 * 4);
    *(float4*)(((float*)sdata) + tid * 64 + 3 * 4) = tmp_r;
    // if(bx == 0)printf("%d, hello\n", tid);
    
    tmp_r = *(float4*)(((float*)r_1) + tid * 64 + 4 * 4);
    *(float4*)(((float*)sdata) + tid * 64 + 4 * 4) = tmp_r;
    // if(bx == 0)printf("%d, hello\n", tid);
    
    tmp_r = *(float4*)(((float*)r_1) + tid * 64 + 5 * 4);
    *(float4*)(((float*)sdata) + tid * 64 + 5 * 4) = tmp_r;
    // if(bx == 0)printf("%d, hello\n", tid);
    
    tmp_r = *(float4*)(((float*)r_1) + tid * 64 + 6 * 4);
    *(float4*)(((float*)sdata) + tid * 64 + 6 * 4) = tmp_r;
    // if(bx == 0)printf("%d, hello\n", tid);
    
    tmp_r = *(float4*)(((float*)r_1) + tid * 64 + 7 * 4);
    *(float4*)(((float*)sdata) + tid * 64 + 7 * 4) = tmp_r;
    // if(bx == 0)printf("%d, hello\n", tid);
    
    tmp_r = *(float4*)(((float*)r_1) + tid * 64 + 8 * 4);
    *(float4*)(((float*)sdata) + tid * 64 + 8 * 4) = tmp_r;
    // if(bx == 0)printf("%d, hello\n", tid);
    
    tmp_r = *(float4*)(((float*)r_1) + tid * 64 + 9 * 4);
    *(float4*)(((float*)sdata) + tid * 64 + 9 * 4) = tmp_r;
    // if(bx == 0)printf("%d, hello\n", tid);
    
    tmp_r = *(float4*)(((float*)r_1) + tid * 64 + 10 * 4);
    *(float4*)(((float*)sdata) + tid * 64 + 10 * 4) = tmp_r;
    // if(bx == 0)printf("%d, hello\n", tid);
    
    tmp_r = *(float4*)(((float*)r_1) + tid * 64 + 11 * 4);
    *(float4*)(((float*)sdata) + tid * 64 + 11 * 4) = tmp_r;
    // if(bx == 0)printf("%d, hello\n", tid);
    
    tmp_r = *(float4*)(((float*)r_1) + tid * 64 + 12 * 4);
    *(float4*)(((float*)sdata) + tid * 64 + 12 * 4) = tmp_r;
    // if(bx == 0)printf("%d, hello\n", tid);
    
    tmp_r = *(float4*)(((float*)r_1) + tid * 64 + 13 * 4);
    *(float4*)(((float*)sdata) + tid * 64 + 13 * 4) = tmp_r;
    // if(bx == 0)printf("%d, hello\n", tid);
    
    tmp_r = *(float4*)(((float*)r_1) + tid * 64 + 14 * 4);
    *(float4*)(((float*)sdata) + tid * 64 + 14 * 4) = tmp_r;
    // if(bx == 0)printf("%d, hello\n", tid);
    
    tmp_r = *(float4*)(((float*)r_1) + tid * 64 + 15 * 4);
    *(float4*)(((float*)sdata) + tid * 64 + 15 * 4) = tmp_r;
    // if(bx == 0)printf("%d, hello\n", tid);
