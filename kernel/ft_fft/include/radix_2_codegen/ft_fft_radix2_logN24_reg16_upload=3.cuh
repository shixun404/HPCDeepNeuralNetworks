...
__global__ void __launch_bounds__(256) fft_radix2_logN24_3(float2* inputs, float2* outputs) {
    ...
    temp_0 = inputs[(tx + 0) + (bx / 16) * 256 + (ty + (bx % 16) * 16) * 65536];
    temp_1 = inputs[(tx + 16) + (bx / 16) * 256 + (ty + (bx % 16) * 16) * 65536];
    temp_2 = inputs[(tx + 32) + (bx / 16) * 256 + (ty + (bx % 16) * 16) * 65536];
    temp_3 = inputs[(tx + 48) + (bx / 16) * 256 + (ty + (bx % 16) * 16) * 65536];
    temp_4 = inputs[(tx + 64) + (bx / 16) * 256 + (ty + (bx % 16) * 16) * 65536];
    temp_5 = inputs[(tx + 80) + (bx / 16) * 256 + (ty + (bx % 16) * 16) * 65536];
    temp_6 = inputs[(tx + 96) + (bx / 16) * 256 + (ty + (bx % 16) * 16) * 65536];
    temp_7 = inputs[(tx + 112) + (bx / 16) * 256 + (ty + (bx % 16) * 16) * 65536];
    temp_8 = inputs[(tx + 128) + (bx / 16) * 256 + (ty + (bx % 16) * 16) * 65536];
    temp_9 = inputs[(tx + 144) + (bx / 16) * 256 + (ty + (bx % 16) * 16) * 65536];
    temp_10 = inputs[(tx + 160) + (bx / 16) * 256 + (ty + (bx % 16) * 16) * 65536];
    temp_11 = inputs[(tx + 176) + (bx / 16) * 256 + (ty + (bx % 16) * 16) * 65536];
    temp_12 = inputs[(tx + 192) + (bx / 16) * 256 + (ty + (bx % 16) * 16) * 65536];
    temp_13 = inputs[(tx + 208) + (bx / 16) * 256 + (ty + (bx % 16) * 16) * 65536];
    temp_14 = inputs[(tx + 224) + (bx / 16) * 256 + (ty + (bx % 16) * 16) * 65536];
    temp_15 = inputs[(tx + 240) + (bx / 16) * 256 + (ty + (bx % 16) * 16) * 65536];
    #if defined(LOG_ON)
