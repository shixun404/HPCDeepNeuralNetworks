...
__global__ void __launch_bounds__(256) fft_radix2_logN24_2(float2* inputs, float2* outputs, float2* r_1) {
    ...
    *(float2*)(((float*)sdata) + tid * 2) = tmp_r;
    ...
    temp_0 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 0) + (bx / 16) * 65536];
    temp_1 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 4096) + (bx / 16) * 65536];
    temp_2 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 8192) + (bx / 16) * 65536];
    temp_3 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 12288) + (bx / 16) * 65536];
    temp_4 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 16384) + (bx / 16) * 65536];
    temp_5 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 20480) + (bx / 16) * 65536];
    temp_6 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 24576) + (bx / 16) * 65536];
    temp_7 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 28672) + (bx / 16) * 65536];
    temp_8 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 32768) + (bx / 16) * 65536];
    temp_9 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 36864) + (bx / 16) * 65536];
    temp_10 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 40960) + (bx / 16) * 65536];
    temp_11 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 45056) + (bx / 16) * 65536];
    temp_12 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 49152) + (bx / 16) * 65536];
    temp_13 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 53248) + (bx / 16) * 65536];
    temp_14 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 57344) + (bx / 16) * 65536];
    temp_15 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 61440) + (bx / 16) * 65536];
    __id[0] = 0 + ty;
    __id[1] = 16 + ty;
    __id[2] = 32 + ty;
    __id[3] = 48 + ty;
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[0])) / (float)(65536), tmp_angle);
    MY_MUL(temp_0, tmp_angle, tmp);
    temp_0 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[0] + ((tx + bx * 16) / 256) * 256 * 256] = temp_0;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[8])) / (float)(65536), tmp_angle);
    MY_MUL(temp_8, tmp_angle, tmp);
    temp_8 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[8] + ((tx + bx * 16) / 256) * 256 * 256] = temp_8;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[4])) / (float)(65536), tmp_angle);
    MY_MUL(temp_4, tmp_angle, tmp);
    temp_4 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[4] + ((tx + bx * 16) / 256) * 256 * 256] = temp_4;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[12])) / (float)(65536), tmp_angle);
    MY_MUL(temp_12, tmp_angle, tmp);
    temp_12 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[12] + ((tx + bx * 16) / 256) * 256 * 256] = temp_12;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[2])) / (float)(65536), tmp_angle);
    MY_MUL(temp_2, tmp_angle, tmp);
    temp_2 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[2] + ((tx + bx * 16) / 256) * 256 * 256] = temp_2;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[10])) / (float)(65536), tmp_angle);
    MY_MUL(temp_10, tmp_angle, tmp);
    temp_10 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[10] + ((tx + bx * 16) / 256) * 256 * 256] = temp_10;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[6])) / (float)(65536), tmp_angle);
    MY_MUL(temp_6, tmp_angle, tmp);
    temp_6 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[6] + ((tx + bx * 16) / 256) * 256 * 256] = temp_6;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[14])) / (float)(65536), tmp_angle);
    MY_MUL(temp_14, tmp_angle, tmp);
    temp_14 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[14] + ((tx + bx * 16) / 256) * 256 * 256] = temp_14;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[1])) / (float)(65536), tmp_angle);
    MY_MUL(temp_1, tmp_angle, tmp);
    temp_1 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[1] + ((tx + bx * 16) / 256) * 256 * 256] = temp_1;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[9])) / (float)(65536), tmp_angle);
    MY_MUL(temp_9, tmp_angle, tmp);
    temp_9 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[9] + ((tx + bx * 16) / 256) * 256 * 256] = temp_9;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[5])) / (float)(65536), tmp_angle);
    MY_MUL(temp_5, tmp_angle, tmp);
    temp_5 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[5] + ((tx + bx * 16) / 256) * 256 * 256] = temp_5;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[13])) / (float)(65536), tmp_angle);
    MY_MUL(temp_13, tmp_angle, tmp);
    temp_13 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[13] + ((tx + bx * 16) / 256) * 256 * 256] = temp_13;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[3])) / (float)(65536), tmp_angle);
    MY_MUL(temp_3, tmp_angle, tmp);
    temp_3 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[3] + ((tx + bx * 16) / 256) * 256 * 256] = temp_3;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[11])) / (float)(65536), tmp_angle);
    MY_MUL(temp_11, tmp_angle, tmp);
    temp_11 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[11] + ((tx + bx * 16) / 256) * 256 * 256] = temp_11;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[7])) / (float)(65536), tmp_angle);
    MY_MUL(temp_7, tmp_angle, tmp);
    temp_7 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[7] + ((tx + bx * 16) / 256) * 256 * 256] = temp_7;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[15])) / (float)(65536), tmp_angle);
    MY_MUL(temp_15, tmp_angle, tmp);
    temp_15 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[15] + ((tx + bx * 16) / 256) * 256 * 256] = temp_15;
