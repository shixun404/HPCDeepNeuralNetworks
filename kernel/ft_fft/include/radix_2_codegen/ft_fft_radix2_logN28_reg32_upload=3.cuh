...
__global__ void __launch_bounds__(256) fft_radix2_logN28_3(float2* inputs, float2* outputs) {
    ...
    temp_0 = inputs[(tx + 0) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_1 = inputs[(tx + 32) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_2 = inputs[(tx + 64) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_3 = inputs[(tx + 96) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_4 = inputs[(tx + 128) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_5 = inputs[(tx + 160) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_6 = inputs[(tx + 192) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_7 = inputs[(tx + 224) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_8 = inputs[(tx + 256) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_9 = inputs[(tx + 288) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_10 = inputs[(tx + 320) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_11 = inputs[(tx + 352) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_12 = inputs[(tx + 384) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_13 = inputs[(tx + 416) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_14 = inputs[(tx + 448) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_15 = inputs[(tx + 480) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_16 = inputs[(tx + 512) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_17 = inputs[(tx + 544) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_18 = inputs[(tx + 576) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_19 = inputs[(tx + 608) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_20 = inputs[(tx + 640) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_21 = inputs[(tx + 672) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_22 = inputs[(tx + 704) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_23 = inputs[(tx + 736) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_24 = inputs[(tx + 768) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_25 = inputs[(tx + 800) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_26 = inputs[(tx + 832) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_27 = inputs[(tx + 864) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_28 = inputs[(tx + 896) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_29 = inputs[(tx + 928) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_30 = inputs[(tx + 960) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    temp_31 = inputs[(tx + 992) + (bx / 64) * 1024 + (ty + (bx % 64) * 8) * 524288];
    #if defined(LOG_ON)
