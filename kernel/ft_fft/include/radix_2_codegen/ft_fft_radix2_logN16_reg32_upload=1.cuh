...
__global__ void __launch_bounds__(64) fft_radix2_logN16_1(float2* inputs, float2* outputs, float2* r_1) {
    ...
    *(float4*)(((float*)sdata) + tid * 4) = tmp_r;
    ...
    temp_0 = inputs[(ty + 0 * 4) * 512 + tx + bx * 16];
    temp_1 = inputs[(ty + 1 * 4) * 512 + tx + bx * 16];
    temp_2 = inputs[(ty + 2 * 4) * 512 + tx + bx * 16];
    temp_3 = inputs[(ty + 3 * 4) * 512 + tx + bx * 16];
    temp_4 = inputs[(ty + 4 * 4) * 512 + tx + bx * 16];
    temp_5 = inputs[(ty + 5 * 4) * 512 + tx + bx * 16];
    temp_6 = inputs[(ty + 6 * 4) * 512 + tx + bx * 16];
    temp_7 = inputs[(ty + 7 * 4) * 512 + tx + bx * 16];
    temp_8 = inputs[(ty + 8 * 4) * 512 + tx + bx * 16];
    temp_9 = inputs[(ty + 9 * 4) * 512 + tx + bx * 16];
    temp_10 = inputs[(ty + 10 * 4) * 512 + tx + bx * 16];
    temp_11 = inputs[(ty + 11 * 4) * 512 + tx + bx * 16];
    temp_12 = inputs[(ty + 12 * 4) * 512 + tx + bx * 16];
    temp_13 = inputs[(ty + 13 * 4) * 512 + tx + bx * 16];
    temp_14 = inputs[(ty + 14 * 4) * 512 + tx + bx * 16];
    temp_15 = inputs[(ty + 15 * 4) * 512 + tx + bx * 16];
    temp_16 = inputs[(ty + 16 * 4) * 512 + tx + bx * 16];
    temp_17 = inputs[(ty + 17 * 4) * 512 + tx + bx * 16];
    temp_18 = inputs[(ty + 18 * 4) * 512 + tx + bx * 16];
    temp_19 = inputs[(ty + 19 * 4) * 512 + tx + bx * 16];
    temp_20 = inputs[(ty + 20 * 4) * 512 + tx + bx * 16];
    temp_21 = inputs[(ty + 21 * 4) * 512 + tx + bx * 16];
    temp_22 = inputs[(ty + 22 * 4) * 512 + tx + bx * 16];
    temp_23 = inputs[(ty + 23 * 4) * 512 + tx + bx * 16];
    temp_24 = inputs[(ty + 24 * 4) * 512 + tx + bx * 16];
    temp_25 = inputs[(ty + 25 * 4) * 512 + tx + bx * 16];
    temp_26 = inputs[(ty + 26 * 4) * 512 + tx + bx * 16];
    temp_27 = inputs[(ty + 27 * 4) * 512 + tx + bx * 16];
    temp_28 = inputs[(ty + 28 * 4) * 512 + tx + bx * 16];
    temp_29 = inputs[(ty + 29 * 4) * 512 + tx + bx * 16];
    temp_30 = inputs[(ty + 30 * 4) * 512 + tx + bx * 16];
    temp_31 = inputs[(ty + 31 * 4) * 512 + tx + bx * 16];
...
__syncthreads();
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 16) / (float)(128), tmp_angle);
    MY_MUL(temp_1, tmp_angle, tmp);
    temp_1 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 17) / (float)(128), tmp_angle);
    MY_MUL(temp_17, tmp_angle, tmp);
    temp_17 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 18) / (float)(128), tmp_angle);
    MY_MUL(temp_9, tmp_angle, tmp);
    temp_9 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 19) / (float)(128), tmp_angle);
    MY_MUL(temp_25, tmp_angle, tmp);
    temp_25 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 20) / (float)(128), tmp_angle);
    MY_MUL(temp_5, tmp_angle, tmp);
    temp_5 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 21) / (float)(128), tmp_angle);
    MY_MUL(temp_21, tmp_angle, tmp);
    temp_21 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 22) / (float)(128), tmp_angle);
    MY_MUL(temp_13, tmp_angle, tmp);
    temp_13 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 23) / (float)(128), tmp_angle);
    MY_MUL(temp_29, tmp_angle, tmp);
    temp_29 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 24) / (float)(128), tmp_angle);
    MY_MUL(temp_3, tmp_angle, tmp);
    temp_3 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 25) / (float)(128), tmp_angle);
    MY_MUL(temp_19, tmp_angle, tmp);
    temp_19 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 26) / (float)(128), tmp_angle);
    MY_MUL(temp_11, tmp_angle, tmp);
    temp_11 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 27) / (float)(128), tmp_angle);
    MY_MUL(temp_27, tmp_angle, tmp);
    temp_27 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 28) / (float)(128), tmp_angle);
    MY_MUL(temp_7, tmp_angle, tmp);
    temp_7 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 29) / (float)(128), tmp_angle);
    MY_MUL(temp_23, tmp_angle, tmp);
    temp_23 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 30) / (float)(128), tmp_angle);
    MY_MUL(temp_15, tmp_angle, tmp);
    temp_15 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 1) * 31) / (float)(128), tmp_angle);
    MY_MUL(temp_31, tmp_angle, tmp);
    temp_31 = tmp;
    ...
    temp_1 = sdata[tx + 16 * (4 + ty)];
    __id[1] = ty + 4;
    
    temp_2 = sdata[tx + 16 * (8 + ty)];
    __id[2] = ty + 8;
    
    temp_3 = sdata[tx + 16 * (12 + ty)];
    __id[3] = ty + 12;
    
    temp_4 = sdata[tx + 16 * (16 + ty)];
    __id[4] = ty + 16;
    
    temp_5 = sdata[tx + 16 * (20 + ty)];
    __id[5] = ty + 20;
    
    temp_6 = sdata[tx + 16 * (24 + ty)];
    __id[6] = ty + 24;
    
    temp_7 = sdata[tx + 16 * (28 + ty)];
    __id[7] = ty + 28;
    
    temp_8 = sdata[tx + 16 * (32 + ty)];
    __id[8] = ty + 32;
    
    temp_9 = sdata[tx + 16 * (36 + ty)];
    __id[9] = ty + 36;
    
    temp_10 = sdata[tx + 16 * (40 + ty)];
    __id[10] = ty + 40;
    
    temp_11 = sdata[tx + 16 * (44 + ty)];
    __id[11] = ty + 44;
    
    temp_12 = sdata[tx + 16 * (48 + ty)];
    __id[12] = ty + 48;
    
    temp_13 = sdata[tx + 16 * (52 + ty)];
    __id[13] = ty + 52;
    
    temp_14 = sdata[tx + 16 * (56 + ty)];
    __id[14] = ty + 56;
    
    temp_15 = sdata[tx + 16 * (60 + ty)];
    __id[15] = ty + 60;
    
    temp_16 = sdata[tx + 16 * (64 + ty)];
    __id[16] = ty + 64;
    
    temp_17 = sdata[tx + 16 * (68 + ty)];
    __id[17] = ty + 68;
    
    temp_18 = sdata[tx + 16 * (72 + ty)];
    __id[18] = ty + 72;
    
    temp_19 = sdata[tx + 16 * (76 + ty)];
    __id[19] = ty + 76;
    
    temp_20 = sdata[tx + 16 * (80 + ty)];
    __id[20] = ty + 80;
    
    temp_21 = sdata[tx + 16 * (84 + ty)];
    __id[21] = ty + 84;
    
    temp_22 = sdata[tx + 16 * (88 + ty)];
    __id[22] = ty + 88;
    
    temp_23 = sdata[tx + 16 * (92 + ty)];
    __id[23] = ty + 92;
    
    temp_24 = sdata[tx + 16 * (96 + ty)];
    __id[24] = ty + 96;
    
    temp_25 = sdata[tx + 16 * (100 + ty)];
    __id[25] = ty + 100;
    
    temp_26 = sdata[tx + 16 * (104 + ty)];
    __id[26] = ty + 104;
    
    temp_27 = sdata[tx + 16 * (108 + ty)];
    __id[27] = ty + 108;
    
    temp_28 = sdata[tx + 16 * (112 + ty)];
    __id[28] = ty + 112;
    
    temp_29 = sdata[tx + 16 * (116 + ty)];
    __id[29] = ty + 116;
    
    temp_30 = sdata[tx + 16 * (120 + ty)];
    __id[30] = ty + 120;
    
    temp_31 = sdata[tx + 16 * (124 + ty)];
    __id[31] = ty + 124;
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[0])) / (float)(65536), tmp_angle);
    MY_MUL(temp_0, tmp_angle, tmp);
    temp_0 = tmp;
    sdata[tx + 16 * __id[0]] = temp_0;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[1])) / (float)(65536), tmp_angle);
    MY_MUL(temp_1, tmp_angle, tmp);
    temp_1 = tmp;
    sdata[tx + 16 * __id[1]] = temp_1;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[2])) / (float)(65536), tmp_angle);
    MY_MUL(temp_2, tmp_angle, tmp);
    temp_2 = tmp;
    sdata[tx + 16 * __id[2]] = temp_2;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[3])) / (float)(65536), tmp_angle);
    MY_MUL(temp_3, tmp_angle, tmp);
    temp_3 = tmp;
    sdata[tx + 16 * __id[3]] = temp_3;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[4])) / (float)(65536), tmp_angle);
    MY_MUL(temp_4, tmp_angle, tmp);
    temp_4 = tmp;
    sdata[tx + 16 * __id[4]] = temp_4;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[5])) / (float)(65536), tmp_angle);
    MY_MUL(temp_5, tmp_angle, tmp);
    temp_5 = tmp;
    sdata[tx + 16 * __id[5]] = temp_5;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[6])) / (float)(65536), tmp_angle);
    MY_MUL(temp_6, tmp_angle, tmp);
    temp_6 = tmp;
    sdata[tx + 16 * __id[6]] = temp_6;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[7])) / (float)(65536), tmp_angle);
    MY_MUL(temp_7, tmp_angle, tmp);
    temp_7 = tmp;
    sdata[tx + 16 * __id[7]] = temp_7;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[16])) / (float)(65536), tmp_angle);
    MY_MUL(temp_16, tmp_angle, tmp);
    temp_16 = tmp;
    sdata[tx + 16 * __id[16]] = temp_16;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[17])) / (float)(65536), tmp_angle);
    MY_MUL(temp_17, tmp_angle, tmp);
    temp_17 = tmp;
    sdata[tx + 16 * __id[17]] = temp_17;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[18])) / (float)(65536), tmp_angle);
    MY_MUL(temp_18, tmp_angle, tmp);
    temp_18 = tmp;
    sdata[tx + 16 * __id[18]] = temp_18;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[19])) / (float)(65536), tmp_angle);
    MY_MUL(temp_19, tmp_angle, tmp);
    temp_19 = tmp;
    sdata[tx + 16 * __id[19]] = temp_19;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[20])) / (float)(65536), tmp_angle);
    MY_MUL(temp_20, tmp_angle, tmp);
    temp_20 = tmp;
    sdata[tx + 16 * __id[20]] = temp_20;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[21])) / (float)(65536), tmp_angle);
    MY_MUL(temp_21, tmp_angle, tmp);
    temp_21 = tmp;
    sdata[tx + 16 * __id[21]] = temp_21;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[22])) / (float)(65536), tmp_angle);
    MY_MUL(temp_22, tmp_angle, tmp);
    temp_22 = tmp;
    sdata[tx + 16 * __id[22]] = temp_22;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[23])) / (float)(65536), tmp_angle);
    MY_MUL(temp_23, tmp_angle, tmp);
    temp_23 = tmp;
    sdata[tx + 16 * __id[23]] = temp_23;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[8])) / (float)(65536), tmp_angle);
    MY_MUL(temp_8, tmp_angle, tmp);
    temp_8 = tmp;
    sdata[tx + 16 * __id[8]] = temp_8;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[9])) / (float)(65536), tmp_angle);
    MY_MUL(temp_9, tmp_angle, tmp);
    temp_9 = tmp;
    sdata[tx + 16 * __id[9]] = temp_9;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[10])) / (float)(65536), tmp_angle);
    MY_MUL(temp_10, tmp_angle, tmp);
    temp_10 = tmp;
    sdata[tx + 16 * __id[10]] = temp_10;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[11])) / (float)(65536), tmp_angle);
    MY_MUL(temp_11, tmp_angle, tmp);
    temp_11 = tmp;
    sdata[tx + 16 * __id[11]] = temp_11;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[12])) / (float)(65536), tmp_angle);
    MY_MUL(temp_12, tmp_angle, tmp);
    temp_12 = tmp;
    sdata[tx + 16 * __id[12]] = temp_12;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[13])) / (float)(65536), tmp_angle);
    MY_MUL(temp_13, tmp_angle, tmp);
    temp_13 = tmp;
    sdata[tx + 16 * __id[13]] = temp_13;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[14])) / (float)(65536), tmp_angle);
    MY_MUL(temp_14, tmp_angle, tmp);
    temp_14 = tmp;
    sdata[tx + 16 * __id[14]] = temp_14;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[15])) / (float)(65536), tmp_angle);
    MY_MUL(temp_15, tmp_angle, tmp);
    temp_15 = tmp;
    sdata[tx + 16 * __id[15]] = temp_15;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[24])) / (float)(65536), tmp_angle);
    MY_MUL(temp_24, tmp_angle, tmp);
    temp_24 = tmp;
    sdata[tx + 16 * __id[24]] = temp_24;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[25])) / (float)(65536), tmp_angle);
    MY_MUL(temp_25, tmp_angle, tmp);
    temp_25 = tmp;
    sdata[tx + 16 * __id[25]] = temp_25;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[26])) / (float)(65536), tmp_angle);
    MY_MUL(temp_26, tmp_angle, tmp);
    temp_26 = tmp;
    sdata[tx + 16 * __id[26]] = temp_26;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[27])) / (float)(65536), tmp_angle);
    MY_MUL(temp_27, tmp_angle, tmp);
    temp_27 = tmp;
    sdata[tx + 16 * __id[27]] = temp_27;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[28])) / (float)(65536), tmp_angle);
    MY_MUL(temp_28, tmp_angle, tmp);
    temp_28 = tmp;
    sdata[tx + 16 * __id[28]] = temp_28;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[29])) / (float)(65536), tmp_angle);
    MY_MUL(temp_29, tmp_angle, tmp);
    temp_29 = tmp;
    sdata[tx + 16 * __id[29]] = temp_29;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[30])) / (float)(65536), tmp_angle);
    MY_MUL(temp_30, tmp_angle, tmp);
    temp_30 = tmp;
    sdata[tx + 16 * __id[30]] = temp_30;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[31])) / (float)(65536), tmp_angle);
    MY_MUL(temp_31, tmp_angle, tmp);
    temp_31 = tmp;
    sdata[tx + 16 * __id[31]] = temp_31;
    ...
    temp_0 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 0 * (2) + (ty % 2))];
    global_mem_checksum += temp_0.x + temp_0.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 0 * (2) + (ty % 2))] = temp_0;
    
    temp_1 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 1 * (2) + (ty % 2))];
    global_mem_checksum += temp_1.x + temp_1.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 1 * (2) + (ty % 2))] = temp_1;
    
    temp_2 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 2 * (2) + (ty % 2))];
    global_mem_checksum += temp_2.x + temp_2.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 2 * (2) + (ty % 2))] = temp_2;
    
    temp_3 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 3 * (2) + (ty % 2))];
    global_mem_checksum += temp_3.x + temp_3.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 3 * (2) + (ty % 2))] = temp_3;
    
    temp_4 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 4 * (2) + (ty % 2))];
    global_mem_checksum += temp_4.x + temp_4.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 4 * (2) + (ty % 2))] = temp_4;
    
    temp_5 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 5 * (2) + (ty % 2))];
    global_mem_checksum += temp_5.x + temp_5.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 5 * (2) + (ty % 2))] = temp_5;
    
    temp_6 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 6 * (2) + (ty % 2))];
    global_mem_checksum += temp_6.x + temp_6.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 6 * (2) + (ty % 2))] = temp_6;
    
    temp_7 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 7 * (2) + (ty % 2))];
    global_mem_checksum += temp_7.x + temp_7.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 7 * (2) + (ty % 2))] = temp_7;
    ...
    outputs[65536 + bx * 8 + 4 * (tid / 32) +  1].x = global_mem_checksum;
    global_mem_checksum = 0;
    
    temp_8 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 8 * (2) + (ty % 2))];
    global_mem_checksum += temp_8.x + temp_8.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 8 * (2) + (ty % 2))] = temp_8;
    
    temp_9 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 9 * (2) + (ty % 2))];
    global_mem_checksum += temp_9.x + temp_9.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 9 * (2) + (ty % 2))] = temp_9;
    
    temp_10 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 10 * (2) + (ty % 2))];
    global_mem_checksum += temp_10.x + temp_10.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 10 * (2) + (ty % 2))] = temp_10;
    
    temp_11 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 11 * (2) + (ty % 2))];
    global_mem_checksum += temp_11.x + temp_11.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 11 * (2) + (ty % 2))] = temp_11;
    
    temp_12 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 12 * (2) + (ty % 2))];
    global_mem_checksum += temp_12.x + temp_12.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 12 * (2) + (ty % 2))] = temp_12;
    
    temp_13 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 13 * (2) + (ty % 2))];
    global_mem_checksum += temp_13.x + temp_13.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 13 * (2) + (ty % 2))] = temp_13;
    
    temp_14 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 14 * (2) + (ty % 2))];
    global_mem_checksum += temp_14.x + temp_14.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 14 * (2) + (ty % 2))] = temp_14;
    
    temp_15 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 15 * (2) + (ty % 2))];
    global_mem_checksum += temp_15.x + temp_15.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 15 * (2) + (ty % 2))] = temp_15;
    ...
    outputs[65536 + bx * 8 + 4 * (tid / 32) +  2].x = global_mem_checksum;
    global_mem_checksum = 0;
    
    temp_16 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 16 * (2) + (ty % 2))];
    global_mem_checksum += temp_16.x + temp_16.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 16 * (2) + (ty % 2))] = temp_16;
    
    temp_17 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 17 * (2) + (ty % 2))];
    global_mem_checksum += temp_17.x + temp_17.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 17 * (2) + (ty % 2))] = temp_17;
    
    temp_18 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 18 * (2) + (ty % 2))];
    global_mem_checksum += temp_18.x + temp_18.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 18 * (2) + (ty % 2))] = temp_18;
    
    temp_19 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 19 * (2) + (ty % 2))];
    global_mem_checksum += temp_19.x + temp_19.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 19 * (2) + (ty % 2))] = temp_19;
    
    temp_20 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 20 * (2) + (ty % 2))];
    global_mem_checksum += temp_20.x + temp_20.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 20 * (2) + (ty % 2))] = temp_20;
    
    temp_21 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 21 * (2) + (ty % 2))];
    global_mem_checksum += temp_21.x + temp_21.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 21 * (2) + (ty % 2))] = temp_21;
    
    temp_22 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 22 * (2) + (ty % 2))];
    global_mem_checksum += temp_22.x + temp_22.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 22 * (2) + (ty % 2))] = temp_22;
    
    temp_23 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 23 * (2) + (ty % 2))];
    global_mem_checksum += temp_23.x + temp_23.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 23 * (2) + (ty % 2))] = temp_23;
    ...
    outputs[65536 + bx * 8 + 4 * (tid / 32) +  3].x = global_mem_checksum;
    global_mem_checksum = 0;
    
    temp_24 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 24 * (2) + (ty % 2))];
    global_mem_checksum += temp_24.x + temp_24.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 24 * (2) + (ty % 2))] = temp_24;
    
    temp_25 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 25 * (2) + (ty % 2))];
    global_mem_checksum += temp_25.x + temp_25.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 25 * (2) + (ty % 2))] = temp_25;
    
    temp_26 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 26 * (2) + (ty % 2))];
    global_mem_checksum += temp_26.x + temp_26.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 26 * (2) + (ty % 2))] = temp_26;
    
    temp_27 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 27 * (2) + (ty % 2))];
    global_mem_checksum += temp_27.x + temp_27.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 27 * (2) + (ty % 2))] = temp_27;
    
    temp_28 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 28 * (2) + (ty % 2))];
    global_mem_checksum += temp_28.x + temp_28.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 28 * (2) + (ty % 2))] = temp_28;
    
    temp_29 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 29 * (2) + (ty % 2))];
    global_mem_checksum += temp_29.x + temp_29.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 29 * (2) + (ty % 2))] = temp_29;
    
    temp_30 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 30 * (2) + (ty % 2))];
    global_mem_checksum += temp_30.x + temp_30.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 30 * (2) + (ty % 2))] = temp_30;
    
    temp_31 = sdata[tx + 16 * (((ty * 16) / 32) * 32 * (2) + 31 * (2) + (ty % 2))];
    global_mem_checksum += temp_31.x + temp_31.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 32 * (2) + 31 * (2) + (ty % 2))] = temp_31;
    ...
    outputs[65536 + bx * 8 + 4 * (tid / 32) +  4].x = global_mem_checksum;
    global_mem_checksum = 0;
