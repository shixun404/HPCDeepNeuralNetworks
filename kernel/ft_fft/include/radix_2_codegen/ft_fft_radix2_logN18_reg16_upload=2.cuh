extern __shared__ float shared[];
    __global__ void __launch_bounds__(512) fft_radix2_logN18_2(float2* inputs, float2* outputs, float2* r_1) {
    ...
    float2 mem_checksum, mem_checksum_t1;
        ...
        *(float2*)(((float*)sdata) + tid * 2) = tmp_r;
        ...
        temp_0 = inputs[(ty + 0 * 32) + (tx + bx * 16) * 512];
        temp_1 = inputs[(ty + 1 * 32) + (tx + bx * 16) * 512];
        temp_2 = inputs[(ty + 2 * 32) + (tx + bx * 16) * 512];
        temp_3 = inputs[(ty + 3 * 32) + (tx + bx * 16) * 512];
        temp_4 = inputs[(ty + 4 * 32) + (tx + bx * 16) * 512];
        temp_5 = inputs[(ty + 5 * 32) + (tx + bx * 16) * 512];
        temp_6 = inputs[(ty + 6 * 32) + (tx + bx * 16) * 512];
        temp_7 = inputs[(ty + 7 * 32) + (tx + bx * 16) * 512];
        temp_8 = inputs[(ty + 8 * 32) + (tx + bx * 16) * 512];
        temp_9 = inputs[(ty + 9 * 32) + (tx + bx * 16) * 512];
        temp_10 = inputs[(ty + 10 * 32) + (tx + bx * 16) * 512];
        temp_11 = inputs[(ty + 11 * 32) + (tx + bx * 16) * 512];
        temp_12 = inputs[(ty + 12 * 32) + (tx + bx * 16) * 512];
        temp_13 = inputs[(ty + 13 * 32) + (tx + bx * 16) * 512];
        temp_14 = inputs[(ty + 14 * 32) + (tx + bx * 16) * 512];
        temp_15 = inputs[(ty + 15 * 32) + (tx + bx * 16) * 512];
