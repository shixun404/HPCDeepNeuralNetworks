...
__global__ void __launch_bounds__(512) fft_radix2_logN29_1(float2* inputs, float2* outputs, float2* r_1) {
    ...
    *(float4*)(((float*)sdata) + tid * 4) = tmp_r;
    ...
    temp_0 = inputs[(ty + 0 * 64) * 524288 + tx + bx * 8];
    temp_1 = inputs[(ty + 1 * 64) * 524288 + tx + bx * 8];
    temp_2 = inputs[(ty + 2 * 64) * 524288 + tx + bx * 8];
    temp_3 = inputs[(ty + 3 * 64) * 524288 + tx + bx * 8];
    temp_4 = inputs[(ty + 4 * 64) * 524288 + tx + bx * 8];
    temp_5 = inputs[(ty + 5 * 64) * 524288 + tx + bx * 8];
    temp_6 = inputs[(ty + 6 * 64) * 524288 + tx + bx * 8];
    temp_7 = inputs[(ty + 7 * 64) * 524288 + tx + bx * 8];
    temp_8 = inputs[(ty + 8 * 64) * 524288 + tx + bx * 8];
    temp_9 = inputs[(ty + 9 * 64) * 524288 + tx + bx * 8];
    temp_10 = inputs[(ty + 10 * 64) * 524288 + tx + bx * 8];
    temp_11 = inputs[(ty + 11 * 64) * 524288 + tx + bx * 8];
    temp_12 = inputs[(ty + 12 * 64) * 524288 + tx + bx * 8];
    temp_13 = inputs[(ty + 13 * 64) * 524288 + tx + bx * 8];
    temp_14 = inputs[(ty + 14 * 64) * 524288 + tx + bx * 8];
    temp_15 = inputs[(ty + 15 * 64) * 524288 + tx + bx * 8];
    __id[0] = 0 + ty;
    __id[1] = 64 + ty;
    __id[2] = 128 + ty;
    __id[3] = 192 + ty;
    ...
    temp_1 = sdata[tx + 8 * (64 + ty)];
    __id[1] = ty + 64;
    
    temp_2 = sdata[tx + 8 * (128 + ty)];
    __id[2] = ty + 128;
    
    temp_3 = sdata[tx + 8 * (192 + ty)];
    __id[3] = ty + 192;
    
    temp_4 = sdata[tx + 8 * (256 + ty)];
    __id[4] = ty + 256;
    
    temp_5 = sdata[tx + 8 * (320 + ty)];
    __id[5] = ty + 320;
    
    temp_6 = sdata[tx + 8 * (384 + ty)];
    __id[6] = ty + 384;
    
    temp_7 = sdata[tx + 8 * (448 + ty)];
    __id[7] = ty + 448;
    
    temp_8 = sdata[tx + 8 * (512 + ty)];
    __id[8] = ty + 512;
    
    temp_9 = sdata[tx + 8 * (576 + ty)];
    __id[9] = ty + 576;
    
    temp_10 = sdata[tx + 8 * (640 + ty)];
    __id[10] = ty + 640;
    
    temp_11 = sdata[tx + 8 * (704 + ty)];
    __id[11] = ty + 704;
    
    temp_12 = sdata[tx + 8 * (768 + ty)];
    __id[12] = ty + 768;
    
    temp_13 = sdata[tx + 8 * (832 + ty)];
    __id[13] = ty + 832;
    
    temp_14 = sdata[tx + 8 * (896 + ty)];
    __id[14] = ty + 896;
    
    temp_15 = sdata[tx + 8 * (960 + ty)];
    __id[15] = ty + 960;
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 0) / (float)(64.0), tmp_angle);
    MY_MUL(temp_0, tmp_angle, tmp);
    temp_0 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 1) / (float)(64.0), tmp_angle);
    MY_MUL(temp_8, tmp_angle, tmp);
    temp_8 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 2) / (float)(64.0), tmp_angle);
    MY_MUL(temp_4, tmp_angle, tmp);
    temp_4 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 3) / (float)(64.0), tmp_angle);
    MY_MUL(temp_12, tmp_angle, tmp);
    temp_12 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 4) / (float)(64.0), tmp_angle);
    MY_MUL(temp_2, tmp_angle, tmp);
    temp_2 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 5) / (float)(64.0), tmp_angle);
    MY_MUL(temp_10, tmp_angle, tmp);
    temp_10 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 6) / (float)(64.0), tmp_angle);
    MY_MUL(temp_6, tmp_angle, tmp);
    temp_6 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 7) / (float)(64.0), tmp_angle);
    MY_MUL(temp_14, tmp_angle, tmp);
    temp_14 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 8) / (float)(64.0), tmp_angle);
    MY_MUL(temp_1, tmp_angle, tmp);
    temp_1 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 9) / (float)(64.0), tmp_angle);
    MY_MUL(temp_9, tmp_angle, tmp);
    temp_9 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 10) / (float)(64.0), tmp_angle);
    MY_MUL(temp_5, tmp_angle, tmp);
    temp_5 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 11) / (float)(64.0), tmp_angle);
    MY_MUL(temp_13, tmp_angle, tmp);
    temp_13 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 12) / (float)(64.0), tmp_angle);
    MY_MUL(temp_3, tmp_angle, tmp);
    temp_3 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 13) / (float)(64.0), tmp_angle);
    MY_MUL(temp_11, tmp_angle, tmp);
    temp_11 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 14) / (float)(64.0), tmp_angle);
    MY_MUL(temp_7, tmp_angle, tmp);
    temp_7 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((ty) / 16) * 15) / (float)(64.0), tmp_angle);
    MY_MUL(temp_15, tmp_angle, tmp);
    temp_15 = tmp;
    ...
    __id[15] = ty + 960;
            ...
            warp_checksum.y = 0;
                        ...
                        warp_checksum.x += temp_0.x * A_radix4_0_x - temp_0.y * A_radix4_0_y;
                        warp_checksum.y += temp_0.x * A_radix4_0_y + temp_0.y * A_radix4_0_x;
        
                        warp_checksum.x += temp_4.x * A_radix4_1_x - temp_4.y * A_radix4_1_y;
                        warp_checksum.y += temp_4.x * A_radix4_1_y + temp_4.y * A_radix4_1_x;
        
                        warp_checksum.x += temp_8.x * A_radix4_2_x - temp_8.y * A_radix4_2_y;
                        warp_checksum.y += temp_8.x * A_radix4_2_y + temp_8.y * A_radix4_2_x;
        
                        warp_checksum.x += temp_12.x * A_radix4_3_x - temp_12.y * A_radix4_3_y;
                        warp_checksum.y += temp_12.x * A_radix4_3_y + temp_12.y * A_radix4_3_x;
        
                        warp_checksum.x += temp_1.x * A_radix4_0_x - temp_1.y * A_radix4_0_y;
                        warp_checksum.y += temp_1.x * A_radix4_0_y + temp_1.y * A_radix4_0_x;
        
                        warp_checksum.x += temp_5.x * A_radix4_1_x - temp_5.y * A_radix4_1_y;
                        warp_checksum.y += temp_5.x * A_radix4_1_y + temp_5.y * A_radix4_1_x;
        
                        warp_checksum.x += temp_9.x * A_radix4_2_x - temp_9.y * A_radix4_2_y;
                        warp_checksum.y += temp_9.x * A_radix4_2_y + temp_9.y * A_radix4_2_x;
        
                        warp_checksum.x += temp_13.x * A_radix4_3_x - temp_13.y * A_radix4_3_y;
                        warp_checksum.y += temp_13.x * A_radix4_3_y + temp_13.y * A_radix4_3_x;
        
                        warp_checksum.x += temp_2.x * A_radix4_0_x - temp_2.y * A_radix4_0_y;
                        warp_checksum.y += temp_2.x * A_radix4_0_y + temp_2.y * A_radix4_0_x;
        
                        warp_checksum.x += temp_6.x * A_radix4_1_x - temp_6.y * A_radix4_1_y;
                        warp_checksum.y += temp_6.x * A_radix4_1_y + temp_6.y * A_radix4_1_x;
        
                        warp_checksum.x += temp_10.x * A_radix4_2_x - temp_10.y * A_radix4_2_y;
                        warp_checksum.y += temp_10.x * A_radix4_2_y + temp_10.y * A_radix4_2_x;
        
                        warp_checksum.x += temp_14.x * A_radix4_3_x - temp_14.y * A_radix4_3_y;
                        warp_checksum.y += temp_14.x * A_radix4_3_y + temp_14.y * A_radix4_3_x;
        
                        warp_checksum.x += temp_3.x * A_radix4_0_x - temp_3.y * A_radix4_0_y;
                        warp_checksum.y += temp_3.x * A_radix4_0_y + temp_3.y * A_radix4_0_x;
        
                        warp_checksum.x += temp_7.x * A_radix4_1_x - temp_7.y * A_radix4_1_y;
                        warp_checksum.y += temp_7.x * A_radix4_1_y + temp_7.y * A_radix4_1_x;
        
                        warp_checksum.x += temp_11.x * A_radix4_2_x - temp_11.y * A_radix4_2_y;
                        warp_checksum.y += temp_11.x * A_radix4_2_y + temp_11.y * A_radix4_2_x;
        
                        warp_checksum.x += temp_15.x * A_radix4_3_x - temp_15.y * A_radix4_3_y;
                        warp_checksum.y += temp_15.x * A_radix4_3_y + temp_15.y * A_radix4_3_x;
    ...
    tmp_angle_bk = tmp_angle;
        ...
        n_global *= 2;
            ...
            warp_checksum_ = warp_checksum;
                        ...
                        warp_checksum.x -= temp_6.x * r[2].x - temp_6.y * r[2].y;
                        warp_checksum.y -= temp_6.x * r[2].y + temp_6.y * r[2].x;
                        // warp_checksum.x -= temp_6.x;
                        // warp_checksum.y -= temp_6.y;
