...
__global__ void __launch_bounds__(128) fft_radix2_logN14_1(float2* inputs, float2* outputs, float2* r_1) {
    ...
    *(float2*)(((float*)sdata) + tid * 2) = tmp_r;
    ...
    temp_0 = inputs[(ty + 0 * 16) * 128 + tx + bx * 8];
    temp_1 = inputs[(ty + 1 * 16) * 128 + tx + bx * 8];
    temp_2 = inputs[(ty + 2 * 16) * 128 + tx + bx * 8];
    temp_3 = inputs[(ty + 3 * 16) * 128 + tx + bx * 8];
    temp_4 = inputs[(ty + 4 * 16) * 128 + tx + bx * 8];
    temp_5 = inputs[(ty + 5 * 16) * 128 + tx + bx * 8];
    temp_6 = inputs[(ty + 6 * 16) * 128 + tx + bx * 8];
    temp_7 = inputs[(ty + 7 * 16) * 128 + tx + bx * 8];
...
__syncthreads();
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 8) * (__id[0])) / (float)(16384), tmp_angle);
    MY_MUL(temp_0, tmp_angle, tmp);
    temp_0 = tmp;
    outputs[(tx + bx * 8) + 128 * __id[0]] = temp_0;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 8) * (__id[1])) / (float)(16384), tmp_angle);
    MY_MUL(temp_1, tmp_angle, tmp);
    temp_1 = tmp;
    outputs[(tx + bx * 8) + 128 * __id[1]] = temp_1;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 8) * (__id[2])) / (float)(16384), tmp_angle);
    MY_MUL(temp_2, tmp_angle, tmp);
    temp_2 = tmp;
    outputs[(tx + bx * 8) + 128 * __id[2]] = temp_2;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 8) * (__id[3])) / (float)(16384), tmp_angle);
    MY_MUL(temp_3, tmp_angle, tmp);
    temp_3 = tmp;
    outputs[(tx + bx * 8) + 128 * __id[3]] = temp_3;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 8) * (__id[4])) / (float)(16384), tmp_angle);
    MY_MUL(temp_4, tmp_angle, tmp);
    temp_4 = tmp;
    outputs[(tx + bx * 8) + 128 * __id[4]] = temp_4;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 8) * (__id[5])) / (float)(16384), tmp_angle);
    MY_MUL(temp_5, tmp_angle, tmp);
    temp_5 = tmp;
    outputs[(tx + bx * 8) + 128 * __id[5]] = temp_5;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 8) * (__id[6])) / (float)(16384), tmp_angle);
    MY_MUL(temp_6, tmp_angle, tmp);
    temp_6 = tmp;
    outputs[(tx + bx * 8) + 128 * __id[6]] = temp_6;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 8) * (__id[7])) / (float)(16384), tmp_angle);
    MY_MUL(temp_7, tmp_angle, tmp);
    temp_7 = tmp;
