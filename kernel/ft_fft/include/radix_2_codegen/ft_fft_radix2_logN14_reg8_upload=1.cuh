...
__syncthreads();
    ...
    outputs[(tx + bx * 16) + 256 * (((ty * 16) / 32) * 8 * (2) + 0 * (2) + (ty % 2))] = temp_0;
    
    temp_1 = sdata[tx + 16 * (((ty * 16) / 32) * 8 * (2) + 1 * (2) + (ty % 2))];
    global_mem_checksum += temp_1.x + temp_1.y;
    outputs[(tx + bx * 16) + 256 * (((ty * 16) / 32) * 8 * (2) + 1 * (2) + (ty % 2))] = temp_1;
    ...
    outputs[16384 + bx * 16 + 4 * (tid / 32) +  4].x = global_mem_checksum;
    global_mem_checksum = 0;
