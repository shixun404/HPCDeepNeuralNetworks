...
__global__ void __launch_bounds__(512) fft_radix2_logN18_1(float2* inputs, float2* outputs, float2* r_1) {
    ...
    *(float2*)(((float*)sdata) + tid * 2) = tmp_r;
    ...
    temp_0 = inputs[(ty + 0 * 32) * 512 + tx + bx * 16];
    temp_1 = inputs[(ty + 1 * 32) * 512 + tx + bx * 16];
    temp_2 = inputs[(ty + 2 * 32) * 512 + tx + bx * 16];
    temp_3 = inputs[(ty + 3 * 32) * 512 + tx + bx * 16];
    temp_4 = inputs[(ty + 4 * 32) * 512 + tx + bx * 16];
    temp_5 = inputs[(ty + 5 * 32) * 512 + tx + bx * 16];
    temp_6 = inputs[(ty + 6 * 32) * 512 + tx + bx * 16];
    temp_7 = inputs[(ty + 7 * 32) * 512 + tx + bx * 16];
    temp_8 = inputs[(ty + 8 * 32) * 512 + tx + bx * 16];
    temp_9 = inputs[(ty + 9 * 32) * 512 + tx + bx * 16];
    temp_10 = inputs[(ty + 10 * 32) * 512 + tx + bx * 16];
    temp_11 = inputs[(ty + 11 * 32) * 512 + tx + bx * 16];
    temp_12 = inputs[(ty + 12 * 32) * 512 + tx + bx * 16];
    temp_13 = inputs[(ty + 13 * 32) * 512 + tx + bx * 16];
    temp_14 = inputs[(ty + 14 * 32) * 512 + tx + bx * 16];
    temp_15 = inputs[(ty + 15 * 32) * 512 + tx + bx * 16];
...
__syncthreads();
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[0])) / (float)(262144), tmp_angle);
    MY_MUL(temp_0, tmp_angle, tmp);
    temp_0 = tmp;
    sdata[tx + 16 * __id[0]] = temp_0;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[1])) / (float)(262144), tmp_angle);
    MY_MUL(temp_1, tmp_angle, tmp);
    temp_1 = tmp;
    sdata[tx + 16 * __id[1]] = temp_1;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[2])) / (float)(262144), tmp_angle);
    MY_MUL(temp_2, tmp_angle, tmp);
    temp_2 = tmp;
    sdata[tx + 16 * __id[2]] = temp_2;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[3])) / (float)(262144), tmp_angle);
    MY_MUL(temp_3, tmp_angle, tmp);
    temp_3 = tmp;
    sdata[tx + 16 * __id[3]] = temp_3;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[4])) / (float)(262144), tmp_angle);
    MY_MUL(temp_4, tmp_angle, tmp);
    temp_4 = tmp;
    sdata[tx + 16 * __id[4]] = temp_4;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[5])) / (float)(262144), tmp_angle);
    MY_MUL(temp_5, tmp_angle, tmp);
    temp_5 = tmp;
    sdata[tx + 16 * __id[5]] = temp_5;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[6])) / (float)(262144), tmp_angle);
    MY_MUL(temp_6, tmp_angle, tmp);
    temp_6 = tmp;
    sdata[tx + 16 * __id[6]] = temp_6;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[7])) / (float)(262144), tmp_angle);
    MY_MUL(temp_7, tmp_angle, tmp);
    temp_7 = tmp;
    sdata[tx + 16 * __id[7]] = temp_7;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[8])) / (float)(262144), tmp_angle);
    MY_MUL(temp_8, tmp_angle, tmp);
    temp_8 = tmp;
    sdata[tx + 16 * __id[8]] = temp_8;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[9])) / (float)(262144), tmp_angle);
    MY_MUL(temp_9, tmp_angle, tmp);
    temp_9 = tmp;
    sdata[tx + 16 * __id[9]] = temp_9;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[10])) / (float)(262144), tmp_angle);
    MY_MUL(temp_10, tmp_angle, tmp);
    temp_10 = tmp;
    sdata[tx + 16 * __id[10]] = temp_10;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[11])) / (float)(262144), tmp_angle);
    MY_MUL(temp_11, tmp_angle, tmp);
    temp_11 = tmp;
    sdata[tx + 16 * __id[11]] = temp_11;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[12])) / (float)(262144), tmp_angle);
    MY_MUL(temp_12, tmp_angle, tmp);
    temp_12 = tmp;
    sdata[tx + 16 * __id[12]] = temp_12;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[13])) / (float)(262144), tmp_angle);
    MY_MUL(temp_13, tmp_angle, tmp);
    temp_13 = tmp;
    sdata[tx + 16 * __id[13]] = temp_13;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[14])) / (float)(262144), tmp_angle);
    MY_MUL(temp_14, tmp_angle, tmp);
    temp_14 = tmp;
    sdata[tx + 16 * __id[14]] = temp_14;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[15])) / (float)(262144), tmp_angle);
    MY_MUL(temp_15, tmp_angle, tmp);
    temp_15 = tmp;
    sdata[tx + 16 * __id[15]] = temp_15;
    ...
    temp_0 = sdata[tx + 16 * (((ty * 16) / 32) * 16 * (2) + 0 * (2) + (ty % 2))];
    global_mem_checksum += temp_0.x + temp_0.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 16 * (2) + 0 * (2) + (ty % 2))] = temp_0;
    
    temp_1 = sdata[tx + 16 * (((ty * 16) / 32) * 16 * (2) + 1 * (2) + (ty % 2))];
    global_mem_checksum += temp_1.x + temp_1.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 16 * (2) + 1 * (2) + (ty % 2))] = temp_1;
    
    temp_2 = sdata[tx + 16 * (((ty * 16) / 32) * 16 * (2) + 2 * (2) + (ty % 2))];
    global_mem_checksum += temp_2.x + temp_2.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 16 * (2) + 2 * (2) + (ty % 2))] = temp_2;
    
    temp_3 = sdata[tx + 16 * (((ty * 16) / 32) * 16 * (2) + 3 * (2) + (ty % 2))];
    global_mem_checksum += temp_3.x + temp_3.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 16 * (2) + 3 * (2) + (ty % 2))] = temp_3;
    ...
    outputs[262144 + bx * 64 + 4 * (tid / 32) +  1].x = global_mem_checksum;
    global_mem_checksum = 0;
    
    temp_4 = sdata[tx + 16 * (((ty * 16) / 32) * 16 * (2) + 4 * (2) + (ty % 2))];
    global_mem_checksum += temp_4.x + temp_4.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 16 * (2) + 4 * (2) + (ty % 2))] = temp_4;
    
    temp_5 = sdata[tx + 16 * (((ty * 16) / 32) * 16 * (2) + 5 * (2) + (ty % 2))];
    global_mem_checksum += temp_5.x + temp_5.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 16 * (2) + 5 * (2) + (ty % 2))] = temp_5;
    
    temp_6 = sdata[tx + 16 * (((ty * 16) / 32) * 16 * (2) + 6 * (2) + (ty % 2))];
    global_mem_checksum += temp_6.x + temp_6.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 16 * (2) + 6 * (2) + (ty % 2))] = temp_6;
    
    temp_7 = sdata[tx + 16 * (((ty * 16) / 32) * 16 * (2) + 7 * (2) + (ty % 2))];
    global_mem_checksum += temp_7.x + temp_7.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 16 * (2) + 7 * (2) + (ty % 2))] = temp_7;
    ...
    outputs[262144 + bx * 64 + 4 * (tid / 32) +  2].x = global_mem_checksum;
    global_mem_checksum = 0;
    
    temp_8 = sdata[tx + 16 * (((ty * 16) / 32) * 16 * (2) + 8 * (2) + (ty % 2))];
    global_mem_checksum += temp_8.x + temp_8.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 16 * (2) + 8 * (2) + (ty % 2))] = temp_8;
    
    temp_9 = sdata[tx + 16 * (((ty * 16) / 32) * 16 * (2) + 9 * (2) + (ty % 2))];
    global_mem_checksum += temp_9.x + temp_9.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 16 * (2) + 9 * (2) + (ty % 2))] = temp_9;
    
    temp_10 = sdata[tx + 16 * (((ty * 16) / 32) * 16 * (2) + 10 * (2) + (ty % 2))];
    global_mem_checksum += temp_10.x + temp_10.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 16 * (2) + 10 * (2) + (ty % 2))] = temp_10;
    
    temp_11 = sdata[tx + 16 * (((ty * 16) / 32) * 16 * (2) + 11 * (2) + (ty % 2))];
    global_mem_checksum += temp_11.x + temp_11.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 16 * (2) + 11 * (2) + (ty % 2))] = temp_11;
    ...
    outputs[262144 + bx * 64 + 4 * (tid / 32) +  3].x = global_mem_checksum;
    global_mem_checksum = 0;
    
    temp_12 = sdata[tx + 16 * (((ty * 16) / 32) * 16 * (2) + 12 * (2) + (ty % 2))];
    global_mem_checksum += temp_12.x + temp_12.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 16 * (2) + 12 * (2) + (ty % 2))] = temp_12;
    
    temp_13 = sdata[tx + 16 * (((ty * 16) / 32) * 16 * (2) + 13 * (2) + (ty % 2))];
    global_mem_checksum += temp_13.x + temp_13.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 16 * (2) + 13 * (2) + (ty % 2))] = temp_13;
    
    temp_14 = sdata[tx + 16 * (((ty * 16) / 32) * 16 * (2) + 14 * (2) + (ty % 2))];
    global_mem_checksum += temp_14.x + temp_14.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 16 * (2) + 14 * (2) + (ty % 2))] = temp_14;
    
    temp_15 = sdata[tx + 16 * (((ty * 16) / 32) * 16 * (2) + 15 * (2) + (ty % 2))];
    global_mem_checksum += temp_15.x + temp_15.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 16 * (2) + 15 * (2) + (ty % 2))] = temp_15;
    ...
    outputs[262144 + bx * 64 + 4 * (tid / 32) +  4].x = global_mem_checksum;
    global_mem_checksum = 0;
