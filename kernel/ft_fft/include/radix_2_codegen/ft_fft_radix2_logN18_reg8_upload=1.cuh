...
__global__ void __launch_bounds__(1024) fft_radix2_logN18_1(float2* inputs, float2* outputs, float2* r_1) {
    ...
    *(float1*)(((float*)sdata) + tid * 1) = tmp_r;
    ...
    temp_0 = inputs[(ty + 0 * 64) * 512 + tx + bx * 16];
    temp_1 = inputs[(ty + 1 * 64) * 512 + tx + bx * 16];
    temp_2 = inputs[(ty + 2 * 64) * 512 + tx + bx * 16];
    temp_3 = inputs[(ty + 3 * 64) * 512 + tx + bx * 16];
    temp_4 = inputs[(ty + 4 * 64) * 512 + tx + bx * 16];
    temp_5 = inputs[(ty + 5 * 64) * 512 + tx + bx * 16];
    temp_6 = inputs[(ty + 6 * 64) * 512 + tx + bx * 16];
    temp_7 = inputs[(ty + 7 * 64) * 512 + tx + bx * 16];
...
__syncthreads();
    ...
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 8 * (2) + 0 * (2) + (ty % 2))] = temp_0;
    
    temp_1 = sdata[tx + 16 * (((ty * 16) / 32) * 8 * (2) + 1 * (2) + (ty % 2))];
    global_mem_checksum += temp_1.x + temp_1.y;
    outputs[(tx + bx * 16) + 512 * (((ty * 16) / 32) * 8 * (2) + 1 * (2) + (ty % 2))] = temp_1;
    ...
    outputs[262144 + bx * 128 + 4 * (tid / 32) +  4].x = global_mem_checksum;
    global_mem_checksum = 0;
