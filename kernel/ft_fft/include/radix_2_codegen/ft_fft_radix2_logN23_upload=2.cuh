...
__global__ void __launch_bounds__(128) fft_radix2_logN23_2(float2* inputs, float2* outputs, float2* r_1) {
    ...
    *(float2*)(((float*)sdata) + tid * 2) = tmp_r;
    ...
    temp_1 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 2048) + (bx / 16) * 32768];
    temp_2 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 4096) + (bx / 16) * 32768];
    temp_3 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 6144) + (bx / 16) * 32768];
    temp_4 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 8192) + (bx / 16) * 32768];
    temp_5 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 10240) + (bx / 16) * 32768];
    temp_6 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 12288) + (bx / 16) * 32768];
    temp_7 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 14336) + (bx / 16) * 32768];
    temp_8 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 16384) + (bx / 16) * 32768];
    temp_9 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 18432) + (bx / 16) * 32768];
    temp_10 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 20480) + (bx / 16) * 32768];
    temp_11 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 22528) + (bx / 16) * 32768];
    temp_12 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 24576) + (bx / 16) * 32768];
    temp_13 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 26624) + (bx / 16) * 32768];
    temp_14 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 28672) + (bx / 16) * 32768];
    temp_15 = inputs[tx + (bx % 16) * 16 + (ty * 256 + 30720) + (bx / 16) * 32768];
    __id[0] = 0 + ty;
    __id[1] = 8 + ty;
    __id[2] = 16 + ty;
    __id[3] = 24 + ty;
    ...
    temp_8 = sdata[tx + 16 * (64 + ty)];
    __id[8] = ty + 64;
    
    temp_9 = sdata[tx + 16 * (72 + ty)];
    __id[9] = ty + 72;
    
    temp_10 = sdata[tx + 16 * (80 + ty)];
    __id[10] = ty + 80;
    
    temp_11 = sdata[tx + 16 * (88 + ty)];
    __id[11] = ty + 88;
    
    temp_12 = sdata[tx + 16 * (96 + ty)];
    __id[12] = ty + 96;
    
    temp_13 = sdata[tx + 16 * (104 + ty)];
    __id[13] = ty + 104;
    
    temp_14 = sdata[tx + 16 * (112 + ty)];
    __id[14] = ty + 112;
    
    temp_15 = sdata[tx + 16 * (120 + ty)];
    __id[15] = ty + 120;
            ...
            warp_checksum.y = 0;
                        ...
                        warp_checksum.x += temp_2.x * A_radix8_1_x - temp_2.y * A_radix8_1_y;
                        warp_checksum.y += temp_2.x * A_radix8_1_y + temp_2.y * A_radix8_1_x;
        
                        warp_checksum.x += temp_4.x * A_radix8_2_x - temp_4.y * A_radix8_2_y;
                        warp_checksum.y += temp_4.x * A_radix8_2_y + temp_4.y * A_radix8_2_x;
        
                        warp_checksum.x += temp_6.x * A_radix8_3_x - temp_6.y * A_radix8_3_y;
                        warp_checksum.y += temp_6.x * A_radix8_3_y + temp_6.y * A_radix8_3_x;
        
                        warp_checksum.x += temp_8.x * A_radix8_4_x - temp_8.y * A_radix8_4_y;
                        warp_checksum.y += temp_8.x * A_radix8_4_y + temp_8.y * A_radix8_4_x;
        
                        warp_checksum.x += temp_10.x * A_radix8_5_x - temp_10.y * A_radix8_5_y;
                        warp_checksum.y += temp_10.x * A_radix8_5_y + temp_10.y * A_radix8_5_x;
        
                        warp_checksum.x += temp_12.x * A_radix8_6_x - temp_12.y * A_radix8_6_y;
                        warp_checksum.y += temp_12.x * A_radix8_6_y + temp_12.y * A_radix8_6_x;
        
                        warp_checksum.x += temp_14.x * A_radix8_7_x - temp_14.y * A_radix8_7_y;
                        warp_checksum.y += temp_14.x * A_radix8_7_y + temp_14.y * A_radix8_7_x;
        
                        warp_checksum.x += temp_1.x * A_radix8_0_x - temp_1.y * A_radix8_0_y;
                        warp_checksum.y += temp_1.x * A_radix8_0_y + temp_1.y * A_radix8_0_x;
        
                        warp_checksum.x += temp_3.x * A_radix8_1_x - temp_3.y * A_radix8_1_y;
                        warp_checksum.y += temp_3.x * A_radix8_1_y + temp_3.y * A_radix8_1_x;
        
                        warp_checksum.x += temp_5.x * A_radix8_2_x - temp_5.y * A_radix8_2_y;
                        warp_checksum.y += temp_5.x * A_radix8_2_y + temp_5.y * A_radix8_2_x;
        
                        warp_checksum.x += temp_7.x * A_radix8_3_x - temp_7.y * A_radix8_3_y;
                        warp_checksum.y += temp_7.x * A_radix8_3_y + temp_7.y * A_radix8_3_x;
        
                        warp_checksum.x += temp_9.x * A_radix8_4_x - temp_9.y * A_radix8_4_y;
                        warp_checksum.y += temp_9.x * A_radix8_4_y + temp_9.y * A_radix8_4_x;
        
                        warp_checksum.x += temp_11.x * A_radix8_5_x - temp_11.y * A_radix8_5_y;
                        warp_checksum.y += temp_11.x * A_radix8_5_y + temp_11.y * A_radix8_5_x;
        
                        warp_checksum.x += temp_13.x * A_radix8_6_x - temp_13.y * A_radix8_6_y;
                        warp_checksum.y += temp_13.x * A_radix8_6_y + temp_13.y * A_radix8_6_x;
        
                        warp_checksum.x += temp_15.x * A_radix8_7_x - temp_15.y * A_radix8_7_y;
                        warp_checksum.y += temp_15.x * A_radix8_7_y + temp_15.y * A_radix8_7_x;
    ...
    n_global *= 2;
            ...
            warp_checksum_ = warp_checksum;
                        ...
                        warp_checksum.x -= temp_3.x * r[1].x - temp_3.y * r[1].y;
                        warp_checksum.y -= temp_3.x * r[1].y + temp_3.y * r[1].x;
                        // warp_checksum.x -= temp_3.x;
                        // warp_checksum.y -= temp_3.y;
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[8])) / (float)(32768), tmp_angle);
    MY_MUL(temp_8, tmp_angle, tmp);
    temp_8 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[8] + ((tx + bx * 16) / 256) * 128 * 256] = temp_8;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[9])) / (float)(32768), tmp_angle);
    MY_MUL(temp_9, tmp_angle, tmp);
    temp_9 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[9] + ((tx + bx * 16) / 256) * 128 * 256] = temp_9;
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[12])) / (float)(32768), tmp_angle);
    MY_MUL(temp_12, tmp_angle, tmp);
    temp_12 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[12] + ((tx + bx * 16) / 256) * 128 * 256] = temp_12;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[13])) / (float)(32768), tmp_angle);
    MY_MUL(temp_13, tmp_angle, tmp);
    temp_13 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[13] + ((tx + bx * 16) / 256) * 128 * 256] = temp_13;
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[10])) / (float)(32768), tmp_angle);
    MY_MUL(temp_10, tmp_angle, tmp);
    temp_10 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[10] + ((tx + bx * 16) / 256) * 128 * 256] = temp_10;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[11])) / (float)(32768), tmp_angle);
    MY_MUL(temp_11, tmp_angle, tmp);
    temp_11 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[11] + ((tx + bx * 16) / 256) * 128 * 256] = temp_11;
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[14])) / (float)(32768), tmp_angle);
    MY_MUL(temp_14, tmp_angle, tmp);
    temp_14 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[14] + ((tx + bx * 16) / 256) * 128 * 256] = temp_14;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + bx * 16) % 256) * (__id[15])) / (float)(32768), tmp_angle);
    MY_MUL(temp_15, tmp_angle, tmp);
    temp_15 = tmp;
    outputs[(tx + bx * 16) % 256 + 256 * __id[15] + ((tx + bx * 16) / 256) * 128 * 256] = temp_15;
