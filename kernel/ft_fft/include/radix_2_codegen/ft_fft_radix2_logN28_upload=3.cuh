...
__global__ void __launch_bounds__(1024) fft_radix2_logN28_3(float2* inputs, float2* outputs, float2* r_1) {
    ...
    temp_0 = inputs[(tx + 128 * ty + 0 * 1024) % 1024 + (((bx % 64) * 8) + ((tx + 128 * ty + 0 * 1024) / 1024)) * 524288 + (bx / 64) * 1024];
        sdata[(tx + 128 * ty + 0 * 1024) % 1024 + ((tx + 128 * ty + 0 * 1024) / 1024) * 1024] = temp_0;
    temp_1 = inputs[(tx + 128 * ty + 1 * 1024) % 1024 + (((bx % 64) * 8) + ((tx + 128 * ty + 1 * 1024) / 1024)) * 524288 + (bx / 64) * 1024];
        sdata[(tx + 128 * ty + 1 * 1024) % 1024 + ((tx + 128 * ty + 1 * 1024) / 1024) * 1024] = temp_1;
    temp_2 = inputs[(tx + 128 * ty + 2 * 1024) % 1024 + (((bx % 64) * 8) + ((tx + 128 * ty + 2 * 1024) / 1024)) * 524288 + (bx / 64) * 1024];
        sdata[(tx + 128 * ty + 2 * 1024) % 1024 + ((tx + 128 * ty + 2 * 1024) / 1024) * 1024] = temp_2;
    temp_3 = inputs[(tx + 128 * ty + 3 * 1024) % 1024 + (((bx % 64) * 8) + ((tx + 128 * ty + 3 * 1024) / 1024)) * 524288 + (bx / 64) * 1024];
        sdata[(tx + 128 * ty + 3 * 1024) % 1024 + ((tx + 128 * ty + 3 * 1024) / 1024) * 1024] = temp_3;
    temp_4 = inputs[(tx + 128 * ty + 4 * 1024) % 1024 + (((bx % 64) * 8) + ((tx + 128 * ty + 4 * 1024) / 1024)) * 524288 + (bx / 64) * 1024];
        sdata[(tx + 128 * ty + 4 * 1024) % 1024 + ((tx + 128 * ty + 4 * 1024) / 1024) * 1024] = temp_4;
    temp_5 = inputs[(tx + 128 * ty + 5 * 1024) % 1024 + (((bx % 64) * 8) + ((tx + 128 * ty + 5 * 1024) / 1024)) * 524288 + (bx / 64) * 1024];
        sdata[(tx + 128 * ty + 5 * 1024) % 1024 + ((tx + 128 * ty + 5 * 1024) / 1024) * 1024] = temp_5;
    temp_6 = inputs[(tx + 128 * ty + 6 * 1024) % 1024 + (((bx % 64) * 8) + ((tx + 128 * ty + 6 * 1024) / 1024)) * 524288 + (bx / 64) * 1024];
        sdata[(tx + 128 * ty + 6 * 1024) % 1024 + ((tx + 128 * ty + 6 * 1024) / 1024) * 1024] = temp_6;
    temp_7 = inputs[(tx + 128 * ty + 7 * 1024) % 1024 + (((bx % 64) * 8) + ((tx + 128 * ty + 7 * 1024) / 1024)) * 524288 + (bx / 64) * 1024];
    ...
    *(float2*)(((float*)sdata) + tid * 2) = tmp_r;
    ...
    outputs[(((tx + ty * 128 + 0) % 8) + (bx % 64) * 8) + (bx / 64) * 512 + ((tx + ty * 128 + 0) / 8) * 262144] = temp_0; 
    ...
    outputs[(((tx + ty * 128 + 1024) % 8) + (bx % 64) * 8) + (bx / 64) * 512 + ((tx + ty * 128 + 1024) / 8) * 262144] = temp_0; 
    ...
    outputs[(((tx + ty * 128 + 2048) % 8) + (bx % 64) * 8) + (bx / 64) * 512 + ((tx + ty * 128 + 2048) / 8) * 262144] = temp_0; 
    ...
    outputs[(((tx + ty * 128 + 3072) % 8) + (bx % 64) * 8) + (bx / 64) * 512 + ((tx + ty * 128 + 3072) / 8) * 262144] = temp_0; 
    ...
    outputs[(((tx + ty * 128 + 4096) % 8) + (bx % 64) * 8) + (bx / 64) * 512 + ((tx + ty * 128 + 4096) / 8) * 262144] = temp_0; 
    ...
    outputs[(((tx + ty * 128 + 5120) % 8) + (bx % 64) * 8) + (bx / 64) * 512 + ((tx + ty * 128 + 5120) / 8) * 262144] = temp_0; 
    ...
    outputs[(((tx + ty * 128 + 6144) % 8) + (bx % 64) * 8) + (bx / 64) * 512 + ((tx + ty * 128 + 6144) / 8) * 262144] = temp_0; 
    ...
    outputs[(((tx + ty * 128 + 7168) % 8) + (bx % 64) * 8) + (bx / 64) * 512 + ((tx + ty * 128 + 7168) / 8) * 262144] = temp_0; 
