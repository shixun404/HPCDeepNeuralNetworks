...
__global__ void __launch_bounds__(512) fft_radix2_logN24_3(float2* inputs, float2* outputs, float2* r_1) {
    ...
    temp_0 = inputs[(tx + 32 * ty + 0 * 512) % 256 + (((bx % 16) * 16) + ((tx + 32 * ty + 0 * 512) / 256)) * 65536 + (bx / 16) * 256];
        sdata[(tx + 32 * ty + 0 * 512) % 256 + ((tx + 32 * ty + 0 * 512) / 256) * 256] = temp_0;
    temp_1 = inputs[(tx + 32 * ty + 1 * 512) % 256 + (((bx % 16) * 16) + ((tx + 32 * ty + 1 * 512) / 256)) * 65536 + (bx / 16) * 256];
        sdata[(tx + 32 * ty + 1 * 512) % 256 + ((tx + 32 * ty + 1 * 512) / 256) * 256] = temp_1;
    temp_2 = inputs[(tx + 32 * ty + 2 * 512) % 256 + (((bx % 16) * 16) + ((tx + 32 * ty + 2 * 512) / 256)) * 65536 + (bx / 16) * 256];
        sdata[(tx + 32 * ty + 2 * 512) % 256 + ((tx + 32 * ty + 2 * 512) / 256) * 256] = temp_2;
    temp_3 = inputs[(tx + 32 * ty + 3 * 512) % 256 + (((bx % 16) * 16) + ((tx + 32 * ty + 3 * 512) / 256)) * 65536 + (bx / 16) * 256];
        sdata[(tx + 32 * ty + 3 * 512) % 256 + ((tx + 32 * ty + 3 * 512) / 256) * 256] = temp_3;
    temp_4 = inputs[(tx + 32 * ty + 4 * 512) % 256 + (((bx % 16) * 16) + ((tx + 32 * ty + 4 * 512) / 256)) * 65536 + (bx / 16) * 256];
        sdata[(tx + 32 * ty + 4 * 512) % 256 + ((tx + 32 * ty + 4 * 512) / 256) * 256] = temp_4;
    temp_5 = inputs[(tx + 32 * ty + 5 * 512) % 256 + (((bx % 16) * 16) + ((tx + 32 * ty + 5 * 512) / 256)) * 65536 + (bx / 16) * 256];
        sdata[(tx + 32 * ty + 5 * 512) % 256 + ((tx + 32 * ty + 5 * 512) / 256) * 256] = temp_5;
    temp_6 = inputs[(tx + 32 * ty + 6 * 512) % 256 + (((bx % 16) * 16) + ((tx + 32 * ty + 6 * 512) / 256)) * 65536 + (bx / 16) * 256];
        sdata[(tx + 32 * ty + 6 * 512) % 256 + ((tx + 32 * ty + 6 * 512) / 256) * 256] = temp_6;
    temp_7 = inputs[(tx + 32 * ty + 7 * 512) % 256 + (((bx % 16) * 16) + ((tx + 32 * ty + 7 * 512) / 256)) * 65536 + (bx / 16) * 256];
        sdata[(tx + 32 * ty + 7 * 512) % 256 + ((tx + 32 * ty + 7 * 512) / 256) * 256] = temp_7;
    
    __syncthreads();
    temp_0 = sdata[(tx + 0) + ty * 256];
    temp_1 = sdata[(tx + 32) + ty * 256];
    temp_2 = sdata[(tx + 64) + ty * 256];
    temp_3 = sdata[(tx + 96) + ty * 256];
    temp_4 = sdata[(tx + 128) + ty * 256];
    temp_5 = sdata[(tx + 160) + ty * 256];
    temp_6 = sdata[(tx + 192) + ty * 256];
    temp_7 = sdata[(tx + 224) + ty * 256];
    __id[0] = 0 + tx;
    __id[1] = 32 + tx;
    __id[2] = 64 + tx;
    __id[3] = 96 + tx;
    ...
    *(float1*)(((float*)sdata) + tid * 1) = tmp_r;
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 8) * 0) / (float)(32.0), tmp_angle);
    MY_MUL(temp_0, tmp_angle, tmp);
    temp_0 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 8) * 1) / (float)(32.0), tmp_angle);
    MY_MUL(temp_4, tmp_angle, tmp);
    temp_4 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 8) * 2) / (float)(32.0), tmp_angle);
    MY_MUL(temp_2, tmp_angle, tmp);
    temp_2 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 8) * 3) / (float)(32.0), tmp_angle);
    MY_MUL(temp_6, tmp_angle, tmp);
    temp_6 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 8) * 4) / (float)(32.0), tmp_angle);
    MY_MUL(temp_1, tmp_angle, tmp);
    temp_1 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 8) * 5) / (float)(32.0), tmp_angle);
    MY_MUL(temp_5, tmp_angle, tmp);
    temp_5 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 8) * 6) / (float)(32.0), tmp_angle);
    MY_MUL(temp_3, tmp_angle, tmp);
    temp_3 = tmp;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx) / 8) * 7) / (float)(32.0), tmp_angle);
    MY_MUL(temp_7, tmp_angle, tmp);
    temp_7 = tmp;
    ...
    __id[7] = tx + 224;
            ...
            warp_checksum.y = 0;
                        ...
                        warp_checksum.x += temp_2.x * A_radix4_1_x - temp_2.y * A_radix4_1_y;
                        warp_checksum.y += temp_2.x * A_radix4_1_y + temp_2.y * A_radix4_1_x;
                        // warp_checksum.x += temp_2.x;
                        // warp_checksum.y += temp_2.y;
        
                        warp_checksum.x += temp_4.x * A_radix4_2_x - temp_4.y * A_radix4_2_y;
                        warp_checksum.y += temp_4.x * A_radix4_2_y + temp_4.y * A_radix4_2_x;
                        // warp_checksum.x += temp_4.x;
                        // warp_checksum.y += temp_4.y;
        
                        warp_checksum.x += temp_6.x * A_radix4_3_x - temp_6.y * A_radix4_3_y;
                        warp_checksum.y += temp_6.x * A_radix4_3_y + temp_6.y * A_radix4_3_x;
                        // warp_checksum.x += temp_6.x;
                        // warp_checksum.y += temp_6.y;
                        ...
                        warp_checksum.x += temp_3.x * A_radix4_1_x - temp_3.y * A_radix4_1_y;
                        warp_checksum.y += temp_3.x * A_radix4_1_y + temp_3.y * A_radix4_1_x;
                        // warp_checksum.x += temp_3.x;
                        // warp_checksum.y += temp_3.y;
        
                        warp_checksum.x += temp_5.x * A_radix4_2_x - temp_5.y * A_radix4_2_y;
                        warp_checksum.y += temp_5.x * A_radix4_2_y + temp_5.y * A_radix4_2_x;
                        // warp_checksum.x += temp_5.x;
                        // warp_checksum.y += temp_5.y;
        
                        warp_checksum.x += temp_7.x * A_radix4_3_x - temp_7.y * A_radix4_3_y;
                        warp_checksum.y += temp_7.x * A_radix4_3_y + temp_7.y * A_radix4_3_x;
                        // warp_checksum.x += temp_7.x;
                        // warp_checksum.y += temp_7.y;
    ...
    tmp_angle_bk = tmp_angle;
        ...
        n_global *= 2;
            ...
            warp_checksum_ = warp_checksum;
                        ...
                        warp_checksum.x -= temp_3.x * r[2].x - temp_3.y * r[2].y;
                        warp_checksum.y -= temp_3.x * r[2].y + temp_3.y * r[2].x;
                        // warp_checksum.x -= temp_3.x;
                        // warp_checksum.y -= temp_3.y;
    ...
    temp_0 = sdata[((tx + ty * 32 + 0) / 16) + ((tx + ty * 32 + 0) % 16) * 256];
    ...
    temp_0 = sdata[((tx + ty * 32 + 512) / 16) + ((tx + ty * 32 + 512) % 16) * 256];
    ...
    temp_0 = sdata[((tx + ty * 32 + 1024) / 16) + ((tx + ty * 32 + 1024) % 16) * 256];
    ...
    temp_0 = sdata[((tx + ty * 32 + 1536) / 16) + ((tx + ty * 32 + 1536) % 16) * 256];
    ...
    temp_0 = sdata[((tx + ty * 32 + 2048) / 16) + ((tx + ty * 32 + 2048) % 16) * 256];
    ...
    temp_0 = sdata[((tx + ty * 32 + 2560) / 16) + ((tx + ty * 32 + 2560) % 16) * 256];
    ...
    temp_0 = sdata[((tx + ty * 32 + 3072) / 16) + ((tx + ty * 32 + 3072) % 16) * 256];
    ...
    temp_0 = sdata[((tx + ty * 32 + 3584) / 16) + ((tx + ty * 32 + 3584) % 16) * 256];
