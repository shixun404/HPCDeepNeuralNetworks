...
__global__ void __launch_bounds__(16) fft_radix2_logN7(float2* inputs, float2* outputs) {
    ...
    n_global *= 2;
        ...
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 16) * 0) / (float)(128), tmp_angle);
        MY_MUL(temp_0, tmp_angle, tmp);
        temp_0 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 16) * 1) / (float)(128), tmp_angle);
        MY_MUL(temp_4, tmp_angle, tmp);
        temp_4 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 16) * 2) / (float)(128), tmp_angle);
        MY_MUL(temp_2, tmp_angle, tmp);
        temp_2 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 16) * 3) / (float)(128), tmp_angle);
        MY_MUL(temp_6, tmp_angle, tmp);
        temp_6 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 16) * 4) / (float)(128), tmp_angle);
        MY_MUL(temp_1, tmp_angle, tmp);
        temp_1 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 16) * 5) / (float)(128), tmp_angle);
        MY_MUL(temp_5, tmp_angle, tmp);
        temp_5 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 16) * 6) / (float)(128), tmp_angle);
        MY_MUL(temp_3, tmp_angle, tmp);
        temp_3 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 16) * 7) / (float)(128), tmp_angle);
        MY_MUL(temp_7, tmp_angle, tmp);
        temp_7 = tmp;
