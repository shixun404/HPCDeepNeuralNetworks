...
__global__ void __launch_bounds__(512) fft_radix2_logN14_1(float2* inputs, float2* outputs, float2* r_1) {
    ...
    *(((float*)sdata) + tid * {2 * N1 // num_thread}) = tmp_r;
    ...
    temp_0 = inputs[(ty + 0 * 8) * 128 + tx + bx * 64];
    temp_1 = inputs[(ty + 1 * 8) * 128 + tx + bx * 64];
    temp_2 = inputs[(ty + 2 * 8) * 128 + tx + bx * 64];
    temp_3 = inputs[(ty + 3 * 8) * 128 + tx + bx * 64];
    temp_4 = inputs[(ty + 4 * 8) * 128 + tx + bx * 64];
    temp_5 = inputs[(ty + 5 * 8) * 128 + tx + bx * 64];
    temp_6 = inputs[(ty + 6 * 8) * 128 + tx + bx * 64];
    temp_7 = inputs[(ty + 7 * 8) * 128 + tx + bx * 64];
    temp_8 = inputs[(ty + 8 * 8) * 128 + tx + bx * 64];
    temp_9 = inputs[(ty + 9 * 8) * 128 + tx + bx * 64];
    temp_10 = inputs[(ty + 10 * 8) * 128 + tx + bx * 64];
    temp_11 = inputs[(ty + 11 * 8) * 128 + tx + bx * 64];
    temp_12 = inputs[(ty + 12 * 8) * 128 + tx + bx * 64];
    temp_13 = inputs[(ty + 13 * 8) * 128 + tx + bx * 64];
    temp_14 = inputs[(ty + 14 * 8) * 128 + tx + bx * 64];
    temp_15 = inputs[(ty + 15 * 8) * 128 + tx + bx * 64];
...
__syncthreads();
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 64) * (__id[0])) / (float)(16384), tmp_angle);
    MY_MUL(temp_0, tmp_angle, tmp);
    temp_0 = tmp;
    outputs[(tx + bx * 64) + 128 * __id[0]] = temp_0;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 64) * (__id[1])) / (float)(16384), tmp_angle);
    MY_MUL(temp_1, tmp_angle, tmp);
    temp_1 = tmp;
    outputs[(tx + bx * 64) + 128 * __id[1]] = temp_1;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 64) * (__id[8])) / (float)(16384), tmp_angle);
    MY_MUL(temp_8, tmp_angle, tmp);
    temp_8 = tmp;
    outputs[(tx + bx * 64) + 128 * __id[8]] = temp_8;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 64) * (__id[9])) / (float)(16384), tmp_angle);
    MY_MUL(temp_9, tmp_angle, tmp);
    temp_9 = tmp;
    outputs[(tx + bx * 64) + 128 * __id[9]] = temp_9;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 64) * (__id[4])) / (float)(16384), tmp_angle);
    MY_MUL(temp_4, tmp_angle, tmp);
    temp_4 = tmp;
    outputs[(tx + bx * 64) + 128 * __id[4]] = temp_4;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 64) * (__id[5])) / (float)(16384), tmp_angle);
    MY_MUL(temp_5, tmp_angle, tmp);
    temp_5 = tmp;
    outputs[(tx + bx * 64) + 128 * __id[5]] = temp_5;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 64) * (__id[12])) / (float)(16384), tmp_angle);
    MY_MUL(temp_12, tmp_angle, tmp);
    temp_12 = tmp;
    outputs[(tx + bx * 64) + 128 * __id[12]] = temp_12;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 64) * (__id[13])) / (float)(16384), tmp_angle);
    MY_MUL(temp_13, tmp_angle, tmp);
    temp_13 = tmp;
    outputs[(tx + bx * 64) + 128 * __id[13]] = temp_13;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 64) * (__id[2])) / (float)(16384), tmp_angle);
    MY_MUL(temp_2, tmp_angle, tmp);
    temp_2 = tmp;
    outputs[(tx + bx * 64) + 128 * __id[2]] = temp_2;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 64) * (__id[3])) / (float)(16384), tmp_angle);
    MY_MUL(temp_3, tmp_angle, tmp);
    temp_3 = tmp;
    outputs[(tx + bx * 64) + 128 * __id[3]] = temp_3;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 64) * (__id[10])) / (float)(16384), tmp_angle);
    MY_MUL(temp_10, tmp_angle, tmp);
    temp_10 = tmp;
    outputs[(tx + bx * 64) + 128 * __id[10]] = temp_10;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 64) * (__id[11])) / (float)(16384), tmp_angle);
    MY_MUL(temp_11, tmp_angle, tmp);
    temp_11 = tmp;
    outputs[(tx + bx * 64) + 128 * __id[11]] = temp_11;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 64) * (__id[6])) / (float)(16384), tmp_angle);
    MY_MUL(temp_6, tmp_angle, tmp);
    temp_6 = tmp;
    outputs[(tx + bx * 64) + 128 * __id[6]] = temp_6;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 64) * (__id[7])) / (float)(16384), tmp_angle);
    MY_MUL(temp_7, tmp_angle, tmp);
    temp_7 = tmp;
    outputs[(tx + bx * 64) + 128 * __id[7]] = temp_7;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 64) * (__id[14])) / (float)(16384), tmp_angle);
    MY_MUL(temp_14, tmp_angle, tmp);
    temp_14 = tmp;
    outputs[(tx + bx * 64) + 128 * __id[14]] = temp_14;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 64) * (__id[15])) / (float)(16384), tmp_angle);
    MY_MUL(temp_15, tmp_angle, tmp);
    temp_15 = tmp;
