...
__global__ void __launch_bounds__(128) fft_radix2_logN16_1(float2* inputs, float2* outputs, float2* r_1) {
    ...
    *(float2*)(((float*)sdata) + tid * 2) = tmp_r;
    ...
    temp_8 = inputs[(ty + 8 * 8) * 512 + tx + bx * 16];
    temp_9 = inputs[(ty + 9 * 8) * 512 + tx + bx * 16];
    temp_10 = inputs[(ty + 10 * 8) * 512 + tx + bx * 16];
    temp_11 = inputs[(ty + 11 * 8) * 512 + tx + bx * 16];
    temp_12 = inputs[(ty + 12 * 8) * 512 + tx + bx * 16];
    temp_13 = inputs[(ty + 13 * 8) * 512 + tx + bx * 16];
    temp_14 = inputs[(ty + 14 * 8) * 512 + tx + bx * 16];
    temp_15 = inputs[(ty + 15 * 8) * 512 + tx + bx * 16];
