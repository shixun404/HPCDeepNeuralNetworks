...
__global__ void __launch_bounds__(32) fft_radix2_logN8(float2* inputs, float2* outputs) {
    ...
    n_global *= 2;
        ...
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 32) * 0) / (float)(256), tmp_angle);
        MY_MUL(temp_0, tmp_angle, tmp);
        temp_0 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 32) * 1) / (float)(256), tmp_angle);
        MY_MUL(temp_4, tmp_angle, tmp);
        temp_4 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 32) * 2) / (float)(256), tmp_angle);
        MY_MUL(temp_2, tmp_angle, tmp);
        temp_2 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 32) * 3) / (float)(256), tmp_angle);
        MY_MUL(temp_6, tmp_angle, tmp);
        temp_6 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 32) * 4) / (float)(256), tmp_angle);
        MY_MUL(temp_1, tmp_angle, tmp);
        temp_1 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 32) * 5) / (float)(256), tmp_angle);
        MY_MUL(temp_5, tmp_angle, tmp);
        temp_5 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 32) * 6) / (float)(256), tmp_angle);
        MY_MUL(temp_3, tmp_angle, tmp);
        temp_3 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 32) * 7) / (float)(256), tmp_angle);
        MY_MUL(temp_7, tmp_angle, tmp);
        temp_7 = tmp;
    ...
    __syncthreads();
        ...
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 4) * 0) / (float)(32.0), tmp_angle);
        MY_MUL(temp_0, tmp_angle, tmp);
        temp_0 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 4) * 1) / (float)(32.0), tmp_angle);
        MY_MUL(temp_4, tmp_angle, tmp);
        temp_4 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 4) * 2) / (float)(32.0), tmp_angle);
        MY_MUL(temp_2, tmp_angle, tmp);
        temp_2 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 4) * 3) / (float)(32.0), tmp_angle);
        MY_MUL(temp_6, tmp_angle, tmp);
        temp_6 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 4) * 4) / (float)(32.0), tmp_angle);
        MY_MUL(temp_1, tmp_angle, tmp);
        temp_1 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 4) * 5) / (float)(32.0), tmp_angle);
        MY_MUL(temp_5, tmp_angle, tmp);
        temp_5 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 4) * 6) / (float)(32.0), tmp_angle);
        MY_MUL(temp_3, tmp_angle, tmp);
        temp_3 = tmp;
        
        MY_ANGLE2COMPLEX((float)(-M_PI * 2 * ((tx + 0 * 1) % 4) * 7) / (float)(32.0), tmp_angle);
        MY_MUL(temp_7, tmp_angle, tmp);
        temp_7 = tmp;
