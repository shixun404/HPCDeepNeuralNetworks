...
__global__ void __launch_bounds__(1024) fft_radix2_logN25_3(float2* inputs, float2* outputs) {
    ...
    temp_0 = inputs[(tx + 0) + (bx / 16) * 512 + (ty + (bx % 16) * 16) * 131072];
    temp_1 = inputs[(tx + 64) + (bx / 16) * 512 + (ty + (bx % 16) * 16) * 131072];
    temp_2 = inputs[(tx + 128) + (bx / 16) * 512 + (ty + (bx % 16) * 16) * 131072];
    temp_3 = inputs[(tx + 192) + (bx / 16) * 512 + (ty + (bx % 16) * 16) * 131072];
    temp_4 = inputs[(tx + 256) + (bx / 16) * 512 + (ty + (bx % 16) * 16) * 131072];
    temp_5 = inputs[(tx + 320) + (bx / 16) * 512 + (ty + (bx % 16) * 16) * 131072];
    temp_6 = inputs[(tx + 384) + (bx / 16) * 512 + (ty + (bx % 16) * 16) * 131072];
    temp_7 = inputs[(tx + 448) + (bx / 16) * 512 + (ty + (bx % 16) * 16) * 131072];
    #if defined(LOG_ON)
    ...
    temp_6 = tmp;
    #if defined(LOG_ON)
    printf("tx %d, rot_a.real %f,  rot_a.imag %f, local_id 5,  global_id %d, j %d, k %d, j * k %d, n_global %d, \n",
    ...
    temp_7 = tmp;
    #if defined(LOG_ON)
    printf("tx %d, rot_a.real %f,  rot_a.imag %f, local_id 7,  global_id %d, j %d, k %d, j * k %d, n_global %d, \n",
    ...
    temp_3 = tmp;
    #if defined(LOG_ON)
    printf("tx %d, rot_a.real %f,  rot_a.imag %f, local_id 6,  global_id %d, j %d, k %d, j * k %d, n_global %d, \n",
    ...
    temp_3 = tmp;
    #if defined(LOG_ON)
    printf("tx %d,  a_rot.real %f,  a_rot.imag %f, local_id 6,  global_id %d, j %d, k %d, j * k %d, n_global %d, \n",
                        tx, tmp_angle_rot.x, tmp_angle_rot.y, __id[3], j, k, j*k, n_global);
    #endif
    ...
    temp_7 = tmp;
    #if defined(LOG_ON)
    printf("tx %d,  a_rot.real %f,  a_rot.imag %f, local_id 7,  global_id %d, j %d, k %d, j * k %d, n_global %d, \n",
                        tx, tmp_angle_rot.x, tmp_angle_rot.y, __id[7], j, k, j*k, n_global);
    #endif
