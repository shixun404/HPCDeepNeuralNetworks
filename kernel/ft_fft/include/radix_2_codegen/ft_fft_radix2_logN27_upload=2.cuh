...
__global__ void __launch_bounds__(1024) fft_radix2_logN27_2(float2* inputs, float2* outputs) {
    ...
    temp_1 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 32768) + (bx / 32) * 262144];
    temp_2 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 65536) + (bx / 32) * 262144];
    temp_3 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 98304) + (bx / 32) * 262144];
    temp_4 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 131072) + (bx / 32) * 262144];
    temp_5 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 163840) + (bx / 32) * 262144];
    temp_6 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 196608) + (bx / 32) * 262144];
    temp_7 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 229376) + (bx / 32) * 262144];
