...
__global__ void __launch_bounds__(256) fft_radix2_logN25_2(float2* inputs, float2* outputs, float2* r_1) {
    ...
    *(float2*)(((float*)sdata) + tid * 2) = tmp_r;
    ...
    temp_2 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 16384) + (bx / 32) * 131072];
    temp_3 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 24576) + (bx / 32) * 131072];
    temp_4 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 32768) + (bx / 32) * 131072];
    temp_5 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 40960) + (bx / 32) * 131072];
    temp_6 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 49152) + (bx / 32) * 131072];
    temp_7 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 57344) + (bx / 32) * 131072];
    temp_8 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 65536) + (bx / 32) * 131072];
    temp_9 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 73728) + (bx / 32) * 131072];
    temp_10 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 81920) + (bx / 32) * 131072];
    temp_11 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 90112) + (bx / 32) * 131072];
    temp_12 = inputs[tx + (bx % 32) * 16 + (ty * 512 + 98304) + (bx / 32) * 131072];
