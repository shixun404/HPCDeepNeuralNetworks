...
__global__ void __launch_bounds__(1024) fft_radix2_logN27_3(float2* inputs, float2* outputs) {
    ...
    temp_0 = inputs[(tx + 0) + (bx / 32) * 512 + (ty + (bx % 32) * 16) * 262144];
    temp_1 = inputs[(tx + 64) + (bx / 32) * 512 + (ty + (bx % 32) * 16) * 262144];
    temp_2 = inputs[(tx + 128) + (bx / 32) * 512 + (ty + (bx % 32) * 16) * 262144];
    temp_3 = inputs[(tx + 192) + (bx / 32) * 512 + (ty + (bx % 32) * 16) * 262144];
    temp_4 = inputs[(tx + 256) + (bx / 32) * 512 + (ty + (bx % 32) * 16) * 262144];
    temp_5 = inputs[(tx + 320) + (bx / 32) * 512 + (ty + (bx % 32) * 16) * 262144];
    temp_6 = inputs[(tx + 384) + (bx / 32) * 512 + (ty + (bx % 32) * 16) * 262144];
    temp_7 = inputs[(tx + 448) + (bx / 32) * 512 + (ty + (bx % 32) * 16) * 262144];
    #if defined(LOG_ON)
