extern __shared__ float shared[];
    __global__ void __launch_bounds__(1024) fft_radix2_logN16_2(float2* inputs, float2* outputs) {
        ...
        outputs[(ty + bx * 16) + 128 * __id[0]] = temp_0;
        // outputs[__id[0]] = temp_0;
        
        
        
        outputs[(ty + bx * 16) + 128 * __id[4]] = temp_4;
        // outputs[__id[4]] = temp_4;
        
        
        
        outputs[(ty + bx * 16) + 128 * __id[2]] = temp_2;
        // outputs[__id[2]] = temp_2;
        
        
        
        outputs[(ty + bx * 16) + 128 * __id[6]] = temp_6;
        // outputs[__id[6]] = temp_6;
        
        
        
        outputs[(ty + bx * 16) + 128 * __id[1]] = temp_1;
        // outputs[__id[1]] = temp_1;
        
        
        
        outputs[(ty + bx * 16) + 128 * __id[5]] = temp_5;
        // outputs[__id[5]] = temp_5;
        
        
        
        outputs[(ty + bx * 16) + 128 * __id[3]] = temp_3;
        // outputs[__id[3]] = temp_3;
        
        
        
        outputs[(ty + bx * 16) + 128 * __id[7]] = temp_7;
