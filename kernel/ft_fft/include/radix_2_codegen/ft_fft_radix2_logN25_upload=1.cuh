...
__global__ void __launch_bounds__(512) fft_radix2_logN25_1(float2* inputs, float2* outputs) {
    ...
    temp_0 = inputs[(ty + 0 * 32) * 131072 + tx + bx * 16];
    temp_1 = inputs[(ty + 1 * 32) * 131072 + tx + bx * 16];
    temp_2 = inputs[(ty + 2 * 32) * 131072 + tx + bx * 16];
    temp_3 = inputs[(ty + 3 * 32) * 131072 + tx + bx * 16];
    temp_4 = inputs[(ty + 4 * 32) * 131072 + tx + bx * 16];
    temp_5 = inputs[(ty + 5 * 32) * 131072 + tx + bx * 16];
    temp_6 = inputs[(ty + 6 * 32) * 131072 + tx + bx * 16];
    temp_7 = inputs[(ty + 7 * 32) * 131072 + tx + bx * 16];
    __id[0] = 0 + ty;
    __id[1] = 32 + ty;
    __id[2] = 64 + ty;
    __id[3] = 96 + ty;
    ...
    MY_MUL(temp_5, tmp_angle_rot, tmp);
    temp_5 = tmp;
