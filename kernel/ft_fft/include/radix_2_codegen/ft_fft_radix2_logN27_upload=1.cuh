...
__global__ void __launch_bounds__(512) fft_radix2_logN27_1(float2* inputs, float2* outputs, float2* r_1) {
    ...
    *(float2*)(((float*)sdata) + tid * 2) = tmp_r;
    ...
    temp_0 = inputs[(ty + 0 * 32) * 262144 + tx + bx * 16];
    temp_1 = inputs[(ty + 1 * 32) * 262144 + tx + bx * 16];
    temp_2 = inputs[(ty + 2 * 32) * 262144 + tx + bx * 16];
    temp_3 = inputs[(ty + 3 * 32) * 262144 + tx + bx * 16];
    temp_4 = inputs[(ty + 4 * 32) * 262144 + tx + bx * 16];
    temp_5 = inputs[(ty + 5 * 32) * 262144 + tx + bx * 16];
    temp_6 = inputs[(ty + 6 * 32) * 262144 + tx + bx * 16];
    temp_7 = inputs[(ty + 7 * 32) * 262144 + tx + bx * 16];
    temp_8 = inputs[(ty + 8 * 32) * 262144 + tx + bx * 16];
    temp_9 = inputs[(ty + 9 * 32) * 262144 + tx + bx * 16];
    temp_10 = inputs[(ty + 10 * 32) * 262144 + tx + bx * 16];
    temp_11 = inputs[(ty + 11 * 32) * 262144 + tx + bx * 16];
    temp_12 = inputs[(ty + 12 * 32) * 262144 + tx + bx * 16];
    temp_13 = inputs[(ty + 13 * 32) * 262144 + tx + bx * 16];
    temp_14 = inputs[(ty + 14 * 32) * 262144 + tx + bx * 16];
    temp_15 = inputs[(ty + 15 * 32) * 262144 + tx + bx * 16];
    __id[0] = 0 + ty;
    __id[1] = 32 + ty;
    __id[2] = 64 + ty;
    __id[3] = 96 + ty;
    ...
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[8])) / (float)(134217728), tmp_angle);
    MY_MUL(temp_8, tmp_angle, tmp);
    temp_8 = tmp;
    outputs[(tx + bx * 16) + 262144 * __id[8]] = temp_8;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[9])) / (float)(134217728), tmp_angle);
    MY_MUL(temp_9, tmp_angle, tmp);
    temp_9 = tmp;
    outputs[(tx + bx * 16) + 262144 * __id[9]] = temp_9;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[10])) / (float)(134217728), tmp_angle);
    MY_MUL(temp_10, tmp_angle, tmp);
    temp_10 = tmp;
    outputs[(tx + bx * 16) + 262144 * __id[10]] = temp_10;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[11])) / (float)(134217728), tmp_angle);
    MY_MUL(temp_11, tmp_angle, tmp);
    temp_11 = tmp;
    outputs[(tx + bx * 16) + 262144 * __id[11]] = temp_11;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[12])) / (float)(134217728), tmp_angle);
    MY_MUL(temp_12, tmp_angle, tmp);
    temp_12 = tmp;
    outputs[(tx + bx * 16) + 262144 * __id[12]] = temp_12;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[13])) / (float)(134217728), tmp_angle);
    MY_MUL(temp_13, tmp_angle, tmp);
    temp_13 = tmp;
    outputs[(tx + bx * 16) + 262144 * __id[13]] = temp_13;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[14])) / (float)(134217728), tmp_angle);
    MY_MUL(temp_14, tmp_angle, tmp);
    temp_14 = tmp;
    outputs[(tx + bx * 16) + 262144 * __id[14]] = temp_14;
    
    MY_ANGLE2COMPLEX((float)(-M_PI * 2 * (tx + bx * 16) * (__id[15])) / (float)(134217728), tmp_angle);
    MY_MUL(temp_15, tmp_angle, tmp);
    temp_15 = tmp;
    outputs[(tx + bx * 16) + 262144 * __id[15]] = temp_15;
