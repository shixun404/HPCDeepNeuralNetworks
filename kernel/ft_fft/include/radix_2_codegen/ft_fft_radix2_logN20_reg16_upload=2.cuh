extern __shared__ float shared[];
    ...
    temp_15 = tmp;
        ...
        temp_1 = sdata[tx + 4 * (64 + ty)];
        __id[1] = ty + 64;
        
        temp_2 = sdata[tx + 4 * (128 + ty)];
        __id[2] = ty + 128;
        
        temp_3 = sdata[tx + 4 * (192 + ty)];
        __id[3] = ty + 192;
        
        temp_4 = sdata[tx + 4 * (256 + ty)];
        __id[4] = ty + 256;
        
        temp_5 = sdata[tx + 4 * (320 + ty)];
        __id[5] = ty + 320;
        
        temp_6 = sdata[tx + 4 * (384 + ty)];
        __id[6] = ty + 384;
        
        temp_7 = sdata[tx + 4 * (448 + ty)];
        __id[7] = ty + 448;
        
        temp_8 = sdata[tx + 4 * (512 + ty)];
        __id[8] = ty + 512;
        
        temp_9 = sdata[tx + 4 * (576 + ty)];
        __id[9] = ty + 576;
        
        temp_10 = sdata[tx + 4 * (640 + ty)];
        __id[10] = ty + 640;
        
        temp_11 = sdata[tx + 4 * (704 + ty)];
        __id[11] = ty + 704;
        
        temp_12 = sdata[tx + 4 * (768 + ty)];
        __id[12] = ty + 768;
        
        temp_13 = sdata[tx + 4 * (832 + ty)];
        __id[13] = ty + 832;
        
        temp_14 = sdata[tx + 4 * (896 + ty)];
        __id[14] = ty + 896;
        
        temp_15 = sdata[tx + 4 * (960 + ty)];
        __id[15] = ty + 960;
