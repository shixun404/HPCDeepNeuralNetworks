...
extern "C" __global__ void __launch_bounds__(64) VkFFT_main_logN9 (float2* inputs, float2* outputs) {
unsigned int sharedStride = 528;
float2* sdata = (float2*)shared;
	...
	sdataID = inoutID + 0;
	sharedStride = 544;	sdataID = (sdataID / 16) * 17 + sdataID % 16;	sdata[sdataID] = temp_0;
	sdataID = inoutID + 1;
